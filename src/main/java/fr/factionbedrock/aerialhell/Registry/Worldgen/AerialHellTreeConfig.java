...
public class AerialHellTreeConfig
{
    ...
    )).belowTrunkProvider(BlockStateProvider.simple(AerialHellBlocks.STELLAR_DIRT.get())).ignoreVines().build();
    ...
    )).belowTrunkProvider(BlockStateProvider.simple(AerialHellBlocks.STELLAR_DIRT.get())).decorators(ImmutableList.of(new AlterGroundDecorator(BlockStateProvider.simple(AerialHellBlocks.SHADOW_GRASS_BLOCK.get().defaultBlockState())))).ignoreVines().build();
    ...
    public static final TreeConfiguration MEGA_PURPLE_SHADOW_PINE_CONFIG = (new TreeConfiguration.TreeConfigurationBuilder(
            ...
            new TwoLayersFeatureSize(1, 1, 2)
    )).decorators(ImmutableList.of(new AlterGroundDecorator(BlockStateProvider.simple(AerialHellBlocks.SHADOW_GRASS_BLOCK.get().defaultBlockState())))).belowTrunkProvider(BlockStateProvider.simple(AerialHellBlocks.STELLAR_DIRT.get())).ignoreVines().build();
    ...
    {
        return makeClassicTreeConfigBuilder(logBlockState, trunkPlacer, leavesBlockState, foliagePlacer, featureSize).belowTrunkProvider(BlockStateProvider.simple(AerialHellBlocks.STELLAR_DIRT.get())).ignoreVines().build();
    }
}
