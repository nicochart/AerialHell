...
public class AerialHellStructures
{
	...
	public static class Sets
	{
		...
		{
			return ResourceKey.create(Registries.STRUCTURE_SET, AerialHell.id(name));
		}
	}

	public static <S extends Structure> StructureType<S> register(String name, MapCodec<S> codec)
	{
		return Registry.register(BuiltInRegistries.STRUCTURE_TYPE, AerialHell.id(name), () -> codec);
	}
