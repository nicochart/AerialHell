...
public class AerialHellFeatures
{
	...
	public static final RegistryObject<Feature<NaturalFieldConfig>> NATURAL_FIELD = FEATURES.register("natural_field", () -> new NaturalFieldFeature(NaturalFieldConfig.CODEC));
