...
public class AerialHellFeatures
{
	...
	public static final Feature<?> HUGE_MUSHROOM = register("huge_mushroom", new HugeMushroomFeature(HugeMushroomFeatureConfiguration.CODEC));
	...
	public static final Feature<?> LARGE_DEAD_STELLAR_JUNGLE_TREE_LOG = register("large_dead_stellar_jungle_tree_log", new LargeDeadLogFeature(NoneFeatureConfiguration.CODEC, () -> AerialHellBlocks.DEAD_STELLAR_JUNGLE_TREE_LOG));
	...
	public static final Feature<?> WHITE_SOLID_ETHER = register("white_solid_ether", new WhiteSolidEtherCloudFeature(NoneFeatureConfiguration.CODEC));
	public static final Feature<?> BLUE_SOLID_ETHER = register("blue_solid_ether", new BlueSolidEtherCloudFeature(NoneFeatureConfiguration.CODEC));
	public static final Feature<?> GOLDEN_SOLID_ETHER = register("golden_solid_ether", new GoldenSolidEtherCloudFeature(NoneFeatureConfiguration.CODEC));
	public static final Feature<?> GREEN_SOLID_ETHER = register("green_solid_ether", new GreenSolidEtherCloudFeature(NoneFeatureConfiguration.CODEC));
	public static final Feature<?> PURPLE_SOLID_ETHER = register("purple_solid_ether", new PurpleSolidEtherCloudFeature(NoneFeatureConfiguration.CODEC));

	public static final Feature<?> ROOT_BRIDGE = register("root_bridge", new RootBridgeFeature(NoneFeatureConfiguration.CODEC));
	...
	public static final Feature<?> SHADOW_CRYSTAL_BLOB_IN_DARK_AREAS = register("shadow_crystal_blob_in_dark_areas", new StellarStoneCrystalBlobFeature(() -> AerialHellBlocks.SHADOW_CRYSTAL_BLOCK, NoneFeatureConfiguration.CODEC));
	public static final Feature<?> CRYSTALLIZED_FIRE = register("cristallized_fire", new CrystallizedFireFeature(NoneFeatureConfiguration.CODEC));
	public static final Feature<?> GIANT_CRYSTAL_BLOB = register("giant_crystal_blob", new GiantCrystalBlobFeature(NoneFeatureConfiguration.CODEC));

	public static final Feature<?> RANDOM_PATCH_IN_DARK_AREA = register("random_patch_in_dark_area", new RandomPatchInDarkAreaFeature(RandomPatchConfiguration.CODEC));
	...
	{
		return Registry.register(BuiltInRegistries.FEATURE, AerialHell.id(name), feature);
	}
