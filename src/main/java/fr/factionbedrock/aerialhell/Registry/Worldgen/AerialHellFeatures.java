...
public class AerialHellFeatures
{
	...
	public static final RegistryObject<Feature<NoneFeatureConfiguration>> GIANT_TREE = FEATURES.register("giant_tree", () -> new GiantTreeFeature(NoneFeatureConfiguration.CODEC));
