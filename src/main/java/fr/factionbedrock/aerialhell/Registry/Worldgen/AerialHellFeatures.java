...
public class AerialHellFeatures
{
	...
	public static final Feature<?> MOSSY_STELLAR_COBBLESTONE_ROCK = register("mossy_stellar_cobblestone_rock", new RockFeature(NoneFeatureConfiguration.CODEC, new WeightedStateProvider(WeightedList.<BlockState>builder().add(AerialHellBlocks.MOSSY_STELLAR_COBBLESTONE.defaultBlockState(), 1).add(AerialHellBlocks.STELLAR_COBBLESTONE.defaultBlockState(), 1))));
