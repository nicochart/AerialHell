...
public class AerialHellItems
{
    ...
    public static final DeferredItem<Item> VOLUCITE_PICKAXE = ITEMS.register(Keys.VOLUCITE_PICKAXE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_PICKAXE).pickaxe(ToolMaterials.VOLUCITE, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()), ToolEffects.VOLUCITE_POWER, List.of()));
    ...
    public static final DeferredItem<Item> VOLUCITE_SHOVEL = ITEMS.register(Keys.VOLUCITE_SHOVEL.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_SHOVEL).shovel(ToolMaterials.VOLUCITE, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()), ToolEffects.VOLUCITE_POWER, List.of(AerialHellToolItem.UseInteractionToolType.SHOVEL)));
    ...
    public static final DeferredItem<Item> VOLUCITE_HOE = ITEMS.register(Keys.VOLUCITE_HOE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_HOE).hoe(ToolMaterials.VOLUCITE, 0.0F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()), ToolEffects.VOLUCITE_POWER, List.of(AerialHellToolItem.UseInteractionToolType.HOE)));
