...
public class AerialHellItems
{
    ...
    public static final DeferredItem<Item> MAGMA_CUBE_PICKAXE = ITEMS.register(Keys.MAGMA_CUBE_PICKAXE.identifier().getPath(), () -> new EffectPickaxeItem(new AerialHellItemProperties().setId(Keys.MAGMA_CUBE_PICKAXE).pickaxe(ToolMaterials.OBSIDIAN, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    ...
    public static final DeferredItem<Item> MAGMA_CUBE_SHOVEL = ITEMS.register(Keys.MAGMA_CUBE_SHOVEL.identifier().getPath(), () -> new EffectShovelItem(new AerialHellItemProperties().setId(Keys.MAGMA_CUBE_SHOVEL).shovel(ToolMaterials.OBSIDIAN, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    ...
    public static final DeferredItem<Item> AXE_OF_LIGHT = ITEMS.register(Keys.AXE_OF_LIGHT.identifier().getPath(), () -> new EffectAxeItem(new AerialHellItemProperties().setId(Keys.AXE_OF_LIGHT).axe(ToolMaterials.LUNATIC, 5.0F, -3.1F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    ...
    public static final DeferredItem<Item> BERSERK_AXE = ITEMS.register(Keys.BERSERK_AXE.identifier().getPath(), () -> new BerserkAxeItem(new AerialHellItemProperties().setId(Keys.BERSERK_AXE).axe(ToolMaterials.ARSONIST, 4.0F, -2.5F, 0.0F, 0.0F).rarity(AerialHellRarities.MYTHICAL.getValue())));
    ...
    public static final DeferredItem<Item> REAPER_SCYTHE = ITEMS.register(Keys.REAPER_SCYTHE.identifier().getPath(), () -> new EffectHoeItem(new AerialHellItemProperties().setId(Keys.REAPER_SCYTHE).hoe(ToolMaterials.SHADOW, -2.8F, 4.0F, 0.0F, 0.0F).rarity(AerialHellRarities.MYTHICAL.getValue())));
    ...
    public static final DeferredItem<Item> NINJA_SWORD = ITEMS.register(Keys.NINJA_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.NINJA_SWORD).sword(ToolMaterials.OBSIDIAN, 2, -1.6F, 0.15F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> NINJA_MASTER_SWORD = ITEMS.register(Keys.NINJA_MASTER_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.NINJA_MASTER_SWORD).sword(ToolMaterials.OBSIDIAN, 4, -2.4F, 0.15F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));
    public static final DeferredItem<Item> GLOUTON_SWORD = ITEMS.register(Keys.GLOUTON_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.GLOUTON_SWORD).sword(ToolMaterials.RUBY, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> RANDOM_SWORD = ITEMS.register(Keys.RANDOM_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.RANDOM_SWORD).sword(ToolMaterials.RUBY, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(Rarity.EPIC)));
    ...
    public static final DeferredItem<Item> SWORD_OF_LIGHT = ITEMS.register(Keys.SWORD_OF_LIGHT.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.SWORD_OF_LIGHT).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ANTIDOTE_SWORD = ITEMS.register(Keys.ANTIDOTE_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.ANTIDOTE_SWORD).sword(ToolMaterials.RUBY, 4, -2.4F, 0.0F, 0.0F).fireResistant().rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> NETHERIAN_KING_SWORD = ITEMS.register(Keys.NETHERIAN_KING_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.NETHERIAN_KING_SWORD).sword(ToolMaterials.OBSIDIAN, 1, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> GLASS_CANON_SWORD = ITEMS.register(Keys.GLASS_CANON_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.GLASS_CANON_SWORD).sword(ToolMaterials.ARSONIST, 7, -1.6F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));
    public static final DeferredItem<Item> GOD_SWORD = ITEMS.register(Keys.GOD_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.GOD_SWORD).sword(ToolMaterials.ARSONIST, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));
