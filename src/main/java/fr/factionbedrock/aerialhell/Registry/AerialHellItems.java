...
public class AerialHellItems
{
    ...
    public static final DeferredItem<Item> STELLAR_STONE_BREAKER = ITEMS.register(Keys.STELLAR_STONE_BREAKER.identifier().getPath(), () -> new AerialHellPickaxeItem(new AerialHellItemProperties().setId(Keys.STELLAR_STONE_BREAKER).pickaxe(ToolMaterials.BREAKER, 1.0F, -2.8F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    ...
    public static final DeferredItem<Item> HEAVY_AXE = ITEMS.register(Keys.HEAVY_AXE.identifier().getPath(), () -> new AerialHellAxeItem(new AerialHellItemProperties().setId(Keys.HEAVY_AXE).axe(ToolMaterials.HEAVY, 6.0F, -3.5F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    ...
    public static final DeferredItem<Item> CURSED_AXE = ITEMS.register(Keys.CURSED_AXE.identifier().getPath(), () -> new AerialHellAxeItem(new AerialHellItemProperties().setId(Keys.CURSED_AXE).axe(ToolMaterials.SHADOW, 2.0F, -3.2F, 0.0F, 0.0F).rarity(AerialHellRarities.CORRUPTED.getValue())));
    ...
    public static final DeferredItem<Item> ARSONIST_SWORD = ITEMS.register(Keys.ARSONIST_SWORD.identifier().getPath(), () -> new AerialHellSwordItem(new AerialHellItemProperties().setId(Keys.ARSONIST_SWORD).sword(ToolMaterials.ARSONIST, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));
    ...
    public static final DeferredItem<Item> HEALTH_BOOST_SWORD = ITEMS.register(Keys.HEALTH_BOOST_SWORD.identifier().getPath(), () -> new AerialHellSwordItem(new AerialHellItemProperties().setId(Keys.HEALTH_BOOST_SWORD).sword(ToolMaterials.LUNATIC, 3, -2.4F, 0.0F, 4.0F).fireResistant().rarity(Rarity.EPIC)));
    ...
    public static final DeferredItem<Item> DISLOYAL_SWORD = ITEMS.register(Keys.DISLOYAL_SWORD.identifier().getPath(), () -> new AerialHellSwordItem(new AerialHellItemProperties().setId(Keys.DISLOYAL_SWORD).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> CURSED_SWORD = ITEMS.register(Keys.CURSED_SWORD.identifier().getPath(), () -> new AerialHellSwordItem(new AerialHellItemProperties().setId(Keys.CURSED_SWORD).sword(ToolMaterials.SHADOW, 1, -2.5F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.CORRUPTED.getValue())));
    public static final DeferredItem<Item> ABSOLUTE_ZERO_SWORD = ITEMS.register(Keys.ABSOLUTE_ZERO_SWORD.identifier().getPath(), () -> new AerialHellSwordItem(new AerialHellItemProperties().setId(Keys.ABSOLUTE_ZERO_SWORD).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));
