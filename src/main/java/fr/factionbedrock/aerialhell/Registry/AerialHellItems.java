...
public class AerialHellItems
{
    ...
    public static final DeferredItem<Item> FORGOTTEN_BATTLE_TRIDENT = ITEMS.register(Keys.FORGOTTEN_BATTLE_TRIDENT.identifier().getPath(), () -> new ForgottenBattleTridentItem(new AerialHellItem.Properties().setId(Keys.FORGOTTEN_BATTLE_TRIDENT).sword(ToolMaterials.VOLUCITE, 3, -2.9F, 0.2F, 0.0F).durability(1000).rarity(AerialHellRarities.LEGENDARY.getValue())));
