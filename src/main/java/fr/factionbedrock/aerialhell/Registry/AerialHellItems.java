...
public class AerialHellItems
{
    ...
    public static final DeferredItem<Item> VOLUCITE_VIBRANT = ITEMS.register(Keys.VOLUCITE_VIBRANT.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_VIBRANT).trimMaterial(AerialHellTrimMaterials.Keys.VOLUCITE_VIBRANT).rarity(AerialHellRarities.VIBRANT.getValue())));
