...
public class AerialHellItems
{
    ...
    public static final Item MAGMATIC_GEL_SHOVEL = register(Keys.MAGMATIC_GEL_SHOVEL.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_SHOVEL).shovel(AerialHellToolMaterials.MAGMATIC_GEL, 1.5F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    ...
    public static final Item MAGMATIC_GEL_AXE = register(Keys.MAGMATIC_GEL_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_AXE).axe(AerialHellToolMaterials.MAGMATIC_GEL, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    ...
    public static final Item LUNATIC_AXE = register(Keys.LUNATIC_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_AXE).axe(AerialHellToolMaterials.LUNATIC, 6.0F, -3.1F).rarity(AerialHellRarities.LEGENDARY).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final Item ARSONIST_AXE = register(Keys.ARSONIST_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_AXE).axe(AerialHellToolMaterials.ARSONIST, 6.0F, -3.1F).fireResistant().rarity(AerialHellRarities.MYTHICAL).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    ...
    public static final Item MAGMATIC_GEL_HOE = register(Keys.MAGMATIC_GEL_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_HOE).hoe(AerialHellToolMaterials.MAGMATIC_GEL, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    ...
    public static final Item LUNATIC_HOE = register(Keys.LUNATIC_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_HOE).hoe(AerialHellToolMaterials.LUNATIC, 0.0F, -1.0F).rarity(AerialHellRarities.LEGENDARY).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final Item ARSONIST_HOE = register(Keys.ARSONIST_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_HOE).hoe(AerialHellToolMaterials.ARSONIST, 0.0F, -1.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL).useInteraction(AerialHellItem.UseInteractionType.HOE)));
