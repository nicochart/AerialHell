...
public class AerialHellItems
{
    ...
    public static final Item ROASTED_AERIAL_BERRY = register("roasted_aerial_berry", new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(3).saturationModifier(0.3F).build())));
    public static final Item VIBRANT_AERIAL_BERRY = register("vibrant_aerial_berry", new Item(new Item.Settings().rarity(AerialHellRarities.VIBRANT).food(new FoodComponent.Builder().nutrition(4).saturationModifier(0.4F).build())));
    public static final Item FROZEN_AERIAL_BERRY = register("frozen_aerial_berry", new FoodWithEffectItem(4, 0.4F, AerialHellRarities.FROZEN, () -> new StatusEffectInstance(StatusEffects.SLOWNESS, 310, 0), () -> new StatusEffectInstance(StatusEffects.RESISTANCE, 210, 0)));
    ...
    public static final Item VOLUCITE_AERIAL_BERRY = register("volucite_aerial_berry", new FoodWithEffectItem(6, 0.8F, AerialHellRarities.VIBRANT, () -> new StatusEffectInstance(AerialHellMobEffects.HEAD_IN_THE_CLOUDS, 5000, 2)));
    public static final Item GLOWING_STICK_FRUIT = register("glowing_stick_fruit", new AliasedBlockItem(AerialHellBlocks.GLOWING_STICK_FRUIT_VINES, new Item.Settings().food(new FoodComponent.Builder().nutrition(3).saturationModifier(0.3F).build())));
    public static final Item VIBRANT_GLOWING_STICK_FRUIT = register("vibrant_glowing_stick_fruit", new Item(new Item.Settings().rarity(AerialHellRarities.VIBRANT).food(new FoodComponent.Builder().nutrition(6).saturationModifier(0.8F).build())));
    public static final Item FROZEN_GLOWING_STICK_FRUIT = register("frozen_glowing_stick_fruit", new FoodWithEffectItem(6, 0.6F, AerialHellRarities.FROZEN, () -> new StatusEffectInstance(StatusEffects.SLOWNESS, 120, 0), () -> new StatusEffectInstance(StatusEffects.RESISTANCE, 180, 0)));
