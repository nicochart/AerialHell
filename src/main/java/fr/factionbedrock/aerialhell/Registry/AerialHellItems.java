...
public class AerialHellItems
{
    ...
    //tools
    public static final DeferredItem<Item> SKY_WOOD_PICKAXE = ITEMS.register(Keys.SKY_WOOD_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_PICKAXE).pickaxe(ToolMaterials.SKY_WOOD, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_PICKAXE = ITEMS.register(Keys.STELLAR_STONE_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_PICKAXE).pickaxe(ToolMaterials.STELLAR_STONE, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> RUBY_PICKAXE = ITEMS.register(Keys.RUBY_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_PICKAXE).pickaxe(ToolMaterials.RUBY, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_PICKAXE = ITEMS.register(Keys.AZURITE_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_PICKAXE).pickaxe(ToolMaterials.AZURITE, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_PICKAXE = ITEMS.register(Keys.MAGMATIC_GEL_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_PICKAXE).pickaxe(ToolMaterials.MAGMATIC_GEL, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_PICKAXE = ITEMS.register(Keys.OBSIDIAN_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_PICKAXE).pickaxe(ToolMaterials.OBSIDIAN, 1.0F, -2.8F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_PICKAXE = ITEMS.register(Keys.VOLUCITE_PICKAXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_PICKAXE).pickaxe(ToolMaterials.VOLUCITE, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.FULL_VOLUCITE_POWER).nextAbility(AerialHellItemAbilities.HALF_VOLUCITE_POWER))));
    public static final DeferredItem<Item> LUNATIC_PICKAXE = ITEMS.register(Keys.LUNATIC_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_PICKAXE).pickaxe(ToolMaterials.LUNATIC, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_PICKAXE = ITEMS.register(Keys.ARSONIST_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.ARSONIST_PICKAXE).pickaxe(ToolMaterials.ARSONIST, 1.0F, -2.8F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> MAGMA_CUBE_PICKAXE = ITEMS.register(Keys.MAGMA_CUBE_PICKAXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMA_CUBE_PICKAXE).pickaxe(ToolMaterials.OBSIDIAN, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMA_CUBE))));
    public static final DeferredItem<Item> STELLAR_STONE_BREAKER = ITEMS.register(Keys.STELLAR_STONE_BREAKER.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_BREAKER).pickaxe(ToolMaterials.BREAKER, 1.0F, -2.8F, 0.0F, 0.0F).rarity(Rarity.EPIC)));

    public static final DeferredItem<Item> SKY_WOOD_SHOVEL = ITEMS.register(Keys.SKY_WOOD_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_SHOVEL).shovel(ToolMaterials.SKY_WOOD, 1.5F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_SHOVEL = ITEMS.register(Keys.STELLAR_STONE_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().shovel(ToolMaterials.STELLAR_STONE, 1.5F, -3.0F, 0.0F, 0.0F).setId(Keys.STELLAR_STONE_SHOVEL)));
    public static final DeferredItem<Item> RUBY_SHOVEL = ITEMS.register(Keys.RUBY_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_SHOVEL).shovel(ToolMaterials.RUBY, 1.5F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_SHOVEL = ITEMS.register(Keys.AZURITE_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_SHOVEL).shovel(ToolMaterials.AZURITE, 1.5F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_SHOVEL = ITEMS.register(Keys.MAGMATIC_GEL_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_SHOVEL).shovel(ToolMaterials.MAGMATIC_GEL, 1.5F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_SHOVEL = ITEMS.register(Keys.OBSIDIAN_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_SHOVEL).shovel(ToolMaterials.OBSIDIAN, 1.5F, -3.0F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_SHOVEL = ITEMS.register(Keys.VOLUCITE_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_SHOVEL).shovel(ToolMaterials.VOLUCITE, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.FULL_VOLUCITE_POWER).nextAbility(AerialHellItemAbilities.HALF_VOLUCITE_POWER)).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> LUNATIC_SHOVEL = ITEMS.register(Keys.LUNATIC_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_SHOVEL).shovel(ToolMaterials.LUNATIC, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_SHOVEL = ITEMS.register(Keys.ARSONIST_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.ARSONIST_SHOVEL).shovel(ToolMaterials.ARSONIST, 1.5F, -3.0F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> MAGMA_CUBE_SHOVEL = ITEMS.register(Keys.MAGMA_CUBE_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMA_CUBE_SHOVEL).shovel(ToolMaterials.OBSIDIAN, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMA_CUBE)).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));

    public static final DeferredItem<Item> SKY_WOOD_AXE = ITEMS.register(Keys.SKY_WOOD_AXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_AXE).axe(ToolMaterials.SKY_WOOD, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_AXE = ITEMS.register(Keys.STELLAR_STONE_AXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_AXE).axe(ToolMaterials.STELLAR_STONE, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> RUBY_AXE = ITEMS.register(Keys.RUBY_AXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_AXE).axe(ToolMaterials.RUBY, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_AXE = ITEMS.register(Keys.AZURITE_AXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_AXE).axe(ToolMaterials.AZURITE, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_AXE = ITEMS.register(Keys.MAGMATIC_GEL_AXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_AXE).axe(ToolMaterials.MAGMATIC_GEL, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_AXE = ITEMS.register(Keys.OBSIDIAN_AXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_AXE).axe(ToolMaterials.OBSIDIAN, 6.0F, -3.1F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_AXE = ITEMS.register(Keys.VOLUCITE_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_AXE).axe(ToolMaterials.VOLUCITE, 6.0F, -3.1F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.FULL_VOLUCITE_POWER).nextAbility(AerialHellItemAbilities.HALF_VOLUCITE_POWER)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> LUNATIC_AXE = ITEMS.register(Keys.LUNATIC_AXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_AXE).axe(ToolMaterials.LUNATIC, 6.0F, -3.1F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_AXE = ITEMS.register(Keys.ARSONIST_AXE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.ARSONIST_AXE).axe(ToolMaterials.ARSONIST, 6.0F, -3.1F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> HEAVY_AXE = ITEMS.register(Keys.HEAVY_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.HEAVY_AXE).axe(ToolMaterials.HEAVY, 6.0F, -3.5F, 0.0F, 0.0F).rarity(Rarity.EPIC).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> AXE_OF_LIGHT = ITEMS.register(Keys.AXE_OF_LIGHT.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AXE_OF_LIGHT).axe(ToolMaterials.LUNATIC, 5.0F, -3.1F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.AXE_OF_LIGHT)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> CURSED_AXE = ITEMS.register(Keys.CURSED_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.CURSED_AXE).axe(ToolMaterials.SHADOW, 2.0F, -3.2F, 0.0F, 0.0F).rarity(AerialHellRarities.CORRUPTED.getValue()).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final DeferredItem<Item> BERSERK_AXE = ITEMS.register(Keys.BERSERK_AXE.identifier().getPath(), () -> new BerserkAxeItem(new AerialHellItem.Properties().setId(Keys.BERSERK_AXE).axe(ToolMaterials.ARSONIST, 4.0F, -2.5F, 0.0F, 0.0F).rarity(AerialHellRarities.MYTHICAL.getValue()).useInteraction(AerialHellItem.UseInteractionType.AXE)));

    public static final DeferredItem<Item> SKY_WOOD_HOE = ITEMS.register(Keys.SKY_WOOD_HOE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_HOE).hoe(ToolMaterials.SKY_WOOD, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_HOE = ITEMS.register(Keys.STELLAR_STONE_HOE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_HOE).hoe(ToolMaterials.STELLAR_STONE, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> RUBY_HOE = ITEMS.register(Keys.RUBY_HOE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_HOE).hoe(ToolMaterials.RUBY, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_HOE = ITEMS.register(Keys.AZURITE_HOE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_HOE).hoe(ToolMaterials.AZURITE, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_HOE = ITEMS.register(Keys.MAGMATIC_GEL_HOE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_HOE).hoe(ToolMaterials.MAGMATIC_GEL, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_HOE = ITEMS.register(Keys.OBSIDIAN_HOE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_HOE).hoe(ToolMaterials.OBSIDIAN, 0.0F, -3.0F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_HOE = ITEMS.register(Keys.VOLUCITE_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_HOE).hoe(ToolMaterials.VOLUCITE, 0.0F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.FULL_VOLUCITE_POWER).nextAbility(AerialHellItemAbilities.HALF_VOLUCITE_POWER)).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final DeferredItem<Item> LUNATIC_HOE = ITEMS.register(Keys.LUNATIC_HOE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_HOE).hoe(ToolMaterials.LUNATIC, 0.0F, -1.0F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_HOE = ITEMS.register(Keys.ARSONIST_HOE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.ARSONIST_HOE).hoe(ToolMaterials.ARSONIST, 0.0F, -1.0F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> REAPER_SCYTHE = ITEMS.register(Keys.REAPER_SCYTHE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.REAPER_SCYTHE).hoe(ToolMaterials.SHADOW, 1.5F, 4.0F, 0.0F, 0.0F).rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.REAPER_WALK)).useInteraction(AerialHellItem.UseInteractionType.HOE)));

    //weapons
    public static final DeferredItem<Item> SKY_WOOD_SWORD = ITEMS.register(Keys.SKY_WOOD_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_SWORD).sword(ToolMaterials.SKY_WOOD, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_SWORD = ITEMS.register(Keys.STELLAR_STONE_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_SWORD).sword(ToolMaterials.STELLAR_STONE, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> RUBY_SWORD = ITEMS.register(Keys.RUBY_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_SWORD).sword(ToolMaterials.RUBY, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_SWORD = ITEMS.register(Keys.AZURITE_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_SWORD).sword(ToolMaterials.AZURITE, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_SWORD = ITEMS.register(Keys.MAGMATIC_GEL_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_SWORD).sword(ToolMaterials.MAGMATIC_GEL, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_SWORD = ITEMS.register(Keys.OBSIDIAN_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_SWORD).sword(ToolMaterials.OBSIDIAN, 3, -2.4F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_SWORD = ITEMS.register(Keys.VOLUCITE_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.VOLUCITE_SWORD).sword(ToolMaterials.VOLUCITE, 3, -2.4F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.FULL_VOLUCITE_POWER).nextAbility(AerialHellItemAbilities.HALF_VOLUCITE_POWER))));
    public static final DeferredItem<Item> LUNATIC_SWORD = ITEMS.register(Keys.LUNATIC_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_SWORD).sword(ToolMaterials.LUNATIC, 3, -2.4F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_SWORD = ITEMS.register(Keys.ARSONIST_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_SWORD).sword(ToolMaterials.ARSONIST, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> HEAVY_SWORD = ITEMS.register(Keys.HEAVY_SWORD.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.HEAVY_SWORD).sword(ToolMaterials.HEAVY, 3, -2.7F, 0.0F, 0.0F).fireResistant().rarity(Rarity.EPIC)));

    public static final DeferredItem<Item> HEALTH_BOOST_SWORD = ITEMS.register(Keys.HEALTH_BOOST_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.HEALTH_BOOST_SWORD).sword(ToolMaterials.LUNATIC, 3, -2.4F, 0.0F, 4.0F).fireResistant().rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> NINJA_SWORD = ITEMS.register(Keys.NINJA_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.NINJA_SWORD).sword(ToolMaterials.OBSIDIAN, 2, -1.6F, 0.15F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.NINJA_SWORD))));
    public static final DeferredItem<Item> NINJA_MASTER_SWORD = ITEMS.register(Keys.NINJA_MASTER_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.NINJA_MASTER_SWORD).sword(ToolMaterials.OBSIDIAN, 4, -2.4F, 0.15F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.NINJA_MASTER_SWORD))));
    public static final DeferredItem<Item> GLOUTON_SWORD = ITEMS.register(Keys.GLOUTON_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.GLOUTON_SWORD).sword(ToolMaterials.RUBY, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.GLOUTON_SWORD))));
    public static final DeferredItem<Item> RANDOM_SWORD = ITEMS.register(Keys.RANDOM_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RANDOM_SWORD).sword(ToolMaterials.RUBY, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(Rarity.EPIC).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.RANDOM_SWORD))));
    public static final DeferredItem<Item> DISLOYAL_SWORD = ITEMS.register(Keys.DISLOYAL_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.DISLOYAL_SWORD).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> CURSED_SWORD = ITEMS.register(Keys.CURSED_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.CURSED_SWORD).sword(ToolMaterials.SHADOW, 1, -2.5F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.CORRUPTED.getValue())));
    public static final DeferredItem<Item> ABSOLUTE_ZERO_SWORD = ITEMS.register(Keys.ABSOLUTE_ZERO_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ABSOLUTE_ZERO_SWORD).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));
    public static final DeferredItem<Item> SWORD_OF_LIGHT = ITEMS.register(Keys.SWORD_OF_LIGHT.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SWORD_OF_LIGHT).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SWORD_OF_LIGHT))));
    public static final DeferredItem<Item> ANTIDOTE_SWORD = ITEMS.register(Keys.ANTIDOTE_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ANTIDOTE_SWORD).sword(ToolMaterials.RUBY, 4, -2.4F, 0.0F, 0.0F).fireResistant().rarity(Rarity.EPIC).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ANTIDOTE_SWORD))));
    public static final DeferredItem<Item> NETHERIAN_KING_SWORD = ITEMS.register(Keys.NETHERIAN_KING_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.NETHERIAN_KING_SWORD).sword(ToolMaterials.OBSIDIAN, 1, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.NETHERIAN_KING_SWORD))));
    public static final DeferredItem<Item> GLASS_CANON_SWORD = ITEMS.register(Keys.GLASS_CANON_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.GLASS_CANON_SWORD).sword(ToolMaterials.ARSONIST, 7, -1.6F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.GLASS_CANNON_ARMORED_GLASS).nextAbility(AerialHellItemAbilities.GLASS_CANNON_LIFTOFF))));
    public static final DeferredItem<Item> GOD_SWORD = ITEMS.register(Keys.GOD_SWORD.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.GOD_SWORD).sword(ToolMaterials.ARSONIST, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.GOD))));

    public static final DeferredItem<Item> FORGOTTEN_BATTLE_TRIDENT = ITEMS.register(Keys.FORGOTTEN_BATTLE_TRIDENT.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.FORGOTTEN_BATTLE_TRIDENT).sword(ToolMaterials.VOLUCITE, 3, -2.9F, 0.2F, 0.0F).durability(1000).rarity(AerialHellRarities.LEGENDARY.getValue()).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.FORGOTTEN_BATTLE_TRIDENT))));

    //armor
    public static final DeferredItem<Item> RUBY_HELMET = ITEMS.register(Keys.RUBY_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_HELMET).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(15))));
    public static final DeferredItem<Item> RUBY_CHESTPLATE = ITEMS.register(Keys.RUBY_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(15))));
    public static final DeferredItem<Item> RUBY_LEGGINGS = ITEMS.register(Keys.RUBY_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(15))));
    public static final DeferredItem<Item> RUBY_BOOTS = ITEMS.register(Keys.RUBY_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.RUBY_BOOTS).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(15))));

    public static final DeferredItem<Item> AZURITE_HELMET = ITEMS.register(Keys.AZURITE_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_HELMET).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(10))));
    public static final DeferredItem<Item> AZURITE_CHESTPLATE = ITEMS.register(Keys.AZURITE_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(10))));
    public static final DeferredItem<Item> AZURITE_LEGGINGS = ITEMS.register(Keys.AZURITE_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(10))));
    public static final DeferredItem<Item> AZURITE_BOOTS = ITEMS.register(Keys.AZURITE_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_BOOTS).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(10))));

    public static final DeferredItem<Item> OBSIDIAN_HELMET = ITEMS.register(Keys.OBSIDIAN_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_HELMET).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(37)).rarity(Rarity.EPIC)));
    ...
    public static final DeferredItem<Item> OBSIDIAN_LEGGINGS = ITEMS.register(Keys.OBSIDIAN_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(37)).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> OBSIDIAN_BOOTS = ITEMS.register(Keys.OBSIDIAN_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_BOOTS).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(37)).rarity(Rarity.EPIC)));

    public static final DeferredItem<Item> VOLUCITE_HELMET = ITEMS.register(Keys.VOLUCITE_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_HELMET).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(35)).rarity(AerialHellRarities.VIBRANT.getValue())));
    public static final DeferredItem<Item> VOLUCITE_CHESTPLATE = ITEMS.register(Keys.VOLUCITE_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(35)).rarity(AerialHellRarities.VIBRANT.getValue())));
    ...
    public static final DeferredItem<Item> VOLUCITE_BOOTS = ITEMS.register(Keys.VOLUCITE_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_BOOTS).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(35)).rarity(AerialHellRarities.VIBRANT.getValue())));

    public static final DeferredItem<Item> MAGMATIC_GEL_HELMET = ITEMS.register(Keys.MAGMATIC_GEL_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_HELMET).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(7))));
    public static final DeferredItem<Item> MAGMATIC_GEL_CHESTPLATE = ITEMS.register(Keys.MAGMATIC_GEL_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(7))));
    public static final DeferredItem<Item> MAGMATIC_GEL_LEGGINGS = ITEMS.register(Keys.MAGMATIC_GEL_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(7))));
    public static final DeferredItem<Item> MAGMATIC_GEL_BOOTS = ITEMS.register(Keys.MAGMATIC_GEL_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_BOOTS).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(7))));

    public static final DeferredItem<Item> LUNATIC_HELMET = ITEMS.register(Keys.LUNATIC_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_HELMET).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(33)).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> LUNATIC_CHESTPLATE = ITEMS.register(Keys.LUNATIC_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(33)).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> LUNATIC_LEGGINGS = ITEMS.register(Keys.LUNATIC_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(33)).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> LUNATIC_BOOTS = ITEMS.register(Keys.LUNATIC_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_BOOTS).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(33)).rarity(AerialHellRarities.LEGENDARY.getValue())));

    public static final DeferredItem<Item> ARSONIST_HELMET = ITEMS.register(Keys.ARSONIST_HELMET.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.ARSONIST_HELMET).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(37)).rarity(AerialHellRarities.MYTHICAL.getValue()).fireResistant()));
    public static final DeferredItem<Item> ARSONIST_CHESTPLATE = ITEMS.register(Keys.ARSONIST_CHESTPLATE.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.ARSONIST_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(37)).rarity(AerialHellRarities.MYTHICAL.getValue()).fireResistant()));
    public static final DeferredItem<Item> ARSONIST_LEGGINGS = ITEMS.register(Keys.ARSONIST_LEGGINGS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.ARSONIST_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(37)).rarity(AerialHellRarities.MYTHICAL.getValue()).fireResistant()));
    public static final DeferredItem<Item> ARSONIST_BOOTS = ITEMS.register(Keys.ARSONIST_BOOTS.identifier().getPath(), () -> new Item(new AerialHellItem.Properties().setId(Keys.ARSONIST_BOOTS).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(37)).rarity(AerialHellRarities.MYTHICAL.getValue()).fireResistant()));

    public static final DeferredItem<Item> SHADOW_HELMET = ITEMS.register(Keys.SHADOW_HELMET.identifier().getPath(), () -> new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_HELMET).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(25)).rarity(AerialHellRarities.CORRUPTED.getValue())));
    ...
    public static final DeferredItem<Item> SHADOW_LEGGINGS = ITEMS.register(Keys.SHADOW_LEGGINGS.identifier().getPath(), () -> new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(25)).rarity(AerialHellRarities.CORRUPTED.getValue())));
    public static final DeferredItem<Item> SHADOW_BOOTS = ITEMS.register(Keys.SHADOW_BOOTS.identifier().getPath(), () -> new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_BOOTS).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(25)).rarity(AerialHellRarities.CORRUPTED.getValue())));
