...
public class AerialHellItems
{
    ...
    public static final DeferredItem<Item> LUNATIC_SHOVEL = ITEMS.register(Keys.LUNATIC_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_SHOVEL).shovel(AerialHellToolMaterials.LUNATIC, 1.5F, -3.0F).rarity(AerialHellRarities.LEGENDARY.getValue()).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final DeferredItem<Item> ARSONIST_SHOVEL = ITEMS.register(Keys.ARSONIST_SHOVEL.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_SHOVEL).shovel(AerialHellToolMaterials.ARSONIST, 1.5F, -3.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    ...
    public static final DeferredItem<Item> MAGMATIC_GEL_AXE = ITEMS.register(Keys.MAGMATIC_GEL_AXE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_AXE).axe(AerialHellToolMaterials.MAGMATIC_GEL, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    ...
    public static final DeferredItem<Item> MAGMATIC_GEL_HOE = ITEMS.register(Keys.MAGMATIC_GEL_HOE.identifier().getPath(), () -> new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_HOE).hoe(AerialHellToolMaterials.MAGMATIC_GEL, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
