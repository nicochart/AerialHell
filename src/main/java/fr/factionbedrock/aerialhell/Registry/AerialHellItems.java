...
public class AerialHellItems
{
    ...
    //portal
    public static final Item STELLAR_PORTAL_FRAME_BLOCK = register(Keys.STELLAR_PORTAL_FRAME_BLOCK.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_PORTAL_FRAME_BLOCK, new Item.Settings().registryKey(Keys.STELLAR_PORTAL_FRAME_BLOCK)));
    public static final Item STELLAR_PORTAL_FRAME_ORE = register(Keys.STELLAR_PORTAL_FRAME_ORE.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_PORTAL_FRAME_ORE, new Item.Settings().registryKey(Keys.STELLAR_PORTAL_FRAME_ORE)));
    public static final Item DEEPSLATE_STELLAR_PORTAL_FRAME_ORE = register(Keys.DEEPSLATE_STELLAR_PORTAL_FRAME_ORE.getValue().getPath(), new BlockItem(AerialHellBlocks.DEEPSLATE_STELLAR_PORTAL_FRAME_ORE, new Item.Settings().registryKey(Keys.DEEPSLATE_STELLAR_PORTAL_FRAME_ORE)));
    ...
    //torch
    public static final Item FLUORITE_TORCH = register(Keys.FLUORITE_TORCH.getValue().getPath(), new VerticallyAttachableBlockItem(AerialHellBlocks.FLUORITE_TORCH, AerialHellBlocks.FLUORITE_WALL_TORCH, Direction.DOWN, new Item.Settings().registryKey(Keys.FLUORITE_TORCH)));
    public static final Item VOLUCITE_TORCH = register(Keys.VOLUCITE_TORCH.getValue().getPath(), new VerticallyAttachableBlockItem(AerialHellBlocks.VOLUCITE_TORCH, AerialHellBlocks.VOLUCITE_WALL_TORCH, Direction.DOWN, new Item.Settings().registryKey(Keys.VOLUCITE_TORCH)));
    public static final Item SHADOW_TORCH = register(Keys.SHADOW_TORCH.getValue().getPath(), new VerticallyAttachableBlockItem(AerialHellBlocks.SHADOW_TORCH, AerialHellBlocks.SHADOW_WALL_TORCH, Direction.DOWN, new Item.Settings().registryKey(Keys.SHADOW_TORCH)));

    //lanterns
    public static final Item FLUORITE_LANTERN = register(Keys.FLUORITE_LANTERN.getValue().getPath(), new BlockItem(AerialHellBlocks.FLUORITE_LANTERN, new Item.Settings().registryKey(Keys.FLUORITE_LANTERN)));
    public static final Item RUBY_LANTERN = register(Keys.RUBY_LANTERN.getValue().getPath(), new BlockItem(AerialHellBlocks.RUBY_LANTERN, new Item.Settings().registryKey(Keys.RUBY_LANTERN)));
    public static final Item RUBY_FLUORITE_LANTERN = register(Keys.RUBY_FLUORITE_LANTERN.getValue().getPath(), new BlockItem(AerialHellBlocks.RUBY_FLUORITE_LANTERN, new Item.Settings().registryKey(Keys.RUBY_FLUORITE_LANTERN)));
    public static final Item VOLUCITE_LANTERN = register(Keys.VOLUCITE_LANTERN.getValue().getPath(), new BlockItem(AerialHellBlocks.VOLUCITE_LANTERN, new Item.Settings().registryKey(Keys.VOLUCITE_LANTERN)));
    public static final Item VOLUCITE_FLUORITE_LANTERN = register(Keys.VOLUCITE_FLUORITE_LANTERN.getValue().getPath(), new BlockItem(AerialHellBlocks.VOLUCITE_FLUORITE_LANTERN, new Item.Settings().registryKey(Keys.VOLUCITE_FLUORITE_LANTERN)));
    public static final Item LUNATIC_LANTERN = register(Keys.LUNATIC_LANTERN.getValue().getPath(), new BlockItem(AerialHellBlocks.LUNATIC_LANTERN, new Item.Settings().registryKey(Keys.LUNATIC_LANTERN)));
    public static final Item SHADOW_LANTERN = register(Keys.SHADOW_LANTERN.getValue().getPath(), new BlockItem(AerialHellBlocks.SHADOW_LANTERN, new Item.Settings().registryKey(Keys.SHADOW_LANTERN)));

    //chains
    public static final Item RUBY_CHAIN = register(Keys.RUBY_CHAIN.getValue().getPath(), new BlockItem(AerialHellBlocks.RUBY_CHAIN, new Item.Settings().registryKey(Keys.RUBY_CHAIN)));
    public static final Item VOLUCITE_CHAIN = register(Keys.VOLUCITE_CHAIN.getValue().getPath(), new BlockItem(AerialHellBlocks.VOLUCITE_CHAIN, new Item.Settings().registryKey(Keys.VOLUCITE_CHAIN)));
    public static final Item LUNATIC_CHAIN = register(Keys.LUNATIC_CHAIN.getValue().getPath(), new BlockItem(AerialHellBlocks.LUNATIC_CHAIN, new Item.Settings().registryKey(Keys.LUNATIC_CHAIN)));
    public static final Item SHADOW_CHAIN = register(Keys.SHADOW_CHAIN.getValue().getPath(), new BlockItem(AerialHellBlocks.SHADOW_CHAIN, new Item.Settings().registryKey(Keys.SHADOW_CHAIN)));

    //grass & dirt
    public static final Item STELLAR_GRASS_BLOCK = register(Keys.STELLAR_GRASS_BLOCK.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_GRASS_BLOCK, new Item.Settings().registryKey(Keys.STELLAR_GRASS_BLOCK)));
    public static final Item CHISELED_STELLAR_GRASS_BLOCK = register(Keys.CHISELED_STELLAR_GRASS_BLOCK.getValue().getPath(), new BlockItem(AerialHellBlocks.CHISELED_STELLAR_GRASS_BLOCK, new Item.Settings().registryKey(Keys.CHISELED_STELLAR_GRASS_BLOCK)));
    public static final Item STELLAR_DIRT = register(Keys.STELLAR_DIRT.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_DIRT, new Item.Settings().registryKey(Keys.STELLAR_DIRT)));
    public static final Item STELLAR_COARSE_DIRT = register(Keys.STELLAR_COARSE_DIRT.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_COARSE_DIRT, new Item.Settings().registryKey(Keys.STELLAR_COARSE_DIRT)));
    public static final Item STELLAR_FARMLAND = register(Keys.STELLAR_FARMLAND.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_FARMLAND, new Item.Settings().registryKey(Keys.STELLAR_FARMLAND)));
    public static final Item STELLAR_DIRT_PATH = register(Keys.STELLAR_DIRT_PATH.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_DIRT_PATH, new Item.Settings().registryKey(Keys.STELLAR_DIRT_PATH)));
    public static final Item STELLAR_PODZOL = register(Keys.STELLAR_PODZOL.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_PODZOL, new Item.Settings().registryKey(Keys.STELLAR_PODZOL)));
    public static final Item STELLAR_CRYSTAL_PODZOL = register(Keys.STELLAR_CRYSTAL_PODZOL.getValue().getPath(), new BlockItem(AerialHellBlocks.STELLAR_CRYSTAL_PODZOL, new Item.Settings().registryKey(Keys.STELLAR_CRYSTAL_PODZOL)));
    public static final Item CHISELED_STELLAR_DIRT = register(Keys.CHISELED_STELLAR_DIRT.getValue().getPath(), new BlockItem(AerialHellBlocks.CHISELED_STELLAR_DIRT, new Item.Settings().registryKey(Keys.CHISELED_STELLAR_DIRT)));
    public static final Item SHADOW_GRASS_BLOCK = register(Keys.SHADOW_GRASS_BLOCK.getValue().getPath(), new BlockItem(AerialHellBlocks.SHADOW_GRASS_BLOCK, new Item.Settings().registryKey(Keys.SHADOW_GRASS_BLOCK)));
    ...
    //cropper pine
    public static final Item COPPER_PINE_LOG = register(Keys.COPPER_PINE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.COPPER_PINE_LOG, new Item.Settings().registryKey(Keys.COPPER_PINE_LOG), 300));
    public static final Item STRIPPED_COPPER_PINE_LOG = register(Keys.STRIPPED_COPPER_PINE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_COPPER_PINE_LOG, new Item.Settings().registryKey(Keys.STRIPPED_COPPER_PINE_LOG), 300));
    public static final Item COPPER_PINE_WOOD = register(Keys.COPPER_PINE_WOOD.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.COPPER_PINE_WOOD, new Item.Settings().registryKey(Keys.COPPER_PINE_WOOD), 210));
    public static final Item STRIPPED_COPPER_PINE_WOOD = register(Keys.STRIPPED_COPPER_PINE_WOOD.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_COPPER_PINE_WOOD, new Item.Settings().registryKey(Keys.STRIPPED_COPPER_PINE_WOOD), 210));
    public static final Item COPPER_PINE_PLANKS = register(Keys.COPPER_PINE_PLANKS.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.COPPER_PINE_PLANKS, new Item.Settings().registryKey(Keys.COPPER_PINE_PLANKS), 300));
    ...
    //lapis robinia
    public static final Item LAPIS_ROBINIA_LOG = register(Keys.LAPIS_ROBINIA_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.LAPIS_ROBINIA_LOG, new Item.Settings().registryKey(Keys.LAPIS_ROBINIA_LOG), 400));
    public static final Item ENCHANTED_LAPIS_ROBINIA_LOG = register(Keys.ENCHANTED_LAPIS_ROBINIA_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.ENCHANTED_LAPIS_ROBINIA_LOG, new Item.Settings().registryKey(Keys.ENCHANTED_LAPIS_ROBINIA_LOG), 400));
    public static final Item STRIPPED_LAPIS_ROBINIA_LOG = register(Keys.STRIPPED_LAPIS_ROBINIA_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_LAPIS_ROBINIA_LOG, new Item.Settings().registryKey(Keys.STRIPPED_LAPIS_ROBINIA_LOG), 400));
    public static final Item LAPIS_ROBINIA_WOOD = register(Keys.LAPIS_ROBINIA_WOOD.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.LAPIS_ROBINIA_WOOD, new Item.Settings().registryKey(Keys.LAPIS_ROBINIA_WOOD), 300));
    public static final Item STRIPPED_LAPIS_ROBINIA_WOOD = register(Keys.STRIPPED_LAPIS_ROBINIA_WOOD.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_LAPIS_ROBINIA_WOOD, new Item.Settings().registryKey(Keys.STRIPPED_LAPIS_ROBINIA_WOOD), 300));
    ...
    public static final Item LAPIS_ROBINIA_PLANKS = register(Keys.LAPIS_ROBINIA_PLANKS.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.LAPIS_ROBINIA_PLANKS, new Item.Settings().registryKey(Keys.LAPIS_ROBINIA_PLANKS), 300));
    ...
    //shadow_pine
    public static final Item SHADOW_PINE_LOG = register(Keys.SHADOW_PINE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.SHADOW_PINE_LOG, new Item.Settings().registryKey(Keys.SHADOW_PINE_LOG), 300));
    public static final Item EYE_SHADOW_PINE_LOG = register(Keys.EYE_SHADOW_PINE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.EYE_SHADOW_PINE_LOG, new Item.Settings().registryKey(Keys.EYE_SHADOW_PINE_LOG), 300));
    public static final Item STRIPPED_SHADOW_PINE_LOG = register(Keys.STRIPPED_SHADOW_PINE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_SHADOW_PINE_LOG, new Item.Settings().registryKey(Keys.STRIPPED_SHADOW_PINE_LOG), 300));
    public static final Item SHADOW_PINE_WOOD = register(Keys.SHADOW_PINE_WOOD.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.SHADOW_PINE_WOOD, new Item.Settings().registryKey(Keys.SHADOW_PINE_WOOD), 210));
    public static final Item STRIPPED_SHADOW_PINE_WOOD = register(Keys.STRIPPED_SHADOW_PINE_WOOD.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_SHADOW_PINE_WOOD, new Item.Settings().registryKey(Keys.STRIPPED_SHADOW_PINE_WOOD), 210));
    ...
    public static final Item SHADOW_PINE_PLANKS = register(Keys.SHADOW_PINE_PLANKS.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.SHADOW_PINE_PLANKS, new Item.Settings().registryKey(Keys.SHADOW_PINE_PLANKS), 300));
    ...
    //stellar jungle tree
    public static final Item STELLAR_JUNGLE_TREE_LOG = register(Keys.STELLAR_JUNGLE_TREE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STELLAR_JUNGLE_TREE_LOG, new Item.Settings().registryKey(Keys.STELLAR_JUNGLE_TREE_LOG), 400));
    public static final Item STRIPPED_STELLAR_JUNGLE_TREE_LOG = register(Keys.STRIPPED_STELLAR_JUNGLE_TREE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_STELLAR_JUNGLE_TREE_LOG, new Item.Settings().registryKey(Keys.STRIPPED_STELLAR_JUNGLE_TREE_LOG), 400));
    public static final Item STELLAR_JUNGLE_TREE_WOOD = register(Keys.STELLAR_JUNGLE_TREE_WOOD.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STELLAR_JUNGLE_TREE_WOOD, new Item.Settings().registryKey(Keys.STELLAR_JUNGLE_TREE_WOOD), 300));
    public static final Item STRIPPED_STELLAR_JUNGLE_TREE_WOOD = register(Keys.STRIPPED_STELLAR_JUNGLE_TREE_WOOD.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_STELLAR_JUNGLE_TREE_WOOD, new Item.Settings().registryKey(Keys.STRIPPED_STELLAR_JUNGLE_TREE_WOOD), 300));
    ...
    public static final Item STELLAR_JUNGLE_TREE_PLANKS = register(Keys.STELLAR_JUNGLE_TREE_PLANKS.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STELLAR_JUNGLE_TREE_PLANKS, new Item.Settings().registryKey(Keys.STELLAR_JUNGLE_TREE_PLANKS), 300));
    ...
    public static final Item DEAD_STELLAR_JUNGLE_TREE_LOG = register(Keys.DEAD_STELLAR_JUNGLE_TREE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.DEAD_STELLAR_JUNGLE_TREE_LOG, new Item.Settings().registryKey(Keys.DEAD_STELLAR_JUNGLE_TREE_LOG), 300));

    //shroom
    public static final Item GIANT_CORTINARIUS_VIOLACEUS_STEM = register(Keys.GIANT_CORTINARIUS_VIOLACEUS_STEM.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.GIANT_CORTINARIUS_VIOLACEUS_STEM, new Item.Settings().registryKey(Keys.GIANT_CORTINARIUS_VIOLACEUS_STEM), 100));
    ...
    public static final Item GIANT_CORTINARIUS_VIOLACEUS_BARK_STEM = register(Keys.GIANT_CORTINARIUS_VIOLACEUS_BARK_STEM.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.GIANT_CORTINARIUS_VIOLACEUS_BARK_STEM, new Item.Settings().registryKey(Keys.GIANT_CORTINARIUS_VIOLACEUS_BARK_STEM), 100));
    ...
    public static final Item GIANT_VERDIGRIS_AGARIC_STEM = register(Keys.GIANT_VERDIGRIS_AGARIC_STEM.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.GIANT_VERDIGRIS_AGARIC_STEM, new Item.Settings().registryKey(Keys.GIANT_VERDIGRIS_AGARIC_STEM), 100));
    public static final Item STRIPPED_GIANT_VERDIGRIS_AGARIC_STEM = register(Keys.STRIPPED_GIANT_VERDIGRIS_AGARIC_STEM.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_GIANT_VERDIGRIS_AGARIC_STEM, new Item.Settings().registryKey(Keys.STRIPPED_GIANT_VERDIGRIS_AGARIC_STEM), 100));
    public static final Item GIANT_VERDIGRIS_AGARIC_BARK_STEM = register(Keys.GIANT_VERDIGRIS_AGARIC_BARK_STEM.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.GIANT_VERDIGRIS_AGARIC_BARK_STEM, new Item.Settings().registryKey(Keys.GIANT_VERDIGRIS_AGARIC_BARK_STEM), 75));
    public static final Item STRIPPED_GIANT_VERDIGRIS_AGARIC_BARK_STEM = register(Keys.STRIPPED_GIANT_VERDIGRIS_AGARIC_BARK_STEM.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.STRIPPED_GIANT_VERDIGRIS_AGARIC_BARK_STEM, new Item.Settings().registryKey(Keys.STRIPPED_GIANT_VERDIGRIS_AGARIC_BARK_STEM), 75));
    ...
    public static final Item GRAY_SHROOM_PLANKS = register(Keys.GRAY_SHROOM_PLANKS.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.GRAY_SHROOM_PLANKS, new Item.Settings().registryKey(Keys.GRAY_SHROOM_PLANKS), 100));
    ...
    public static final Item SHADOW_AERIAL_TREE_LOG = register(Keys.SHADOW_AERIAL_TREE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.SHADOW_AERIAL_TREE_LOG, new Item.Settings().registryKey(Keys.SHADOW_AERIAL_TREE_LOG), 300));
    public static final Item SHADOW_GOLDEN_BEECH_LOG = register(Keys.SHADOW_GOLDEN_BEECH_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.SHADOW_GOLDEN_BEECH_LOG, new Item.Settings().registryKey(Keys.SHADOW_GOLDEN_BEECH_LOG), 300));
    public static final Item SHADOW_COPPER_PINE_LOG = register(Keys.SHADOW_COPPER_PINE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.SHADOW_COPPER_PINE_LOG, new Item.Settings().registryKey(Keys.SHADOW_COPPER_PINE_LOG), 300));
    public static final Item SHADOW_LAPIS_ROBINIA_LOG = register(Keys.SHADOW_LAPIS_ROBINIA_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.SHADOW_LAPIS_ROBINIA_LOG, new Item.Settings().registryKey(Keys.SHADOW_LAPIS_ROBINIA_LOG), 300));
    public static final Item SHADOW_STELLAR_JUNGLE_TREE_LOG = register(Keys.SHADOW_STELLAR_JUNGLE_TREE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.SHADOW_STELLAR_JUNGLE_TREE_LOG, new Item.Settings().registryKey(Keys.SHADOW_STELLAR_JUNGLE_TREE_LOG), 300));
    public static final Item HOLLOW_SHADOW_PINE_LOG = register(Keys.HOLLOW_SHADOW_PINE_LOG.getValue().getPath(), new BurnableBlockItem(AerialHellBlocks.HOLLOW_SHADOW_PINE_LOG, new Item.Settings().registryKey(Keys.HOLLOW_SHADOW_PINE_LOG), 300));
    ...
    public static final Item FLUORITE = register(Keys.FLUORITE.getValue().getPath(), new Item(new Item.Settings().registryKey(Keys.FLUORITE)));
    public static final Item MAGMATIC_GEL = register(Keys.MAGMATIC_GEL.getValue().getPath(),new Item(new Item.Settings().registryKey(Keys.MAGMATIC_GEL)));
    public static final Item RUBY = register(Keys.RUBY.getValue().getPath(), new Item(new Item.Settings().registryKey(Keys.RUBY)));
    ...
    public static final Item VOLUCITE_VIBRANT = register(Keys.VOLUCITE_VIBRANT.getValue().getPath(), new VoluciteVibrantItem(new Item.Settings().registryKey(Keys.VOLUCITE_VIBRANT).rarity(AerialHellRarities.VIBRANT)));
    ...
    //legendary ores
    public static final Item ARSONIST_INGOT = register(Keys.ARSONIST_INGOT.getValue().getPath(), new Item(new Item.Settings().registryKey(Keys.ARSONIST_INGOT).rarity(AerialHellRarities.LEGENDARY).fireproof()));
    public static final Item LUNATIC_CRYSTAL = register(Keys.LUNATIC_CRYSTAL.getValue().getPath(), new Item(new Item.Settings().registryKey(Keys.LUNATIC_CRYSTAL).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item OBSIDIAN_SHARD = register(Keys.OBSIDIAN_SHARD.getValue().getPath(), new Item(new Item.Settings().registryKey(Keys.OBSIDIAN_SHARD).rarity(Rarity.EPIC)));
    public static final Item CURSED_CRYSAL = register(Keys.CURSED_CRYSAL.getValue().getPath(), new Item(new Item.Settings().registryKey(Keys.CURSED_CRYSAL).rarity(AerialHellRarities.CORRUPTED)));
    ...
    //signs
    public static final Item AERIAL_TREE_SIGN = register(Keys.AERIAL_TREE_SIGN.getValue().getPath(), new SignItem(AerialHellBlocks.AERIAL_TREE_WALL_SIGN, AerialHellBlocks.AERIAL_TREE_STANDING_SIGN, new Item.Settings().registryKey(Keys.AERIAL_TREE_SIGN).useBlockPrefixedTranslationKey()));
    public static final Item GOLDEN_BEECH_SIGN = register(Keys.GOLDEN_BEECH_SIGN.getValue().getPath(), new SignItem(AerialHellBlocks.GOLDEN_BEECH_WALL_SIGN, AerialHellBlocks.GOLDEN_BEECH_STANDING_SIGN, new Item.Settings().registryKey(Keys.GOLDEN_BEECH_SIGN).useBlockPrefixedTranslationKey()));
    public static final Item COPPER_PINE_SIGN = register(Keys.COPPER_PINE_SIGN.getValue().getPath(), new SignItem(AerialHellBlocks.COPPER_PINE_WALL_SIGN, AerialHellBlocks.COPPER_PINE_STANDING_SIGN, new Item.Settings().registryKey(Keys.COPPER_PINE_SIGN).useBlockPrefixedTranslationKey()));
    public static final Item LAPIS_ROBINIA_SIGN = register(Keys.LAPIS_ROBINIA_SIGN.getValue().getPath(), new SignItem(AerialHellBlocks.LAPIS_ROBINIA_WALL_SIGN, AerialHellBlocks.LAPIS_ROBINIA_STANDING_SIGN, new Item.Settings().registryKey(Keys.LAPIS_ROBINIA_SIGN).useBlockPrefixedTranslationKey()));
    public static final Item SHADOW_PINE_SIGN = register(Keys.SHADOW_PINE_SIGN.getValue().getPath(), new SignItem(AerialHellBlocks.SHADOW_PINE_WALL_SIGN, AerialHellBlocks.SHADOW_PINE_STANDING_SIGN, new Item.Settings().registryKey(Keys.SHADOW_PINE_SIGN).useBlockPrefixedTranslationKey()));
    public static final Item STELLAR_JUNGLE_TREE_SIGN = register(Keys.STELLAR_JUNGLE_TREE_SIGN.getValue().getPath(), new SignItem(AerialHellBlocks.STELLAR_JUNGLE_TREE_WALL_SIGN, AerialHellBlocks.STELLAR_JUNGLE_TREE_STANDING_SIGN, new Item.Settings().registryKey(Keys.STELLAR_JUNGLE_TREE_SIGN).useBlockPrefixedTranslationKey()));
    public static final Item SKY_CACTUS_FIBER_SIGN = register(Keys.SKY_CACTUS_FIBER_SIGN.getValue().getPath(), new SignItem(AerialHellBlocks.SKY_CACTUS_FIBER_WALL_SIGN, AerialHellBlocks.SKY_CACTUS_FIBER_STANDING_SIGN, new Item.Settings().registryKey(Keys.SKY_CACTUS_FIBER_SIGN).useBlockPrefixedTranslationKey()));
    public static final Item GRAY_SHROOM_SIGN = register(Keys.GRAY_SHROOM_SIGN.getValue().getPath(), new SignItem(AerialHellBlocks.GRAY_SHROOM_WALL_SIGN, AerialHellBlocks.GRAY_SHROOM_STANDING_SIGN, new Item.Settings().registryKey(Keys.GRAY_SHROOM_SIGN).useBlockPrefixedTranslationKey()));
    ...
    //tools
    public static final PickaxeItem SKY_WOOD_PICKAXE = register(Keys.SKY_WOOD_PICKAXE.getValue().getPath(), new PickaxeItem(ToolMaterials.SKY_WOOD, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.SKY_WOOD_PICKAXE)));
    public static final PickaxeItem STELLAR_STONE_PICKAXE = register(Keys.STELLAR_STONE_PICKAXE.getValue().getPath(), new PickaxeItem(ToolMaterials.STELLAR_STONE, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.STELLAR_STONE_PICKAXE)));
    public static final PickaxeItem RUBY_PICKAXE = register(Keys.RUBY_PICKAXE.getValue().getPath(), new PickaxeItem(ToolMaterials.RUBY, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.RUBY_PICKAXE)));
    public static final PickaxeItem AZURITE_PICKAXE = register(Keys.AZURITE_PICKAXE.getValue().getPath(), new PickaxeItem(ToolMaterials.AZURITE, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.AZURITE_PICKAXE)));
    public static final PickaxeItem MAGMATIC_GEL_PICKAXE = register(Keys.MAGMATIC_GEL_PICKAXE.getValue().getPath(), new PickaxeItem(ToolMaterials.MAGMATIC_GEL, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.MAGMATIC_GEL_PICKAXE)));
    public static final PickaxeItem OBSIDIAN_PICKAXE = register(Keys.OBSIDIAN_PICKAXE.getValue().getPath(), new PickaxeItem(ToolMaterials.OBSIDIAN, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.OBSIDIAN_PICKAXE).rarity(Rarity.EPIC)));
    public static final PickaxeItem VOLUCITE_PICKAXE = register(Keys.VOLUCITE_PICKAXE.getValue().getPath(), new EffectPickaxeItem(ToolMaterials.VOLUCITE, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.VOLUCITE_PICKAXE).rarity(AerialHellRarities.VIBRANT)));
    public static final PickaxeItem LUNATIC_PICKAXE = register(Keys.LUNATIC_PICKAXE.getValue().getPath(), new PickaxeItem(ToolMaterials.LUNATIC, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.LUNATIC_PICKAXE).rarity(AerialHellRarities.LEGENDARY)));
    public static final PickaxeItem ARSONIST_PICKAXE = register(Keys.ARSONIST_PICKAXE.getValue().getPath(), new PickaxeItem(ToolMaterials.ARSONIST, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.ARSONIST_PICKAXE).fireproof().rarity(AerialHellRarities.MYTHICAL)));

    public static final PickaxeItem MAGMA_CUBE_PICKAXE = register(Keys.MAGMA_CUBE_PICKAXE.getValue().getPath(), new EffectPickaxeItem(ToolMaterials.OBSIDIAN, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.MAGMA_CUBE_PICKAXE).rarity(AerialHellRarities.LEGENDARY)));
    public static final PickaxeItem STELLAR_STONE_BREAKER = register(Keys.STELLAR_STONE_BREAKER.getValue().getPath(), new AerialHellPickaxeItem(ToolMaterials.BREAKER, 1.0F, -2.8F, new Item.Settings().registryKey(Keys.STELLAR_STONE_BREAKER).rarity(Rarity.EPIC)));
    ...
    //weapons
    public static final SwordItem SKY_WOOD_SWORD = register(Keys.SKY_WOOD_SWORD.getValue().getPath(), new SwordItem(ToolMaterials.SKY_WOOD, 3, -2.4F, new Item.Settings().registryKey(Keys.SKY_WOOD_SWORD)));
    public static final SwordItem STELLAR_STONE_SWORD = register(Keys.STELLAR_STONE_SWORD.getValue().getPath(), new SwordItem(ToolMaterials.STELLAR_STONE, 3, -2.4F, new Item.Settings().registryKey(Keys.STELLAR_STONE_SWORD)));
    public static final SwordItem RUBY_SWORD = register(Keys.RUBY_SWORD.getValue().getPath(), new SwordItem(ToolMaterials.RUBY, 3, -2.4F, new Item.Settings().registryKey(Keys.RUBY_SWORD)));
    public static final SwordItem AZURITE_SWORD = register(Keys.AZURITE_SWORD.getValue().getPath(), new SwordItem(ToolMaterials.AZURITE, 3, -2.4F, new Item.Settings().registryKey(Keys.AZURITE_SWORD)));
    public static final SwordItem MAGMATIC_GEL_SWORD = register(Keys.MAGMATIC_GEL_SWORD.getValue().getPath(), new SwordItem(ToolMaterials.MAGMATIC_GEL, 3, -2.4F, new Item.Settings().registryKey(Keys.MAGMATIC_GEL_SWORD)));
    public static final SwordItem OBSIDIAN_SWORD = register(Keys.OBSIDIAN_SWORD.getValue().getPath(), new SwordItem(ToolMaterials.OBSIDIAN, 3, -2.4F, new Item.Settings().registryKey(Keys.OBSIDIAN_SWORD).rarity(Rarity.EPIC)));
    public static final SwordItem VOLUCITE_SWORD = register(Keys.VOLUCITE_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.VOLUCITE, 3, -2.4F, new Item.Settings().registryKey(Keys.VOLUCITE_SWORD).rarity(AerialHellRarities.VIBRANT)));
    public static final SwordItem LUNATIC_SWORD = register(Keys.LUNATIC_SWORD.getValue().getPath(), new SwordItem(ToolMaterials.LUNATIC, 3, -2.4F, new Item.Settings().registryKey(Keys.LUNATIC_SWORD).rarity(AerialHellRarities.LEGENDARY)));
    public static final SwordItem ARSONIST_SWORD = register(Keys.ARSONIST_SWORD.getValue().getPath(), new AerialHellSwordItem(ToolMaterials.ARSONIST, 3, -2.4F, new Item.Settings().registryKey(Keys.ARSONIST_SWORD).fireproof().rarity(AerialHellRarities.MYTHICAL)));

    public static final SwordItem HEAVY_SWORD = register(Keys.HEAVY_SWORD.getValue().getPath(), new AerialHellSwordItem(ToolMaterials.HEAVY, 3, -2.7F, -0.30F, 0.0F, new Item.Settings().registryKey(Keys.HEAVY_SWORD).fireproof().rarity(Rarity.EPIC)));
    public static final SwordItem HEALTH_BOOST_SWORD = register(Keys.HEALTH_BOOST_SWORD.getValue().getPath(), new AerialHellSwordItem(ToolMaterials.LUNATIC, 3, -2.4F, 0.0F, 4.0F, new Item.Settings().registryKey(Keys.HEALTH_BOOST_SWORD).fireproof().rarity(Rarity.EPIC)));
    public static final SwordItem NINJA_SWORD = register(Keys.NINJA_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.OBSIDIAN, 2, -1.6F, 0.15F, 0.0F, new Item.Settings().registryKey(Keys.NINJA_SWORD).fireproof().rarity(AerialHellRarities.LEGENDARY)));
    public static final SwordItem NINJA_MASTER_SWORD = register(Keys.NINJA_MASTER_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.OBSIDIAN, 4, -2.4F, 0.15F, 0.0F, new Item.Settings().registryKey(Keys.NINJA_MASTER_SWORD).fireproof().rarity(AerialHellRarities.MYTHICAL)));
    public static final SwordItem GLOUTON_SWORD = register(Keys.GLOUTON_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.RUBY, 3, -2.4F, new Item.Settings().registryKey(Keys.GLOUTON_SWORD).fireproof().fireproof().rarity(AerialHellRarities.LEGENDARY)));
    public static final SwordItem RANDOM_SWORD = register(Keys.RANDOM_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.RUBY, 2, -2.4F, new Item.Settings().registryKey(Keys.RANDOM_SWORD).fireproof().rarity(Rarity.EPIC)));
    public static final SwordItem DISLOYAL_SWORD = register(Keys.DISLOYAL_SWORD.getValue().getPath(), new AerialHellSwordItem(ToolMaterials.LUNATIC, 2, -2.4F, new Item.Settings().registryKey(Keys.DISLOYAL_SWORD).fireproof().rarity(AerialHellRarities.LEGENDARY)));
    public static final SwordItem CURSED_SWORD = register(Keys.CURSED_SWORD.getValue().getPath(), new AerialHellSwordItem(ToolMaterials.SHADOW, 1, -2.5F, new Item.Settings().registryKey(Keys.CURSED_SWORD).fireproof().rarity(AerialHellRarities.CORRUPTED)));
    public static final SwordItem ABSOLUTE_ZERO_SWORD = register(Keys.ABSOLUTE_ZERO_SWORD.getValue().getPath(), new AerialHellSwordItem(ToolMaterials.LUNATIC, 2, -2.4F, new Item.Settings().registryKey(Keys.ABSOLUTE_ZERO_SWORD).fireproof().rarity(AerialHellRarities.MYTHICAL)));
    public static final SwordItem SWORD_OF_LIGHT = register(Keys.SWORD_OF_LIGHT.getValue().getPath(), new EffectSwordItem(ToolMaterials.LUNATIC, 2, -2.4F, new Item.Settings().registryKey(Keys.SWORD_OF_LIGHT).fireproof().rarity(AerialHellRarities.LEGENDARY)));
    public static final SwordItem ANTIDOTE_SWORD = register(Keys.ANTIDOTE_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.RUBY, 4, -2.4F, new Item.Settings().registryKey(Keys.ANTIDOTE_SWORD).fireproof().rarity(Rarity.EPIC)));
    public static final SwordItem NETHERIAN_KING_SWORD = register(Keys.NETHERIAN_KING_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.OBSIDIAN, 1, -2.4F, new Item.Settings().registryKey(Keys.NETHERIAN_KING_SWORD).fireproof().rarity(AerialHellRarities.LEGENDARY)));
    public static final SwordItem GLASS_CANON_SWORD = register(Keys.GLASS_CANON_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.ARSONIST, 7, -1.6F, new Item.Settings().registryKey(Keys.GLASS_CANON_SWORD).fireproof().rarity(AerialHellRarities.MYTHICAL)));
    public static final SwordItem GOD_SWORD = register(Keys.GOD_SWORD.getValue().getPath(), new EffectSwordItem(ToolMaterials.ARSONIST, 3, -2.4F, new Item.Settings().registryKey(Keys.GOD_SWORD).fireproof().rarity(AerialHellRarities.MYTHICAL)));

    public static final SwordItem FORGOTTEN_BATTLE_TRIDENT = register(Keys.FORGOTTEN_BATTLE_TRIDENT.getValue().getPath(), new ForgottenBattleTridentItem(ToolMaterials.VOLUCITE, 3, -2.9F, 0.2F, 0.0F, new Item.Settings().registryKey(Keys.FORGOTTEN_BATTLE_TRIDENT).maxDamage(1000).rarity(AerialHellRarities.LEGENDARY)));

    //armor
    public static final ArmorItem RUBY_HELMET = register(Keys.RUBY_HELMET.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.RUBY, EquipmentType.HELMET, (new Item.Settings().registryKey(Keys.RUBY_HELMET).maxDamage(EquipmentType.HELMET.getMaxDamage(15)))));
    public static final ArmorItem RUBY_CHESTPLATE = register(Keys.RUBY_CHESTPLATE.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.RUBY, EquipmentType.CHESTPLATE, (new Item.Settings().registryKey(Keys.RUBY_CHESTPLATE).maxDamage(EquipmentType.CHESTPLATE.getMaxDamage(15)))));
    public static final ArmorItem RUBY_LEGGINGS = register(Keys.RUBY_LEGGINGS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.RUBY, EquipmentType.LEGGINGS, (new Item.Settings().registryKey(Keys.RUBY_LEGGINGS)).maxDamage(EquipmentType.LEGGINGS.getMaxDamage(15))));
    public static final ArmorItem RUBY_BOOTS = register(Keys.RUBY_BOOTS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.RUBY, EquipmentType.BOOTS, (new Item.Settings().registryKey(Keys.RUBY_BOOTS)).maxDamage(EquipmentType.BOOTS.getMaxDamage(15))));

    public static final ArmorItem AZURITE_HELMET = register(Keys.AZURITE_HELMET.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.AZURITE, EquipmentType.HELMET, (new Item.Settings().registryKey(Keys.AZURITE_HELMET).maxDamage(EquipmentType.HELMET.getMaxDamage(10)))));
    public static final ArmorItem AZURITE_CHESTPLATE = register(Keys.AZURITE_CHESTPLATE.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.AZURITE, EquipmentType.CHESTPLATE, (new Item.Settings().registryKey(Keys.AZURITE_CHESTPLATE).maxDamage(EquipmentType.CHESTPLATE.getMaxDamage(10)))));
    public static final ArmorItem AZURITE_LEGGINGS = register(Keys.AZURITE_LEGGINGS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.AZURITE, EquipmentType.LEGGINGS, (new Item.Settings().registryKey(Keys.AZURITE_LEGGINGS).maxDamage(EquipmentType.LEGGINGS.getMaxDamage(10)))));
    public static final ArmorItem AZURITE_BOOTS = register(Keys.AZURITE_BOOTS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.AZURITE, EquipmentType.BOOTS, (new Item.Settings().registryKey(Keys.AZURITE_BOOTS).maxDamage(EquipmentType.BOOTS.getMaxDamage(10)))));

    public static final ArmorItem OBSIDIAN_HELMET = register(Keys.OBSIDIAN_HELMET.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.OBSIDIAN, EquipmentType.HELMET, (new Item.Settings().registryKey(Keys.OBSIDIAN_HELMET).maxDamage(EquipmentType.HELMET.getMaxDamage(37))).rarity(Rarity.EPIC)));
    public static final ArmorItem OBSIDIAN_CHESTPLATE = register(Keys.OBSIDIAN_CHESTPLATE.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.OBSIDIAN, EquipmentType.CHESTPLATE, (new Item.Settings().registryKey(Keys.OBSIDIAN_CHESTPLATE).maxDamage(EquipmentType.CHESTPLATE.getMaxDamage(37))).rarity(Rarity.EPIC)));
    public static final ArmorItem OBSIDIAN_LEGGINGS = register(Keys.OBSIDIAN_LEGGINGS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.OBSIDIAN, EquipmentType.LEGGINGS, (new Item.Settings().registryKey(Keys.OBSIDIAN_LEGGINGS).maxDamage(EquipmentType.LEGGINGS.getMaxDamage(37))).rarity(Rarity.EPIC)));
    public static final ArmorItem OBSIDIAN_BOOTS = register(Keys.OBSIDIAN_BOOTS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.OBSIDIAN, EquipmentType.BOOTS, (new Item.Settings().registryKey(Keys.OBSIDIAN_BOOTS).maxDamage(EquipmentType.BOOTS.getMaxDamage(37))).rarity(Rarity.EPIC)));

    public static final ArmorItem VOLUCITE_HELMET = register(Keys.VOLUCITE_HELMET.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.VOLUCITE, EquipmentType.HELMET, (new Item.Settings().registryKey(Keys.VOLUCITE_HELMET).maxDamage(EquipmentType.HELMET.getMaxDamage(35))).rarity(AerialHellRarities.VIBRANT)));
    public static final ArmorItem VOLUCITE_CHESTPLATE = register(Keys.VOLUCITE_CHESTPLATE.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.VOLUCITE, EquipmentType.CHESTPLATE, (new Item.Settings().registryKey(Keys.VOLUCITE_CHESTPLATE).maxDamage(EquipmentType.CHESTPLATE.getMaxDamage(35))).rarity(AerialHellRarities.VIBRANT)));
    public static final ArmorItem VOLUCITE_LEGGINGS = register(Keys.VOLUCITE_LEGGINGS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.VOLUCITE, EquipmentType.LEGGINGS, (new Item.Settings().registryKey(Keys.VOLUCITE_LEGGINGS).maxDamage(EquipmentType.LEGGINGS.getMaxDamage(35))).rarity(AerialHellRarities.VIBRANT)));
    public static final ArmorItem VOLUCITE_BOOTS = register(Keys.VOLUCITE_BOOTS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.VOLUCITE, EquipmentType.BOOTS, (new Item.Settings().registryKey(Keys.VOLUCITE_BOOTS).maxDamage(EquipmentType.BOOTS.getMaxDamage(35))).rarity(AerialHellRarities.VIBRANT)));

    public static final ArmorItem MAGMATIC_GEL_HELMET = register(Keys.MAGMATIC_GEL_HELMET.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.MAGMATIC_GEL, EquipmentType.HELMET, (new Item.Settings().registryKey(Keys.MAGMATIC_GEL_HELMET).maxDamage(EquipmentType.HELMET.getMaxDamage(7)))));
    public static final ArmorItem MAGMATIC_GEL_CHESTPLATE = register(Keys.MAGMATIC_GEL_CHESTPLATE.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.MAGMATIC_GEL, EquipmentType.CHESTPLATE, (new Item.Settings().registryKey(Keys.MAGMATIC_GEL_CHESTPLATE).maxDamage(EquipmentType.CHESTPLATE.getMaxDamage(7)))));
    public static final ArmorItem MAGMATIC_GEL_LEGGINGS = register(Keys.MAGMATIC_GEL_LEGGINGS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.MAGMATIC_GEL, EquipmentType.LEGGINGS, (new Item.Settings().registryKey(Keys.MAGMATIC_GEL_LEGGINGS).maxDamage(EquipmentType.LEGGINGS.getMaxDamage(7)))));
    public static final ArmorItem MAGMATIC_GEL_BOOTS = register(Keys.MAGMATIC_GEL_BOOTS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.MAGMATIC_GEL, EquipmentType.BOOTS, (new Item.Settings().registryKey(Keys.MAGMATIC_GEL_BOOTS).maxDamage(EquipmentType.BOOTS.getMaxDamage(7)))));

    public static final ArmorItem LUNATIC_HELMET = register(Keys.LUNATIC_HELMET.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.LUNATIC, EquipmentType.HELMET, (new Item.Settings().registryKey(Keys.LUNATIC_HELMET).maxDamage(EquipmentType.HELMET.getMaxDamage(33))).rarity(AerialHellRarities.LEGENDARY)));
    public static final ArmorItem LUNATIC_CHESTPLATE = register(Keys.LUNATIC_CHESTPLATE.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.LUNATIC, EquipmentType.CHESTPLATE, (new Item.Settings().registryKey(Keys.LUNATIC_CHESTPLATE).maxDamage(EquipmentType.CHESTPLATE.getMaxDamage(33))).rarity(AerialHellRarities.LEGENDARY)));
    public static final ArmorItem LUNATIC_LEGGINGS = register(Keys.LUNATIC_LEGGINGS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.LUNATIC, EquipmentType.LEGGINGS, (new Item.Settings().registryKey(Keys.LUNATIC_LEGGINGS).maxDamage(EquipmentType.LEGGINGS.getMaxDamage(33))).rarity(AerialHellRarities.LEGENDARY)));
    public static final ArmorItem LUNATIC_BOOTS = register(Keys.LUNATIC_BOOTS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.LUNATIC, EquipmentType.BOOTS, (new Item.Settings().registryKey(Keys.LUNATIC_BOOTS).maxDamage(EquipmentType.BOOTS.getMaxDamage(33))).rarity(AerialHellRarities.LEGENDARY)));

    public static final ArmorItem ARSONIST_HELMET = register(Keys.ARSONIST_HELMET.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.ARSONIST, EquipmentType.HELMET, (new Item.Settings().registryKey(Keys.ARSONIST_HELMET).maxDamage(EquipmentType.HELMET.getMaxDamage(37))).rarity(AerialHellRarities.MYTHICAL).fireproof()));
    public static final ArmorItem ARSONIST_CHESTPLATE = register(Keys.ARSONIST_CHESTPLATE.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.ARSONIST, EquipmentType.CHESTPLATE, (new Item.Settings().registryKey(Keys.ARSONIST_CHESTPLATE).maxDamage(EquipmentType.CHESTPLATE.getMaxDamage(37))).rarity(AerialHellRarities.MYTHICAL).fireproof()));
    public static final ArmorItem ARSONIST_LEGGINGS = register(Keys.ARSONIST_LEGGINGS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.ARSONIST, EquipmentType.LEGGINGS, (new Item.Settings().registryKey(Keys.ARSONIST_LEGGINGS).maxDamage(EquipmentType.LEGGINGS.getMaxDamage(37))).rarity(AerialHellRarities.MYTHICAL).fireproof()));
    public static final ArmorItem ARSONIST_BOOTS = register(Keys.ARSONIST_BOOTS.getValue().getPath(), new ArmorItem(AerialHellArmorMaterials.ARSONIST, EquipmentType.BOOTS, (new Item.Settings().registryKey(Keys.ARSONIST_BOOTS).maxDamage(EquipmentType.BOOTS.getMaxDamage(37))).rarity(AerialHellRarities.MYTHICAL).fireproof()));

    public static final ArmorItem SHADOW_HELMET = register(Keys.SHADOW_HELMET.getValue().getPath(), new ShadowArmorItem(AerialHellArmorMaterials.SHADOW, EquipmentType.HELMET, (new Item.Settings().registryKey(Keys.SHADOW_HELMET).maxDamage(EquipmentType.HELMET.getMaxDamage(25))).rarity(AerialHellRarities.CORRUPTED)));
    public static final ArmorItem SHADOW_CHESTPLATE = register(Keys.SHADOW_CHESTPLATE.getValue().getPath(), new ShadowArmorItem(AerialHellArmorMaterials.SHADOW, EquipmentType.CHESTPLATE, (new Item.Settings().registryKey(Keys.SHADOW_CHESTPLATE).maxDamage(EquipmentType.CHESTPLATE.getMaxDamage(25))).rarity(AerialHellRarities.CORRUPTED)));
    public static final ArmorItem SHADOW_LEGGINGS = register(Keys.SHADOW_LEGGINGS.getValue().getPath(), new ShadowArmorItem(AerialHellArmorMaterials.SHADOW, EquipmentType.LEGGINGS, (new Item.Settings().registryKey(Keys.SHADOW_LEGGINGS).maxDamage(EquipmentType.LEGGINGS.getMaxDamage(25))).rarity(AerialHellRarities.CORRUPTED)));
    public static final ArmorItem SHADOW_BOOTS = register(Keys.SHADOW_BOOTS.getValue().getPath(), new ShadowArmorItem(AerialHellArmorMaterials.SHADOW, EquipmentType.BOOTS, (new Item.Settings().registryKey(Keys.SHADOW_BOOTS).maxDamage(EquipmentType.BOOTS.getMaxDamage(25))).rarity(AerialHellRarities.CORRUPTED)));
    ...
    //spawn eggs
    public static final Item STELLAR_STONE_AUTOMATON_SPAWN_EGG = register(Keys.STELLAR_STONE_AUTOMATON_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.STELLAR_STONE_AUTOMATON, new Item.Settings().registryKey(Keys.STELLAR_STONE_AUTOMATON_SPAWN_EGG).rarity(AerialHellRarities.VIBRANT)));
    public static final Item EVIL_COW_SPAWN_EGG = register(Keys.EVIL_COW_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.EVIL_COW, new Item.Settings().registryKey(Keys.EVIL_COW_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item CORTINARIUS_COW_SPAWN_EGG = register(Keys.CORTINARIUS_COW_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.CORTINARIUS_COW, new Item.Settings().registryKey(Keys.CORTINARIUS_COW_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item STELLAR_ENT_SPAWN_EGG = register(Keys.STELLAR_ENT_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.STELLAR_ENT, new Item.Settings().registryKey(Keys.STELLAR_ENT_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item VENOMOUS_SNAKE_SPAWN_EGG = register(Keys.VENOMOUS_SNAKE_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.VENOMOUS_SNAKE, new Item.Settings().registryKey(Keys.VENOMOUS_SNAKE_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item WORM_SPAWN_EGG = register(Keys.WORM_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.WORM, new Item.Settings().registryKey(Keys.WORM_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item STELLAR_CHICKEN_SPAWN_EGG = register(Keys.STELLAR_CHICKEN_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.STELLAR_CHICKEN, new Item.Settings().registryKey(Keys.STELLAR_CHICKEN_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item STELLAR_BOAR_SPAWN_EGG = register(Keys.STELLAR_BOAR_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.STELLAR_BOAR, new Item.Settings().registryKey(Keys.STELLAR_BOAR_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item SHROOMBOOM_SPAWN_EGG = register(Keys.SHROOMBOOM_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.SHROOMBOOM, new Item.Settings().registryKey(Keys.SHROOMBOOM_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item VERDIGRIS_ZOMBIE_SPAWN_EGG = register(Keys.VERDIGRIS_ZOMBIE_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.VERDIGRIS_ZOMBIE, new Item.Settings().registryKey(Keys.VERDIGRIS_ZOMBIE_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item MUMMY_SPAWN_EGG = register(Keys.MUMMY_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.MUMMY, new Item.Settings().registryKey(Keys.MUMMY_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item SLIME_PIRATE_SPAWN_EGG = register(Keys.SLIME_PIRATE_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.SLIME_PIRATE, new Item.Settings().registryKey(Keys.SLIME_PIRATE_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item SLIME_NINJA_PIRATE_SPAWN_EGG = register(Keys.SLIME_NINJA_PIRATE_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.SLIME_NINJA_PIRATE, new Item.Settings().registryKey(Keys.SLIME_NINJA_PIRATE_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item GHOST_SLIME_PIRATE_SPAWN_EGG = register(Keys.GHOST_SLIME_PIRATE_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.GHOST_SLIME_PIRATE, new Item.Settings().registryKey(Keys.GHOST_SLIME_PIRATE_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item GHOST_SLIME_NINJA_PIRATE_SPAWN_EGG = register(Keys.GHOST_SLIME_NINJA_PIRATE_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.GHOST_SLIME_NINJA_PIRATE, new Item.Settings().registryKey(Keys.GHOST_SLIME_NINJA_PIRATE_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item SANDY_SHEEP_SPAWN_EGG = register(Keys.SANDY_SHEEP_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.SANDY_SHEEP, new Item.Settings().registryKey(Keys.SANDY_SHEEP_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item GLIDING_TURTLE_SPAWN_EGG = register(Keys.GLIDING_TURTLE_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.GLIDING_TURTLE, new Item.Settings().registryKey(Keys.GLIDING_TURTLE_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item FAT_PHANTOM_SPAWN_EGG = register(Keys.FAT_PHANTOM_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.FAT_PHANTOM, new Item.Settings().registryKey(Keys.FAT_PHANTOM_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item KODAMA_SPAWN_EGG = register(Keys.KODAMA_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.KODAMA, new Item.Settings().registryKey(Keys.KODAMA_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item MUD_GOLEM_SPAWN_EGG = register(Keys.MUD_GOLEM_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.MUD_GOLEM, new Item.Settings().registryKey(Keys.MUD_GOLEM_SPAWN_EGG).rarity(Rarity.UNCOMMON)));
    public static final Item MUD_SOLDIER_SPAWN_EGG = register(Keys.MUD_SOLDIER_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.MUD_SOLDIER, new Item.Settings().registryKey(Keys.MUD_SOLDIER_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item MUD_CYCLE_MAGE_SPAWN_EGG = register(Keys.MUD_CYCLE_MAGE_SPAWN_EGG.getValue().getPath(), new BossSpawnEggItem(AerialHellEntities.MUD_CYCLE_MAGE, new Item.Settings().registryKey(Keys.MUD_CYCLE_MAGE_SPAWN_EGG).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item HELL_SPIDER_SPAWN_EGG = register(Keys.HELL_SPIDER_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.HELL_SPIDER, new Item.Settings().registryKey(Keys.HELL_SPIDER_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item CRYSTAL_GOLEM_SPAWN_EGG = register(Keys.CRYSTAL_GOLEM_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.CRYSTAL_GOLEM, new Item.Settings().registryKey(Keys.CRYSTAL_GOLEM_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item CRYSTAL_SLIME_SPAWN_EGG = register(Keys.CRYSTAL_SLIME_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.CRYSTAL_SLIME, new Item.Settings().registryKey(Keys.CRYSTAL_SLIME_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item CRYSTAL_SPIDER_SPAWN_EGG = register(Keys.CRYSTAL_SPIDER_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.CRYSTAL_SPIDER, new Item.Settings().registryKey(Keys.CRYSTAL_SPIDER_SPAWN_EGG).rarity(Rarity.UNCOMMON)));
    public static final Item LUNATIC_PRIEST_SPAWN_EGG = register(Keys.LUNATIC_PRIEST_SPAWN_EGG.getValue().getPath(), new BossSpawnEggItem(AerialHellEntities.LUNATIC_PRIEST, new Item.Settings().registryKey(Keys.LUNATIC_PRIEST_SPAWN_EGG).rarity(AerialHellRarities.MYTHICAL)));
    public static final Item CRYSTAL_CATERPILLAR_SPAWN_EGG = register(Keys.CRYSTAL_CATERPILLAR_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.CRYSTAL_CATERPILLAR, new Item.Settings().registryKey(Keys.CRYSTAL_CATERPILLAR_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item FOREST_CATERPILLAR_SPAWN_EGG = register(Keys.FOREST_CATERPILLAR_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.FOREST_CATERPILLAR, new Item.Settings().registryKey(Keys.FOREST_CATERPILLAR_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item TORN_SPIRIT_SPAWN_EGG = register(Keys.TORN_SPIRIT_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.TORN_SPIRIT, new Item.Settings().registryKey(Keys.TORN_SPIRIT_SPAWN_EGG).rarity(Rarity.EPIC)));
    public static final Item CHAINED_GOD_SPAWN_EGG = register(Keys.CHAINED_GOD_SPAWN_EGG.getValue().getPath(), new BossSpawnEggItem(AerialHellEntities.CHAINED_GOD, new Item.Settings().registryKey(Keys.CHAINED_GOD_SPAWN_EGG).rarity(AerialHellRarities.MYTHICAL)));
    public static final Item ICE_SPIRIT_SPAWN_EGG = register(Keys.ICE_SPIRIT_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.ICE_SPIRIT, new Item.Settings().registryKey(Keys.ICE_SPIRIT_SPAWN_EGG).rarity(Rarity.UNCOMMON)));
    public static final Item FIRE_SPIRIT_SPAWN_EGG = register(Keys.FIRE_SPIRIT_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.FIRE_SPIRIT, new Item.Settings().registryKey(Keys.FIRE_SPIRIT_SPAWN_EGG).rarity(Rarity.UNCOMMON)));
    public static final Item ELECTRO_SPIRIT_SPAWN_EGG = register(Keys.ELECTRO_SPIRIT_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.ELECTRO_SPIRIT, new Item.Settings().registryKey(Keys.ELECTRO_SPIRIT_SPAWN_EGG).rarity(Rarity.UNCOMMON)));
    public static final Item FLYING_JELLYFISH_SPAWN_EGG = register(Keys.FLYING_JELLYFISH_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.FLYING_JELLYFISH, new Item.Settings().registryKey(Keys.FLYING_JELLYFISH_SPAWN_EGG).rarity(Rarity.COMMON)));
    public static final Item SHADOW_FLYING_SKULL_SPAWN_EGG = register(Keys.SHADOW_FLYING_SKULL_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.SHADOW_FLYING_SKULL, new Item.Settings().registryKey(Keys.SHADOW_FLYING_SKULL_SPAWN_EGG).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_TROLL_SPAWN_EGG = register(Keys.SHADOW_TROLL_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.SHADOW_TROLL, new Item.Settings().registryKey(Keys.SHADOW_TROLL_SPAWN_EGG).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_AUTOMATON_SPAWN_EGG = register(Keys.SHADOW_AUTOMATON_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.SHADOW_AUTOMATON, new Item.Settings().registryKey(Keys.SHADOW_AUTOMATON_SPAWN_EGG).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_SPIDER_SPAWN_EGG = register(Keys.SHADOW_SPIDER_SPAWN_EGG.getValue().getPath(), new SpawnEggItem(AerialHellEntities.SHADOW_SPIDER, new Item.Settings().registryKey(Keys.SHADOW_SPIDER_SPAWN_EGG).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item LILITH_SPAWN_EGG = register(Keys.LILITH_SPAWN_EGG.getValue().getPath(), new BossSpawnEggItem(AerialHellEntities.LILITH, new Item.Settings().registryKey(Keys.LILITH_SPAWN_EGG).rarity(AerialHellRarities.CORRUPTED)));
