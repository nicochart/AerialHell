...
public class AerialHellItems
{
    ...
    public static final DeferredItem<Item> VOLUCITE_PICKAXE = ITEMS.register(Keys.VOLUCITE_PICKAXE.identifier().getPath(), () -> new EffectPickaxeItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_PICKAXE).pickaxe(ToolMaterials.VOLUCITE, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue())));
    ...
    public static final DeferredItem<Item> VOLUCITE_SHOVEL = ITEMS.register(Keys.VOLUCITE_SHOVEL.identifier().getPath(), () -> new EffectShovelItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_SHOVEL).shovel(ToolMaterials.VOLUCITE, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue())));
    ...
    public static final DeferredItem<Item> VOLUCITE_AXE = ITEMS.register(Keys.VOLUCITE_AXE.identifier().getPath(), () -> new EffectAxeItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_AXE).axe(ToolMaterials.VOLUCITE, 6.0F, -3.1F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue())));
    ...
    public static final DeferredItem<Item> VOLUCITE_HOE = ITEMS.register(Keys.VOLUCITE_HOE.identifier().getPath(), () -> new EffectHoeItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_HOE).hoe(ToolMaterials.VOLUCITE, 0.0F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue())));
    ...
    public static final DeferredItem<Item> VOLUCITE_SWORD = ITEMS.register(Keys.VOLUCITE_SWORD.identifier().getPath(), () -> new EffectSwordItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_SWORD).sword(ToolMaterials.VOLUCITE, 3, -2.4F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue())));
