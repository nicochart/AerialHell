...
public class AerialHellItems
{
    ...
    public static final Item SHADOW_FRUIT_STEW = register(Keys.SHADOW_FRUIT_STEW.identifier().getPath(), new SkySoupItem(new Item.Properties().setId(Keys.SHADOW_FRUIT_STEW).rarity(AerialHellRarities.CORRUPTED).stacksTo(16).food(AerialHellFoods.Properties.SHADOW_FRUIT_STEW, AerialHellFoods.Consumables.SHADOW_FRUIT_STEW)));
    public static final Item SOLID_ETHER_SOUP = register(Keys.SOLID_ETHER_SOUP.identifier().getPath(), new SkySoupItem(new Item.Properties().setId(Keys.SOLID_ETHER_SOUP).rarity(Rarity.COMMON).stacksTo(16).food(AerialHellFoods.Properties.SOLID_ETHER_SOUP, AerialHellFoods.Consumables.SOLID_ETHER_SOUP)));
    ...
    public static final Item MAGMATIC_GEL_PICKAXE = register(Keys.MAGMATIC_GEL_PICKAXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_PICKAXE).pickaxe(AerialHellToolMaterials.MAGMATIC_GEL, 1.0F, -2.8F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL))));
    ...
    public static final Item LUNATIC_PICKAXE = register(Keys.LUNATIC_PICKAXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_PICKAXE).pickaxe(AerialHellToolMaterials.LUNATIC, 1.0F, -2.8F).rarity(AerialHellRarities.LEGENDARY).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.LUNAR_TOOL))));
    public static final Item ARSONIST_PICKAXE = register(Keys.ARSONIST_PICKAXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_PICKAXE).pickaxe(AerialHellToolMaterials.ARSONIST, 1.0F, -2.8F).fireResistant().rarity(AerialHellRarities.MYTHICAL).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_TOOL))));
    ...
    public static final Item STELLAR_STONE_BREAKER = register(Keys.STELLAR_STONE_BREAKER.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_BREAKER).pickaxe(AerialHellToolMaterials.BREAKER, 1.0F, -2.8F).rarity(Rarity.EPIC).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MINE_STONE_FAST))));

    public static final Item SKY_WOOD_SHOVEL = register(Keys.SKY_WOOD_SHOVEL.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_SHOVEL).shovel(AerialHellToolMaterials.SKY_WOOD, 1.5F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final Item STELLAR_STONE_SHOVEL = register(Keys.STELLAR_STONE_SHOVEL.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().shovel(AerialHellToolMaterials.STELLAR_STONE, 1.5F, -3.0F).setId(Keys.STELLAR_STONE_SHOVEL).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final Item RUBY_SHOVEL = register(Keys.RUBY_SHOVEL.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RUBY_SHOVEL).shovel(AerialHellToolMaterials.RUBY, 1.5F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    public static final Item AZURITE_SHOVEL = register(Keys.AZURITE_SHOVEL.identifier().getPath(), new AerialHellItem(new  AerialHellItem.Properties().setId(Keys.AZURITE_SHOVEL).shovel(AerialHellToolMaterials.AZURITE, 1.5F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    ...
    public static final Item OBSIDIAN_SHOVEL = register(Keys.OBSIDIAN_SHOVEL.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_SHOVEL).shovel(AerialHellToolMaterials.OBSIDIAN, 1.5F, -3.0F).rarity(Rarity.EPIC).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    ...
    public static final Item LUNATIC_SHOVEL = register(Keys.LUNATIC_SHOVEL.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_SHOVEL).shovel(AerialHellToolMaterials.LUNATIC, 1.5F, -3.0F).rarity(AerialHellRarities.LEGENDARY).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.LUNAR_TOOL)).useInteraction(AerialHellItem.UseInteractionType.SHOVEL)));
    ...
    public static final Item SKY_WOOD_AXE = register(Keys.SKY_WOOD_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_AXE).axe(AerialHellToolMaterials.SKY_WOOD, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final Item STELLAR_STONE_AXE = register(Keys.STELLAR_STONE_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_AXE).axe(AerialHellToolMaterials.STELLAR_STONE, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final Item RUBY_AXE = register(Keys.RUBY_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RUBY_AXE).axe(AerialHellToolMaterials.RUBY, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final Item AZURITE_AXE = register(Keys.AZURITE_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AZURITE_AXE).axe(AerialHellToolMaterials.AZURITE, 6.0F, -3.1F).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final Item MAGMATIC_GEL_AXE = register(Keys.MAGMATIC_GEL_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_AXE).axe(AerialHellToolMaterials.MAGMATIC_GEL, 6.0F, -3.1F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final Item OBSIDIAN_AXE = register(Keys.OBSIDIAN_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_AXE).axe(AerialHellToolMaterials.OBSIDIAN, 6.0F, -3.1F).rarity(Rarity.EPIC).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    ...
    public static final Item LUNATIC_AXE = register(Keys.LUNATIC_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_AXE).axe(AerialHellToolMaterials.LUNATIC, 6.0F, -3.1F).rarity(AerialHellRarities.LEGENDARY).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.LUNAR_TOOL)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    public static final Item ARSONIST_AXE = register(Keys.ARSONIST_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_AXE).axe(AerialHellToolMaterials.ARSONIST, 6.0F, -3.1F).fireResistant().rarity(AerialHellRarities.MYTHICAL).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_TOOL)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    ...
    public static final Item CURSED_AXE = register(Keys.CURSED_AXE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.CURSED_AXE).axe(AerialHellToolMaterials.SHADOW, 2.0F, -3.2F).rarity(AerialHellRarities.CORRUPTED).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.CURSED_TOOL)).useInteraction(AerialHellItem.UseInteractionType.AXE)));
    ...
    public static final Item SKY_WOOD_HOE = register(Keys.SKY_WOOD_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SKY_WOOD_HOE).hoe(AerialHellToolMaterials.SKY_WOOD, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final Item STELLAR_STONE_HOE = register(Keys.STELLAR_STONE_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.STELLAR_STONE_HOE).hoe(AerialHellToolMaterials.STELLAR_STONE, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final Item RUBY_HOE = register(Keys.RUBY_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.RUBY_HOE).hoe(AerialHellToolMaterials.RUBY, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final Item AZURITE_HOE = register(Keys.AZURITE_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AZURITE_HOE).hoe(AerialHellToolMaterials.AZURITE, 0.0F, -3.0F).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final Item MAGMATIC_GEL_HOE = register(Keys.MAGMATIC_GEL_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_HOE).hoe(AerialHellToolMaterials.MAGMATIC_GEL, 0.0F, -3.0F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL)).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    public static final Item OBSIDIAN_HOE = register(Keys.OBSIDIAN_HOE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_HOE).hoe(AerialHellToolMaterials.OBSIDIAN, 0.0F, -3.0F).rarity(Rarity.EPIC).useInteraction(AerialHellItem.UseInteractionType.HOE)));
    ...
    public static final Item MAGMATIC_GEL_SWORD = register(Keys.MAGMATIC_GEL_SWORD.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_SWORD).sword(AerialHellToolMaterials.MAGMATIC_GEL, 3, -2.4F).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_TOOL))));
    ...
    public static final Item LUNATIC_SWORD = register(Keys.LUNATIC_SWORD.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.LUNATIC_SWORD).sword(AerialHellToolMaterials.LUNATIC, 3, -2.4F).rarity(AerialHellRarities.LEGENDARY).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.LUNAR_TOOL))));
    public static final Item ARSONIST_SWORD = register(Keys.ARSONIST_SWORD.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_SWORD).sword(AerialHellToolMaterials.ARSONIST, 3, -2.4F).fireResistant().rarity(AerialHellRarities.MYTHICAL).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_TOOL))));
    ...
    public static final Item DISLOYAL_SWORD = register(Keys.DISLOYAL_SWORD.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.DISLOYAL_SWORD).sword(AerialHellToolMaterials.LUNATIC, 2, -2.4F).fireResistant().rarity(AerialHellRarities.LEGENDARY).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.DISADVANTAGE_OPPONENT))));
    public static final Item CURSED_SWORD = register(Keys.CURSED_SWORD.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.CURSED_SWORD).sword(AerialHellToolMaterials.SHADOW, 1, -2.5F).fireResistant().rarity(AerialHellRarities.CORRUPTED).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.CURSED_TOOL))));
    public static final Item ABSOLUTE_ZERO_SWORD = register(Keys.ABSOLUTE_ZERO_SWORD.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ABSOLUTE_ZERO_SWORD).sword(AerialHellToolMaterials.LUNATIC, 2, -2.4F).fireResistant().rarity(AerialHellRarities.MYTHICAL).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ABSOLUTE_ZERO))));
    ...
    public static final Item RUBY_LEGGINGS = register(Keys.RUBY_LEGGINGS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.RUBY_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.LEGGINGS)));
    public static final Item RUBY_BOOTS = register(Keys.RUBY_BOOTS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.RUBY_BOOTS).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.BOOTS)));

    public static final Item AZURITE_HELMET = register(Keys.AZURITE_HELMET.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_HELMET).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.HELMET)));
    public static final Item AZURITE_CHESTPLATE = register(Keys.AZURITE_CHESTPLATE.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.CHESTPLATE)));
    public static final Item AZURITE_LEGGINGS = register(Keys.AZURITE_LEGGINGS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.LEGGINGS)));
    public static final Item AZURITE_BOOTS = register(Keys.AZURITE_BOOTS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.AZURITE_BOOTS).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.BOOTS)));

    public static final Item OBSIDIAN_HELMET = register(Keys.OBSIDIAN_HELMET.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_HELMET).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.HELMET).rarity(Rarity.EPIC)));
    public static final Item OBSIDIAN_CHESTPLATE = register(Keys.OBSIDIAN_CHESTPLATE.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.CHESTPLATE).rarity(Rarity.EPIC)));
    public static final Item OBSIDIAN_LEGGINGS = register(Keys.OBSIDIAN_LEGGINGS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.LEGGINGS).rarity(Rarity.EPIC)));
    public static final Item OBSIDIAN_BOOTS = register(Keys.OBSIDIAN_BOOTS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.OBSIDIAN_BOOTS).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.BOOTS).rarity(Rarity.EPIC)));

    public static final Item VOLUCITE_HELMET = register(Keys.VOLUCITE_HELMET.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_HELMET).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.HELMET).rarity(AerialHellRarities.VIBRANT)));
    public static final Item VOLUCITE_CHESTPLATE = register(Keys.VOLUCITE_CHESTPLATE.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.CHESTPLATE).rarity(AerialHellRarities.VIBRANT)));
    public static final Item VOLUCITE_LEGGINGS = register(Keys.VOLUCITE_LEGGINGS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.LEGGINGS).rarity(AerialHellRarities.VIBRANT)));
    public static final Item VOLUCITE_BOOTS = register(Keys.VOLUCITE_BOOTS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.VOLUCITE_BOOTS).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.BOOTS).rarity(AerialHellRarities.VIBRANT)));

    public static final Item MAGMATIC_GEL_HELMET = register(Keys.MAGMATIC_GEL_HELMET.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_HELMET).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.HELMET).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_ARMOR))));
    public static final Item MAGMATIC_GEL_CHESTPLATE = register(Keys.MAGMATIC_GEL_CHESTPLATE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.CHESTPLATE).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_ARMOR))));
    public static final Item MAGMATIC_GEL_LEGGINGS = register(Keys.MAGMATIC_GEL_LEGGINGS.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.LEGGINGS).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_ARMOR))));
    public static final Item MAGMATIC_GEL_BOOTS = register(Keys.MAGMATIC_GEL_BOOTS.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.MAGMATIC_GEL_BOOTS).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.BOOTS).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.MAGMATIC_GEL_ARMOR))));

    public static final Item LUNATIC_HELMET = register(Keys.LUNATIC_HELMET.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_HELMET).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.HELMET).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item LUNATIC_CHESTPLATE = register(Keys.LUNATIC_CHESTPLATE.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.CHESTPLATE).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item LUNATIC_LEGGINGS = register(Keys.LUNATIC_LEGGINGS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.LEGGINGS).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item LUNATIC_BOOTS = register(Keys.LUNATIC_BOOTS.identifier().getPath(), new Item(new AerialHellItem.Properties().setId(Keys.LUNATIC_BOOTS).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.BOOTS).rarity(AerialHellRarities.LEGENDARY)));

    public static final Item ARSONIST_HELMET = register(Keys.ARSONIST_HELMET.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_HELMET).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.HELMET).rarity(AerialHellRarities.MYTHICAL).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_ARMOR))));
    public static final Item ARSONIST_CHESTPLATE = register(Keys.ARSONIST_CHESTPLATE.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.CHESTPLATE).rarity(AerialHellRarities.MYTHICAL).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_ARMOR))));
    public static final Item ARSONIST_LEGGINGS = register(Keys.ARSONIST_LEGGINGS.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.LEGGINGS).rarity(AerialHellRarities.MYTHICAL).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_ARMOR))));
    public static final Item ARSONIST_BOOTS = register(Keys.ARSONIST_BOOTS.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.ARSONIST_BOOTS).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.BOOTS).rarity(AerialHellRarities.MYTHICAL).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.ARSONIST_ARMOR))));

    public static final Item SHADOW_HELMET = register(Keys.SHADOW_HELMET.identifier().getPath(), new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_HELMET).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.HELMET).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_CHESTPLATE = register(Keys.SHADOW_CHESTPLATE.identifier().getPath(), new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.CHESTPLATE).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_LEGGINGS = register(Keys.SHADOW_LEGGINGS.identifier().getPath(), new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.LEGGINGS).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_BOOTS = register(Keys.SHADOW_BOOTS.identifier().getPath(), new ShadowArmorItem(new AerialHellItem.Properties().setId(Keys.SHADOW_BOOTS).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.BOOTS).rarity(AerialHellRarities.CORRUPTED)));

    //effect totems
    public static final Item REGENERATION_TOTEM = register(Keys.REGENERATION_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.REGENERATION_TOTEM).stacksTo(1).rarity(AerialHellRarities.LEGENDARY).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.REGENERATION_TOTEM))));
    public static final Item SPEED_TOTEM = register(Keys.SPEED_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SPEED_TOTEM).stacksTo(1).rarity(AerialHellRarities.LEGENDARY).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SPEED_TOTEM))));
    public static final Item SPEED_II_TOTEM = register(Keys.SPEED_II_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SPEED_II_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SPEED_II_TOTEM))));
    public static final Item NIGHT_VISION_TOTEM = register(Keys.NIGHT_VISION_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.NIGHT_VISION_TOTEM).stacksTo(1).rarity(AerialHellRarities.LEGENDARY).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.NIGHT_VISION_TOTEM))));
    public static final Item AGILITY_TOTEM = register(Keys.AGILITY_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.AGILITY_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.AGILITY_TOTEM))));
    public static final Item HERO_TOTEM = register(Keys.HERO_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.HERO_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.HERO_TOTEM))));
    public static final Item HEAD_IN_THE_CLOUDS_TOTEM = register(Keys.HEAD_IN_THE_CLOUDS_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.HEAD_IN_THE_CLOUDS_TOTEM).stacksTo(1).rarity(AerialHellRarities.VIBRANT).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.HEAD_IN_THE_CLOUDS_TOTEM))));
    public static final Item GOD_TOTEM = register(Keys.GOD_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.GOD_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).fireResistant().abilitySelector(AbilitySelector.of(AerialHellItemAbilities.GOD_TOTEM))));
    public static final Item CURSED_TOTEM = register(Keys.CURSED_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.CURSED_TOTEM).stacksTo(1).rarity(AerialHellRarities.MYTHICAL).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.CURSED_TOTEM))));
    public static final Item SHADOW_TOTEM = register(Keys.SHADOW_TOTEM.identifier().getPath(), new AerialHellItem(new AerialHellItem.Properties().setId(Keys.SHADOW_TOTEM).stacksTo(1).rarity(AerialHellRarities.CORRUPTED).abilitySelector(AbilitySelector.of(AerialHellItemAbilities.SHADOW_TOTEM))));
