...
public class AerialHellItems
{
    ...
    //tools
    public static final DeferredItem<Item> SKY_WOOD_PICKAXE = ITEMS.register(Keys.SKY_WOOD_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.SKY_WOOD_PICKAXE).pickaxe(ToolMaterials.SKY_WOOD, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_PICKAXE = ITEMS.register(Keys.STELLAR_STONE_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.STELLAR_STONE_PICKAXE).pickaxe(ToolMaterials.STELLAR_STONE, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> RUBY_PICKAXE = ITEMS.register(Keys.RUBY_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.RUBY_PICKAXE).pickaxe(ToolMaterials.RUBY, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_PICKAXE = ITEMS.register(Keys.AZURITE_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.AZURITE_PICKAXE).pickaxe(ToolMaterials.AZURITE, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_PICKAXE = ITEMS.register(Keys.MAGMATIC_GEL_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.MAGMATIC_GEL_PICKAXE).pickaxe(ToolMaterials.MAGMATIC_GEL, 1.0F, -2.8F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_PICKAXE = ITEMS.register(Keys.OBSIDIAN_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.OBSIDIAN_PICKAXE).pickaxe(ToolMaterials.OBSIDIAN, 1.0F, -2.8F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_PICKAXE = ITEMS.register(Keys.VOLUCITE_PICKAXE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_PICKAXE).pickaxe(ToolMaterials.VOLUCITE, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()), AerialHellItemAbilities.FULL_VOLUCITE_POWER, List.of()));
    public static final DeferredItem<Item> LUNATIC_PICKAXE = ITEMS.register(Keys.LUNATIC_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.LUNATIC_PICKAXE).pickaxe(ToolMaterials.LUNATIC, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_PICKAXE = ITEMS.register(Keys.ARSONIST_PICKAXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.ARSONIST_PICKAXE).pickaxe(ToolMaterials.ARSONIST, 1.0F, -2.8F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> MAGMA_CUBE_PICKAXE = ITEMS.register(Keys.MAGMA_CUBE_PICKAXE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.MAGMA_CUBE_PICKAXE).pickaxe(ToolMaterials.OBSIDIAN, 1.0F, -2.8F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue()), AerialHellItemAbilities.MAGMA_CUBE));
    public static final DeferredItem<Item> STELLAR_STONE_BREAKER = ITEMS.register(Keys.STELLAR_STONE_BREAKER.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.STELLAR_STONE_BREAKER).pickaxe(ToolMaterials.BREAKER, 1.0F, -2.8F, 0.0F, 0.0F).rarity(Rarity.EPIC)));

    public static final DeferredItem<Item> SKY_WOOD_SHOVEL = ITEMS.register(Keys.SKY_WOOD_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.SKY_WOOD_SHOVEL).shovel(ToolMaterials.SKY_WOOD, 1.5F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_SHOVEL = ITEMS.register(Keys.STELLAR_STONE_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItemProperties().shovel(ToolMaterials.STELLAR_STONE, 1.5F, -3.0F, 0.0F, 0.0F).setId(Keys.STELLAR_STONE_SHOVEL)));
    public static final DeferredItem<Item> RUBY_SHOVEL = ITEMS.register(Keys.RUBY_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.RUBY_SHOVEL).shovel(ToolMaterials.RUBY, 1.5F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_SHOVEL = ITEMS.register(Keys.AZURITE_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.AZURITE_SHOVEL).shovel(ToolMaterials.AZURITE, 1.5F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_SHOVEL = ITEMS.register(Keys.MAGMATIC_GEL_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.MAGMATIC_GEL_SHOVEL).shovel(ToolMaterials.MAGMATIC_GEL, 1.5F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_SHOVEL = ITEMS.register(Keys.OBSIDIAN_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.OBSIDIAN_SHOVEL).shovel(ToolMaterials.OBSIDIAN, 1.5F, -3.0F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_SHOVEL = ITEMS.register(Keys.VOLUCITE_SHOVEL.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_SHOVEL).shovel(ToolMaterials.VOLUCITE, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()), AerialHellItemAbilities.FULL_VOLUCITE_POWER, List.of(AerialHellToolItem.UseInteractionToolType.SHOVEL)));
    public static final DeferredItem<Item> LUNATIC_SHOVEL = ITEMS.register(Keys.LUNATIC_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.LUNATIC_SHOVEL).shovel(ToolMaterials.LUNATIC, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_SHOVEL = ITEMS.register(Keys.ARSONIST_SHOVEL.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.ARSONIST_SHOVEL).shovel(ToolMaterials.ARSONIST, 1.5F, -3.0F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> MAGMA_CUBE_SHOVEL = ITEMS.register(Keys.MAGMA_CUBE_SHOVEL.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.MAGMA_CUBE_SHOVEL).shovel(ToolMaterials.OBSIDIAN, 1.5F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue()), AerialHellItemAbilities.MAGMA_CUBE, List.of(AerialHellToolItem.UseInteractionToolType.SHOVEL)));

    public static final DeferredItem<Item> SKY_WOOD_AXE = ITEMS.register(Keys.SKY_WOOD_AXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.SKY_WOOD_AXE).axe(ToolMaterials.SKY_WOOD, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_AXE = ITEMS.register(Keys.STELLAR_STONE_AXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.STELLAR_STONE_AXE).axe(ToolMaterials.STELLAR_STONE, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> RUBY_AXE = ITEMS.register(Keys.RUBY_AXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.RUBY_AXE).axe(ToolMaterials.RUBY, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_AXE = ITEMS.register(Keys.AZURITE_AXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.AZURITE_AXE).axe(ToolMaterials.AZURITE, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_AXE = ITEMS.register(Keys.MAGMATIC_GEL_AXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.MAGMATIC_GEL_AXE).axe(ToolMaterials.MAGMATIC_GEL, 6.0F, -3.1F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_AXE = ITEMS.register(Keys.OBSIDIAN_AXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.OBSIDIAN_AXE).axe(ToolMaterials.OBSIDIAN, 6.0F, -3.1F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_AXE = ITEMS.register(Keys.VOLUCITE_AXE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_AXE).axe(ToolMaterials.VOLUCITE, 6.0F, -3.1F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()), AerialHellItemAbilities.FULL_VOLUCITE_POWER, List.of(AerialHellToolItem.UseInteractionToolType.AXE)));
    public static final DeferredItem<Item> LUNATIC_AXE = ITEMS.register(Keys.LUNATIC_AXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.LUNATIC_AXE).axe(ToolMaterials.LUNATIC, 6.0F, -3.1F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_AXE = ITEMS.register(Keys.ARSONIST_AXE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.ARSONIST_AXE).axe(ToolMaterials.ARSONIST, 6.0F, -3.1F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> HEAVY_AXE = ITEMS.register(Keys.HEAVY_AXE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.HEAVY_AXE).axe(ToolMaterials.HEAVY, 6.0F, -3.5F, 0.0F, 0.0F).rarity(Rarity.EPIC), List.of(AerialHellToolItem.UseInteractionToolType.AXE)));
    public static final DeferredItem<Item> AXE_OF_LIGHT = ITEMS.register(Keys.AXE_OF_LIGHT.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.AXE_OF_LIGHT).axe(ToolMaterials.LUNATIC, 5.0F, -3.1F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue()), AerialHellItemAbilities.AXE_OF_LIGHT, List.of(AerialHellToolItem.UseInteractionToolType.AXE)));
    public static final DeferredItem<Item> CURSED_AXE = ITEMS.register(Keys.CURSED_AXE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.CURSED_AXE).axe(ToolMaterials.SHADOW, 2.0F, -3.2F, 0.0F, 0.0F).rarity(AerialHellRarities.CORRUPTED.getValue()), List.of(AerialHellToolItem.UseInteractionToolType.AXE)));
    public static final DeferredItem<Item> BERSERK_AXE = ITEMS.register(Keys.BERSERK_AXE.identifier().getPath(), () -> new BerserkAxeItem(new AerialHellItemProperties().setId(Keys.BERSERK_AXE).axe(ToolMaterials.ARSONIST, 4.0F, -2.5F, 0.0F, 0.0F).rarity(AerialHellRarities.MYTHICAL.getValue()), List.of(AerialHellToolItem.UseInteractionToolType.AXE)));

    public static final DeferredItem<Item> SKY_WOOD_HOE = ITEMS.register(Keys.SKY_WOOD_HOE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.SKY_WOOD_HOE).hoe(ToolMaterials.SKY_WOOD, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_HOE = ITEMS.register(Keys.STELLAR_STONE_HOE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.STELLAR_STONE_HOE).hoe(ToolMaterials.STELLAR_STONE, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> RUBY_HOE = ITEMS.register(Keys.RUBY_HOE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.RUBY_HOE).hoe(ToolMaterials.RUBY, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_HOE = ITEMS.register(Keys.AZURITE_HOE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.AZURITE_HOE).hoe(ToolMaterials.AZURITE, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_HOE = ITEMS.register(Keys.MAGMATIC_GEL_HOE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.MAGMATIC_GEL_HOE).hoe(ToolMaterials.MAGMATIC_GEL, 0.0F, -3.0F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_HOE = ITEMS.register(Keys.OBSIDIAN_HOE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.OBSIDIAN_HOE).hoe(ToolMaterials.OBSIDIAN, 0.0F, -3.0F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_HOE = ITEMS.register(Keys.VOLUCITE_HOE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_HOE).hoe(ToolMaterials.VOLUCITE, 0.0F, -3.0F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()), AerialHellItemAbilities.FULL_VOLUCITE_POWER, List.of(AerialHellToolItem.UseInteractionToolType.HOE)));
    public static final DeferredItem<Item> LUNATIC_HOE = ITEMS.register(Keys.LUNATIC_HOE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.LUNATIC_HOE).hoe(ToolMaterials.LUNATIC, 0.0F, -1.0F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_HOE = ITEMS.register(Keys.ARSONIST_HOE.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.ARSONIST_HOE).hoe(ToolMaterials.ARSONIST, 0.0F, -1.0F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> REAPER_SCYTHE = ITEMS.register(Keys.REAPER_SCYTHE.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.REAPER_SCYTHE).hoe(ToolMaterials.SHADOW, 1.5F, 4.0F, 0.0F, 0.0F).rarity(AerialHellRarities.MYTHICAL.getValue()), AerialHellItemAbilities.REAPER_WALK, List.of(AerialHellToolItem.UseInteractionToolType.HOE)));

    //weapons
    public static final DeferredItem<Item> SKY_WOOD_SWORD = ITEMS.register(Keys.SKY_WOOD_SWORD.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.SKY_WOOD_SWORD).sword(ToolMaterials.SKY_WOOD, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> STELLAR_STONE_SWORD = ITEMS.register(Keys.STELLAR_STONE_SWORD.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.STELLAR_STONE_SWORD).sword(ToolMaterials.STELLAR_STONE, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> RUBY_SWORD = ITEMS.register(Keys.RUBY_SWORD.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.RUBY_SWORD).sword(ToolMaterials.RUBY, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> AZURITE_SWORD = ITEMS.register(Keys.AZURITE_SWORD.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.AZURITE_SWORD).sword(ToolMaterials.AZURITE, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> MAGMATIC_GEL_SWORD = ITEMS.register(Keys.MAGMATIC_GEL_SWORD.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.MAGMATIC_GEL_SWORD).sword(ToolMaterials.MAGMATIC_GEL, 3, -2.4F, 0.0F, 0.0F)));
    public static final DeferredItem<Item> OBSIDIAN_SWORD = ITEMS.register(Keys.OBSIDIAN_SWORD.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.OBSIDIAN_SWORD).sword(ToolMaterials.OBSIDIAN, 3, -2.4F, 0.0F, 0.0F).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> VOLUCITE_SWORD = ITEMS.register(Keys.VOLUCITE_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.VOLUCITE_SWORD).sword(ToolMaterials.VOLUCITE, 3, -2.4F, 0.0F, 0.0F).rarity(AerialHellRarities.VIBRANT.getValue()), AerialHellItemAbilities.FULL_VOLUCITE_POWER, List.of()));
    public static final DeferredItem<Item> LUNATIC_SWORD = ITEMS.register(Keys.LUNATIC_SWORD.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.LUNATIC_SWORD).sword(ToolMaterials.LUNATIC, 3, -2.4F, 0.0F, 0.0F).rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> ARSONIST_SWORD = ITEMS.register(Keys.ARSONIST_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.ARSONIST_SWORD).sword(ToolMaterials.ARSONIST, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));

    public static final DeferredItem<Item> HEAVY_SWORD = ITEMS.register(Keys.HEAVY_SWORD.identifier().getPath(), () -> new Item(new AerialHellItemProperties().setId(Keys.HEAVY_SWORD).sword(ToolMaterials.HEAVY, 3, -2.7F, 0.0F, 0.0F).fireResistant().rarity(Rarity.EPIC)));


    public static final DeferredItem<Item> HEALTH_BOOST_SWORD = ITEMS.register(Keys.HEALTH_BOOST_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.HEALTH_BOOST_SWORD).sword(ToolMaterials.LUNATIC, 3, -2.4F, 0.0F, 4.0F).fireResistant().rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> NINJA_SWORD = ITEMS.register(Keys.NINJA_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.NINJA_SWORD).sword(ToolMaterials.OBSIDIAN, 2, -1.6F, 0.15F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()), AerialHellItemAbilities.NINJA_SWORD));
    public static final DeferredItem<Item> NINJA_MASTER_SWORD = ITEMS.register(Keys.NINJA_MASTER_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.NINJA_MASTER_SWORD).sword(ToolMaterials.OBSIDIAN, 4, -2.4F, 0.15F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()), AerialHellItemAbilities.NINJA_MASTER_SWORD));
    public static final DeferredItem<Item> GLOUTON_SWORD = ITEMS.register(Keys.GLOUTON_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.GLOUTON_SWORD).sword(ToolMaterials.RUBY, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()), AerialHellItemAbilities.GLOUTON_SWORD));
    public static final DeferredItem<Item> RANDOM_SWORD = ITEMS.register(Keys.RANDOM_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.RANDOM_SWORD).sword(ToolMaterials.RUBY, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(Rarity.EPIC), AerialHellItemAbilities.RANDOM_SWORD));
    public static final DeferredItem<Item> DISLOYAL_SWORD = ITEMS.register(Keys.DISLOYAL_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.DISLOYAL_SWORD).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue())));
    public static final DeferredItem<Item> CURSED_SWORD = ITEMS.register(Keys.CURSED_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.CURSED_SWORD).sword(ToolMaterials.SHADOW, 1, -2.5F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.CORRUPTED.getValue())));
    public static final DeferredItem<Item> ABSOLUTE_ZERO_SWORD = ITEMS.register(Keys.ABSOLUTE_ZERO_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.ABSOLUTE_ZERO_SWORD).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue())));
    public static final DeferredItem<Item> SWORD_OF_LIGHT = ITEMS.register(Keys.SWORD_OF_LIGHT.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.SWORD_OF_LIGHT).sword(ToolMaterials.LUNATIC, 2, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()), AerialHellItemAbilities.SWORD_OF_LIGHT));
    public static final DeferredItem<Item> ANTIDOTE_SWORD = ITEMS.register(Keys.ANTIDOTE_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.ANTIDOTE_SWORD).sword(ToolMaterials.RUBY, 4, -2.4F, 0.0F, 0.0F).fireResistant().rarity(Rarity.EPIC), AerialHellItemAbilities.ANTIDOTE_SWORD));
    public static final DeferredItem<Item> NETHERIAN_KING_SWORD = ITEMS.register(Keys.NETHERIAN_KING_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.NETHERIAN_KING_SWORD).sword(ToolMaterials.OBSIDIAN, 1, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.LEGENDARY.getValue()), AerialHellItemAbilities.NETHERIAN_KING_SWORD));
    public static final DeferredItem<Item> GLASS_CANON_SWORD = ITEMS.register(Keys.GLASS_CANON_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.GLASS_CANON_SWORD).sword(ToolMaterials.ARSONIST, 7, -1.6F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()), AerialHellItemAbilities.GLASS_CANON_SWORD));
    public static final DeferredItem<Item> GOD_SWORD = ITEMS.register(Keys.GOD_SWORD.identifier().getPath(), () -> new AerialHellToolItem(new AerialHellItemProperties().setId(Keys.GOD_SWORD).sword(ToolMaterials.ARSONIST, 3, -2.4F, 0.0F, 0.0F).fireResistant().rarity(AerialHellRarities.MYTHICAL.getValue()), AerialHellItemAbilities.GOD));

    public static final DeferredItem<Item> FORGOTTEN_BATTLE_TRIDENT = ITEMS.register(Keys.FORGOTTEN_BATTLE_TRIDENT.identifier().getPath(), () -> new ForgottenBattleTridentItem(new AerialHellItemProperties().setId(Keys.FORGOTTEN_BATTLE_TRIDENT).sword(ToolMaterials.VOLUCITE, 3, -2.9F, 0.2F, 0.0F).durability(1000).rarity(AerialHellRarities.LEGENDARY.getValue())));
