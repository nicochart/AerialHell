...
public class AerialHellItems
{
    ...
    //crystal
    public static final Item CRYSTAL_BLOCK = register(Keys.CRYSTAL_BLOCK.identifier().getPath(), new BlockItem(AerialHellBlocks.CRYSTAL_BLOCK, new Item.Properties().setId(Keys.CRYSTAL_BLOCK).useBlockDescriptionPrefix()));
    ...
    public static final Item SHADOW_CRYSTAL_BLOCK = register(Keys.SHADOW_CRYSTAL_BLOCK.identifier().getPath(), new BlockItem(AerialHellBlocks.SHADOW_CRYSTAL_BLOCK, new Item.Properties().setId(Keys.SHADOW_CRYSTAL_BLOCK).rarity(AerialHellRarities.CORRUPTED).useBlockDescriptionPrefix()));
    ...
    public static final Item CRYSTAL = register(Keys.CRYSTAL.identifier().getPath(), new Item(new Item.Properties().setId(Keys.CRYSTAL)));
    ...
    public static final Item SHADOW_CRYSTAL = register(Keys.SHADOW_CRYSTAL.identifier().getPath(), new Item(new Item.Properties().setId(Keys.SHADOW_CRYSTAL).rarity(AerialHellRarities.CORRUPTED)));
    ...
    public static final Item FLUORITE_BLOCK = register(Keys.FLUORITE_BLOCK.identifier().getPath(), new BlockItem(AerialHellBlocks.FLUORITE_BLOCK, new Item.Properties().setId(Keys.FLUORITE_BLOCK).useBlockDescriptionPrefix()));
    ...
    public static final Item FLUORITE = register(Keys.FLUORITE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.FLUORITE).trimMaterial(AerialHellTrimMaterials.FLUORITE)));
    ...
    public static final Item CURSED_CRYSAL = register(Keys.CURSED_CRYSAL.identifier().getPath(), new Item(new Item.Properties().setId(Keys.CURSED_CRYSAL).trimMaterial(AerialHellTrimMaterials.CURSED_CRYSTAL).rarity(AerialHellRarities.CORRUPTED)));
    ...
    public static final Item CURSED_CRYSAL_BLOCK = register(Keys.CURSED_CRYSAL_BLOCK.identifier().getPath(), new BlockItem(AerialHellBlocks.CURSED_CRYSAL_BLOCK, new Item.Properties().setId(Keys.CURSED_CRYSAL_BLOCK).useBlockDescriptionPrefix().rarity(AerialHellRarities.CORRUPTED)));
    ...
    public static final Item SHADOW_SHARD = register(Keys.SHADOW_SHARD.identifier().getPath(),new Item(new Item.Properties().setId(Keys.SHADOW_SHARD).rarity(AerialHellRarities.CORRUPTED)));
    ...
    //shurikens
    public static final Item IRON_SHURIKEN = register(Keys.IRON_SHURIKEN.identifier().getPath(), new IronShurikenItem(new Item.Properties().rarity(Rarity.COMMON).setId(Keys.IRON_SHURIKEN)));
    public static final Item GOLD_SHURIKEN = register(Keys.GOLD_SHURIKEN.identifier().getPath(), new GoldShurikenItem(new Item.Properties().rarity(Rarity.COMMON).setId(Keys.GOLD_SHURIKEN)));
    public static final Item DIAMOND_SHURIKEN = register(Keys.DIAMOND_SHURIKEN.identifier().getPath(), new DiamondShurikenItem(new Item.Properties().rarity(Rarity.COMMON).setId(Keys.DIAMOND_SHURIKEN)));
    public static final Item NETHERITE_SHURIKEN = register(Keys.NETHERITE_SHURIKEN.identifier().getPath(), new NetheriteShurikenItem(new Item.Properties().rarity(Rarity.UNCOMMON).setId(Keys.NETHERITE_SHURIKEN)));
    public static final Item RUBY_SHURIKEN = register(Keys.RUBY_SHURIKEN.identifier().getPath(), new RubyShurikenItem(new Item.Properties().rarity(Rarity.COMMON).setId(Keys.RUBY_SHURIKEN)));
    public static final Item AZURITE_SHURIKEN = register(Keys.AZURITE_SHURIKEN.identifier().getPath(), new AzuriteShurikenItem(new Item.Properties().rarity(Rarity.COMMON).setId(Keys.AZURITE_SHURIKEN)));
    public static final Item MAGMATIC_GEL_SHURIKEN = register(Keys.MAGMATIC_GEL_SHURIKEN.identifier().getPath(), new MagmaticGelShurikenItem(new Item.Properties().rarity(AerialHellRarities.FROZEN).setId(Keys.MAGMATIC_GEL_SHURIKEN)));
    public static final Item VOLUCITE_SHURIKEN = register(Keys.VOLUCITE_SHURIKEN.identifier().getPath(), new VoluciteShurikenItem(new Item.Properties().rarity(AerialHellRarities.VIBRANT).setId(Keys.VOLUCITE_SHURIKEN)));
    public static final Item OBSIDIAN_SHURIKEN = register(Keys.OBSIDIAN_SHURIKEN.identifier().getPath(), new ObsidianShurikenItem(new Item.Properties().rarity(Rarity.EPIC).setId(Keys.OBSIDIAN_SHURIKEN)));
    public static final Item LUNATIC_CRYSTAL_SHURIKEN = register(Keys.LUNATIC_CRYSTAL_SHURIKEN.identifier().getPath(), new LunaticCrystalShurikenItem(new Item.Properties().rarity(AerialHellRarities.LEGENDARY).setId(Keys.LUNATIC_CRYSTAL_SHURIKEN)));
    public static final Item ARSONIST_SHURIKEN = register(Keys.ARSONIST_SHURIKEN.identifier().getPath(), new ArsonistShurikenItem(new Item.Properties().rarity(AerialHellRarities.MYTHICAL).setId(Keys.ARSONIST_SHURIKEN)));
    public static final Item LIGHTNING_SHURIKEN = register(Keys.LIGHTNING_SHURIKEN.identifier().getPath(), new LightningShurikenItem(new Item.Properties().rarity(Rarity.UNCOMMON).setId(Keys.LIGHTNING_SHURIKEN)));
    ...
    //tools
    public static final Item SKY_WOOD_PICKAXE = register(Keys.SKY_WOOD_PICKAXE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.SKY_WOOD_PICKAXE).pickaxe(ToolMaterials.SKY_WOOD, 1.0F, -2.8F)));
    public static final Item STELLAR_STONE_PICKAXE = register(Keys.STELLAR_STONE_PICKAXE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.STELLAR_STONE_PICKAXE).pickaxe(ToolMaterials.STELLAR_STONE, 1.0F, -2.8F)));
    public static final Item RUBY_PICKAXE = register(Keys.RUBY_PICKAXE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.RUBY_PICKAXE).pickaxe(ToolMaterials.RUBY, 1.0F, -2.8F)));
    public static final Item AZURITE_PICKAXE = register(Keys.AZURITE_PICKAXE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.AZURITE_PICKAXE).pickaxe(ToolMaterials.AZURITE, 1.0F, -2.8F)));
    public static final Item MAGMATIC_GEL_PICKAXE = register(Keys.MAGMATIC_GEL_PICKAXE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.MAGMATIC_GEL_PICKAXE).pickaxe(ToolMaterials.MAGMATIC_GEL, 1.0F, -2.8F)));
    public static final Item OBSIDIAN_PICKAXE = register(Keys.OBSIDIAN_PICKAXE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.OBSIDIAN_PICKAXE).pickaxe(ToolMaterials.OBSIDIAN, 1.0F, -2.8F).rarity(Rarity.EPIC)));
    public static final Item VOLUCITE_PICKAXE = register(Keys.VOLUCITE_PICKAXE.identifier().getPath(), new EffectPickaxeItem(ToolMaterials.VOLUCITE, 1.0F, -2.8F, new Item.Properties().setId(Keys.VOLUCITE_PICKAXE).rarity(AerialHellRarities.VIBRANT)));
    public static final Item LUNATIC_PICKAXE = register(Keys.LUNATIC_PICKAXE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.LUNATIC_PICKAXE).pickaxe(ToolMaterials.LUNATIC, 1.0F, -2.8F).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item ARSONIST_PICKAXE = register(Keys.ARSONIST_PICKAXE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.ARSONIST_PICKAXE).pickaxe(ToolMaterials.ARSONIST, 1.0F, -2.8F).fireResistant().rarity(AerialHellRarities.MYTHICAL)));

    public static final Item MAGMA_CUBE_PICKAXE = register(Keys.MAGMA_CUBE_PICKAXE.identifier().getPath(), new EffectPickaxeItem(ToolMaterials.OBSIDIAN, 1.0F, -2.8F, new Item.Properties().setId(Keys.MAGMA_CUBE_PICKAXE).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item STELLAR_STONE_BREAKER = register(Keys.STELLAR_STONE_BREAKER.identifier().getPath(), new AerialHellPickaxeItem(ToolMaterials.BREAKER, 1.0F, -2.8F, new Item.Properties().setId(Keys.STELLAR_STONE_BREAKER).rarity(Rarity.EPIC)));

    public static final ShovelItem SKY_WOOD_SHOVEL = register(Keys.SKY_WOOD_SHOVEL.identifier().getPath(), new ShovelItem(ToolMaterials.SKY_WOOD, 1.5F, -3.0F, new Item.Properties().setId(Keys.SKY_WOOD_SHOVEL)));
    public static final ShovelItem STELLAR_STONE_SHOVEL = register(Keys.STELLAR_STONE_SHOVEL.identifier().getPath(), new ShovelItem(ToolMaterials.STELLAR_STONE, 1.5F, -3.0F, new Item.Properties().setId(Keys.STELLAR_STONE_SHOVEL)));
    public static final ShovelItem RUBY_SHOVEL = register(Keys.RUBY_SHOVEL.identifier().getPath(), new ShovelItem(ToolMaterials.RUBY, 1.5F, -3.0F, new Item.Properties().setId(Keys.RUBY_SHOVEL)));
    public static final ShovelItem AZURITE_SHOVEL = register(Keys.AZURITE_SHOVEL.identifier().getPath(), new ShovelItem(ToolMaterials.AZURITE, 1.5F, -3.0F, new Item.Properties().setId(Keys.AZURITE_SHOVEL)));
    public static final ShovelItem MAGMATIC_GEL_SHOVEL = register(Keys.MAGMATIC_GEL_SHOVEL.identifier().getPath(), new ShovelItem(ToolMaterials.MAGMATIC_GEL, 1.5F, -3.0F, new Item.Properties().setId(Keys.MAGMATIC_GEL_SHOVEL)));
    public static final ShovelItem OBSIDIAN_SHOVEL = register(Keys.OBSIDIAN_SHOVEL.identifier().getPath(), new ShovelItem(ToolMaterials.OBSIDIAN, 1.5F, -3.0F, new Item.Properties().setId(Keys.OBSIDIAN_SHOVEL).rarity(Rarity.EPIC)));
    public static final ShovelItem VOLUCITE_SHOVEL = register(Keys.VOLUCITE_SHOVEL.identifier().getPath(), new EffectShovelItem(ToolMaterials.VOLUCITE, 1.5F, -3.0F, new Item.Properties().setId(Keys.VOLUCITE_SHOVEL).rarity(AerialHellRarities.VIBRANT)));
    public static final ShovelItem LUNATIC_SHOVEL = register(Keys.LUNATIC_SHOVEL.identifier().getPath(), new ShovelItem(ToolMaterials.LUNATIC, 1.5F, -3.0F, new Item.Properties().setId(Keys.LUNATIC_SHOVEL).rarity(AerialHellRarities.LEGENDARY)));
    public static final ShovelItem ARSONIST_SHOVEL = register(Keys.ARSONIST_SHOVEL.identifier().getPath(), new ShovelItem(ToolMaterials.ARSONIST, 1.5F, -3.0F, new Item.Properties().setId(Keys.ARSONIST_SHOVEL).fireResistant().rarity(AerialHellRarities.MYTHICAL)));

    public static final ShovelItem MAGMA_CUBE_SHOVEL = register(Keys.MAGMA_CUBE_SHOVEL.identifier().getPath(), new EffectShovelItem(ToolMaterials.OBSIDIAN, 1.5F, -3.0F, new Item.Properties().setId(Keys.MAGMA_CUBE_SHOVEL).rarity(AerialHellRarities.LEGENDARY)));

    public static final AxeItem SKY_WOOD_AXE = register(Keys.SKY_WOOD_AXE.identifier().getPath(), new AxeItem(ToolMaterials.SKY_WOOD, 6.0F, -3.1F, new Item.Properties().setId(Keys.SKY_WOOD_AXE)));
    public static final AxeItem STELLAR_STONE_AXE = register(Keys.STELLAR_STONE_AXE.identifier().getPath(), new AxeItem(ToolMaterials.STELLAR_STONE, 6.0F, -3.1F, new Item.Properties().setId(Keys.STELLAR_STONE_AXE)));
    public static final AxeItem RUBY_AXE = register(Keys.RUBY_AXE.identifier().getPath(), new AxeItem(ToolMaterials.RUBY, 6.0F, -3.1F, new Item.Properties().setId(Keys.RUBY_AXE)));
    public static final AxeItem AZURITE_AXE = register(Keys.AZURITE_AXE.identifier().getPath(), new AxeItem(ToolMaterials.AZURITE, 6.0F, -3.1F, new Item.Properties().setId(Keys.AZURITE_AXE)));
    public static final AxeItem MAGMATIC_GEL_AXE = register(Keys.MAGMATIC_GEL_AXE.identifier().getPath(), new AxeItem(ToolMaterials.MAGMATIC_GEL, 6.0F, -3.1F, new Item.Properties().setId(Keys.MAGMATIC_GEL_AXE)));
    public static final AxeItem OBSIDIAN_AXE = register(Keys.OBSIDIAN_AXE.identifier().getPath(), new AxeItem(ToolMaterials.OBSIDIAN, 6.0F, -3.1F, new Item.Properties().setId(Keys.OBSIDIAN_AXE).rarity(Rarity.EPIC)));
    public static final AxeItem VOLUCITE_AXE = register(Keys.VOLUCITE_AXE.identifier().getPath(), new EffectAxeItem(ToolMaterials.VOLUCITE, 6.0F, -3.1F, new Item.Properties().setId(Keys.VOLUCITE_AXE).rarity(AerialHellRarities.VIBRANT)));
    public static final AxeItem LUNATIC_AXE = register(Keys.LUNATIC_AXE.identifier().getPath(), new AxeItem(ToolMaterials.LUNATIC, 6.0F, -3.1F, new Item.Properties().setId(Keys.LUNATIC_AXE).rarity(AerialHellRarities.LEGENDARY)));
    public static final AxeItem ARSONIST_AXE = register(Keys.ARSONIST_AXE.identifier().getPath(), new AxeItem(ToolMaterials.ARSONIST, 6.0F, -3.1F, new Item.Properties().setId(Keys.ARSONIST_AXE).fireResistant().rarity(AerialHellRarities.MYTHICAL)));

    public static final AxeItem HEAVY_AXE = register(Keys.HEAVY_AXE.identifier().getPath(), new AerialHellAxeItem(ToolMaterials.HEAVY, 6.0F, -3.5F, -0.30F, 0.0F, new Item.Properties().setId(Keys.HEAVY_AXE).rarity(Rarity.EPIC)));
    public static final AxeItem AXE_OF_LIGHT = register(Keys.AXE_OF_LIGHT.identifier().getPath(), new EffectAxeItem(ToolMaterials.LUNATIC, 5.0F, -3.1F, new Item.Properties().setId(Keys.AXE_OF_LIGHT).rarity(AerialHellRarities.LEGENDARY)));
    public static final AxeItem CURSED_AXE = register(Keys.CURSED_AXE.identifier().getPath(), new AerialHellAxeItem(ToolMaterials.SHADOW, 2.0F, -3.2F, new Item.Properties().setId(Keys.CURSED_AXE).rarity(AerialHellRarities.CORRUPTED)));
    public static final AxeItem BERSERK_AXE = register(Keys.BERSERK_AXE.identifier().getPath(), new BerserkAxeItem(ToolMaterials.ARSONIST, 4.0F, -2.5F, new Item.Properties().setId(Keys.BERSERK_AXE).rarity(AerialHellRarities.MYTHICAL)));

    public static final HoeItem SKY_WOOD_HOE = register(Keys.SKY_WOOD_HOE.identifier().getPath(), new HoeItem(ToolMaterials.SKY_WOOD, 0.0F, -3.0F, new Item.Properties().setId(Keys.SKY_WOOD_HOE)));
    public static final HoeItem STELLAR_STONE_HOE = register(Keys.STELLAR_STONE_HOE.identifier().getPath(), new HoeItem(ToolMaterials.STELLAR_STONE, 0.0F, -3.0F, new Item.Properties().setId(Keys.STELLAR_STONE_HOE)));
    public static final HoeItem RUBY_HOE = register(Keys.RUBY_HOE.identifier().getPath(), new HoeItem(ToolMaterials.RUBY, 0.0F, -3.0F, new Item.Properties().setId(Keys.RUBY_HOE)));
    public static final HoeItem AZURITE_HOE = register(Keys.AZURITE_HOE.identifier().getPath(), new HoeItem(ToolMaterials.AZURITE, 0.0F, -3.0F, new Item.Properties().setId(Keys.AZURITE_HOE)));
    public static final HoeItem MAGMATIC_GEL_HOE = register(Keys.MAGMATIC_GEL_HOE.identifier().getPath(), new HoeItem(ToolMaterials.MAGMATIC_GEL, 0.0F, -3.0F, new Item.Properties().setId(Keys.MAGMATIC_GEL_HOE)));
    public static final HoeItem OBSIDIAN_HOE = register(Keys.OBSIDIAN_HOE.identifier().getPath(), new HoeItem(ToolMaterials.OBSIDIAN, 0.0F, -3.0F, new Item.Properties().setId(Keys.OBSIDIAN_HOE).rarity(Rarity.EPIC)));
    public static final HoeItem VOLUCITE_HOE = register(Keys.VOLUCITE_HOE.identifier().getPath(), new EffectHoeItem(ToolMaterials.VOLUCITE, 0.0F, -3.0F, new Item.Properties().setId(Keys.VOLUCITE_HOE).rarity(AerialHellRarities.VIBRANT)));
    public static final HoeItem LUNATIC_HOE = register(Keys.LUNATIC_HOE.identifier().getPath(), new HoeItem(ToolMaterials.LUNATIC, 0.0F, -1.0F, new Item.Properties().setId(Keys.LUNATIC_HOE).rarity(AerialHellRarities.LEGENDARY)));
    public static final HoeItem ARSONIST_HOE = register(Keys.ARSONIST_HOE.identifier().getPath(), new HoeItem(ToolMaterials.ARSONIST, 0.0F, -1.0F, new Item.Properties().setId(Keys.ARSONIST_HOE).fireResistant().rarity(AerialHellRarities.MYTHICAL)));

    public static final HoeItem REAPER_SCYTHE = register(Keys.REAPER_SCYTHE.identifier().getPath(), new EffectHoeItem(ToolMaterials.SHADOW, -2.8F, 4.0F, new Item.Properties().setId(Keys.REAPER_SCYTHE).rarity(AerialHellRarities.MYTHICAL)));

    //weapons
    public static final Item SKY_WOOD_SWORD = register(Keys.SKY_WOOD_SWORD.identifier().getPath(), new Item(new Item.Properties().setId(Keys.SKY_WOOD_SWORD).sword(ToolMaterials.SKY_WOOD, 3, -2.4F)));
    public static final Item STELLAR_STONE_SWORD = register(Keys.STELLAR_STONE_SWORD.identifier().getPath(), new Item(new Item.Properties().setId(Keys.STELLAR_STONE_SWORD).sword(ToolMaterials.STELLAR_STONE, 3, -2.4F)));
    public static final Item RUBY_SWORD = register(Keys.RUBY_SWORD.identifier().getPath(), new Item(new Item.Properties().setId(Keys.RUBY_SWORD).sword(ToolMaterials.RUBY, 3, -2.4F)));
    public static final Item AZURITE_SWORD = register(Keys.AZURITE_SWORD.identifier().getPath(), new Item(new Item.Properties().setId(Keys.AZURITE_SWORD).sword(ToolMaterials.AZURITE, 3, -2.4F)));
    public static final Item MAGMATIC_GEL_SWORD = register(Keys.MAGMATIC_GEL_SWORD.identifier().getPath(), new Item(new Item.Properties().setId(Keys.MAGMATIC_GEL_SWORD).sword(ToolMaterials.MAGMATIC_GEL, 3, -2.4F)));
    public static final Item OBSIDIAN_SWORD = register(Keys.OBSIDIAN_SWORD.identifier().getPath(), new Item(new Item.Properties().setId(Keys.OBSIDIAN_SWORD).sword(ToolMaterials.OBSIDIAN, 3, -2.4F).rarity(Rarity.EPIC)));
    public static final Item VOLUCITE_SWORD = register(Keys.VOLUCITE_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.VOLUCITE, 3, -2.4F, new Item.Properties().setId(Keys.VOLUCITE_SWORD).rarity(AerialHellRarities.VIBRANT)));
    public static final Item LUNATIC_SWORD = register(Keys.LUNATIC_SWORD.identifier().getPath(), new Item(new Item.Properties().setId(Keys.LUNATIC_SWORD).sword(ToolMaterials.LUNATIC, 3, -2.4F).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item ARSONIST_SWORD = register(Keys.ARSONIST_SWORD.identifier().getPath(), new AerialHellSwordItem(ToolMaterials.ARSONIST, 3, -2.4F, new Item.Properties().setId(Keys.ARSONIST_SWORD).fireResistant().rarity(AerialHellRarities.MYTHICAL)));

    public static final Item HEAVY_SWORD = register(Keys.HEAVY_SWORD.identifier().getPath(), new AerialHellSwordItem(ToolMaterials.HEAVY, 3, -2.7F, -0.30F, 0.0F, new Item.Properties().setId(Keys.HEAVY_SWORD).fireResistant().rarity(Rarity.EPIC)));
    public static final Item HEALTH_BOOST_SWORD = register(Keys.HEALTH_BOOST_SWORD.identifier().getPath(), new AerialHellSwordItem(ToolMaterials.LUNATIC, 3, -2.4F, 0.0F, 4.0F, new Item.Properties().setId(Keys.HEALTH_BOOST_SWORD).fireResistant().rarity(Rarity.EPIC)));
    public static final Item NINJA_SWORD = register(Keys.NINJA_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.OBSIDIAN, 2, -1.6F, 0.15F, 0.0F, new Item.Properties().setId(Keys.NINJA_SWORD).fireResistant().rarity(AerialHellRarities.LEGENDARY)));
    public static final Item NINJA_MASTER_SWORD = register(Keys.NINJA_MASTER_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.OBSIDIAN, 4, -2.4F, 0.15F, 0.0F, new Item.Properties().setId(Keys.NINJA_MASTER_SWORD).fireResistant().rarity(AerialHellRarities.MYTHICAL)));
    public static final Item GLOUTON_SWORD = register(Keys.GLOUTON_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.RUBY, 3, -2.4F, new Item.Properties().setId(Keys.GLOUTON_SWORD).fireResistant().fireResistant().rarity(AerialHellRarities.LEGENDARY)));
    public static final Item RANDOM_SWORD = register(Keys.RANDOM_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.RUBY, 2, -2.4F, new Item.Properties().setId(Keys.RANDOM_SWORD).fireResistant().rarity(Rarity.EPIC)));
    public static final Item DISLOYAL_SWORD = register(Keys.DISLOYAL_SWORD.identifier().getPath(), new AerialHellSwordItem(ToolMaterials.LUNATIC, 2, -2.4F, new Item.Properties().setId(Keys.DISLOYAL_SWORD).fireResistant().rarity(AerialHellRarities.LEGENDARY)));
    public static final Item CURSED_SWORD = register(Keys.CURSED_SWORD.identifier().getPath(), new AerialHellSwordItem(ToolMaterials.SHADOW, 1, -2.5F, new Item.Properties().setId(Keys.CURSED_SWORD).fireResistant().rarity(AerialHellRarities.CORRUPTED)));
    public static final Item ABSOLUTE_ZERO_SWORD = register(Keys.ABSOLUTE_ZERO_SWORD.identifier().getPath(), new AerialHellSwordItem(ToolMaterials.LUNATIC, 2, -2.4F, new Item.Properties().setId(Keys.ABSOLUTE_ZERO_SWORD).fireResistant().rarity(AerialHellRarities.MYTHICAL)));
    public static final Item SWORD_OF_LIGHT = register(Keys.SWORD_OF_LIGHT.identifier().getPath(), new EffectSwordItem(ToolMaterials.LUNATIC, 2, -2.4F, new Item.Properties().setId(Keys.SWORD_OF_LIGHT).fireResistant().rarity(AerialHellRarities.LEGENDARY)));
    public static final Item ANTIDOTE_SWORD = register(Keys.ANTIDOTE_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.RUBY, 4, -2.4F, new Item.Properties().setId(Keys.ANTIDOTE_SWORD).fireResistant().rarity(Rarity.EPIC)));
    public static final Item NETHERIAN_KING_SWORD = register(Keys.NETHERIAN_KING_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.OBSIDIAN, 1, -2.4F, new Item.Properties().setId(Keys.NETHERIAN_KING_SWORD).fireResistant().rarity(AerialHellRarities.LEGENDARY)));
    public static final Item GLASS_CANON_SWORD = register(Keys.GLASS_CANON_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.ARSONIST, 7, -1.6F, new Item.Properties().setId(Keys.GLASS_CANON_SWORD).fireResistant().rarity(AerialHellRarities.MYTHICAL)));
    public static final Item GOD_SWORD = register(Keys.GOD_SWORD.identifier().getPath(), new EffectSwordItem(ToolMaterials.ARSONIST, 3, -2.4F, new Item.Properties().setId(Keys.GOD_SWORD).fireResistant().rarity(AerialHellRarities.MYTHICAL)));

    public static final Item FORGOTTEN_BATTLE_TRIDENT = register(Keys.FORGOTTEN_BATTLE_TRIDENT.identifier().getPath(), new ForgottenBattleTridentItem(ToolMaterials.VOLUCITE, 3, -2.9F, 0.2F, 0.0F, new Item.Properties().setId(Keys.FORGOTTEN_BATTLE_TRIDENT).durability(1000).rarity(AerialHellRarities.LEGENDARY)));

    //armor
    public static final Item RUBY_HELMET = register(Keys.RUBY_HELMET.identifier().getPath(), new Item(new Item.Properties().setId(Keys.RUBY_HELMET).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(15))));
    public static final Item RUBY_CHESTPLATE = register(Keys.RUBY_CHESTPLATE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.RUBY_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(15))));
    public static final Item RUBY_LEGGINGS = register(Keys.RUBY_LEGGINGS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.RUBY_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(15))));
    public static final Item RUBY_BOOTS = register(Keys.RUBY_BOOTS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.RUBY_BOOTS).humanoidArmor(AerialHellArmorMaterials.RUBY, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(15))));

    public static final Item AZURITE_HELMET = register(Keys.AZURITE_HELMET.identifier().getPath(), new Item(new Item.Properties().setId(Keys.AZURITE_HELMET).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(10))));
    public static final Item AZURITE_CHESTPLATE = register(Keys.AZURITE_CHESTPLATE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.AZURITE_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(10))));
    public static final Item AZURITE_LEGGINGS = register(Keys.AZURITE_LEGGINGS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.AZURITE_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(10))));
    public static final Item AZURITE_BOOTS = register(Keys.AZURITE_BOOTS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.AZURITE_BOOTS).humanoidArmor(AerialHellArmorMaterials.AZURITE, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(10))));

    public static final Item OBSIDIAN_HELMET = register(Keys.OBSIDIAN_HELMET.identifier().getPath(), new Item(new Item.Properties().setId(Keys.OBSIDIAN_HELMET).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(37)).rarity(Rarity.EPIC)));
    public static final Item OBSIDIAN_CHESTPLATE = register(Keys.OBSIDIAN_CHESTPLATE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.OBSIDIAN_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(37)).rarity(Rarity.EPIC)));
    public static final Item OBSIDIAN_LEGGINGS = register(Keys.OBSIDIAN_LEGGINGS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.OBSIDIAN_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(37)).rarity(Rarity.EPIC)));
    public static final Item OBSIDIAN_BOOTS = register(Keys.OBSIDIAN_BOOTS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.OBSIDIAN_BOOTS).humanoidArmor(AerialHellArmorMaterials.OBSIDIAN, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(37)).rarity(Rarity.EPIC)));

    public static final Item VOLUCITE_HELMET = register(Keys.VOLUCITE_HELMET.identifier().getPath(), new Item(new Item.Properties().setId(Keys.VOLUCITE_HELMET).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(35)).rarity(AerialHellRarities.VIBRANT)));
    public static final Item VOLUCITE_CHESTPLATE = register(Keys.VOLUCITE_CHESTPLATE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.VOLUCITE_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(35)).rarity(AerialHellRarities.VIBRANT)));
    public static final Item VOLUCITE_LEGGINGS = register(Keys.VOLUCITE_LEGGINGS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.VOLUCITE_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(35)).rarity(AerialHellRarities.VIBRANT)));
    public static final Item VOLUCITE_BOOTS = register(Keys.VOLUCITE_BOOTS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.VOLUCITE_BOOTS).humanoidArmor(AerialHellArmorMaterials.VOLUCITE, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(35)).rarity(AerialHellRarities.VIBRANT)));

    public static final Item MAGMATIC_GEL_HELMET = register(Keys.MAGMATIC_GEL_HELMET.identifier().getPath(), new Item(new Item.Properties().setId(Keys.MAGMATIC_GEL_HELMET).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(7))));
    public static final Item MAGMATIC_GEL_CHESTPLATE = register(Keys.MAGMATIC_GEL_CHESTPLATE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.MAGMATIC_GEL_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(7))));
    public static final Item MAGMATIC_GEL_LEGGINGS = register(Keys.MAGMATIC_GEL_LEGGINGS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.MAGMATIC_GEL_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(7))));
    public static final Item MAGMATIC_GEL_BOOTS = register(Keys.MAGMATIC_GEL_BOOTS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.MAGMATIC_GEL_BOOTS).humanoidArmor(AerialHellArmorMaterials.MAGMATIC_GEL, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(7))));

    public static final Item LUNATIC_HELMET = register(Keys.LUNATIC_HELMET.identifier().getPath(), new Item(new Item.Properties().setId(Keys.LUNATIC_HELMET).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(33)).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item LUNATIC_CHESTPLATE = register(Keys.LUNATIC_CHESTPLATE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.LUNATIC_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(33)).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item LUNATIC_LEGGINGS = register(Keys.LUNATIC_LEGGINGS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.LUNATIC_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(33)).rarity(AerialHellRarities.LEGENDARY)));
    public static final Item LUNATIC_BOOTS = register(Keys.LUNATIC_BOOTS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.LUNATIC_BOOTS).humanoidArmor(AerialHellArmorMaterials.LUNATIC, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(33)).rarity(AerialHellRarities.LEGENDARY)));

    public static final Item ARSONIST_HELMET = register(Keys.ARSONIST_HELMET.identifier().getPath(), new Item(new Item.Properties().setId(Keys.ARSONIST_HELMET).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(37)).rarity(AerialHellRarities.MYTHICAL).fireResistant()));
    public static final Item ARSONIST_CHESTPLATE = register(Keys.ARSONIST_CHESTPLATE.identifier().getPath(), new Item(new Item.Properties().setId(Keys.ARSONIST_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(37)).rarity(AerialHellRarities.MYTHICAL).fireResistant()));
    public static final Item ARSONIST_LEGGINGS = register(Keys.ARSONIST_LEGGINGS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.ARSONIST_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(37)).rarity(AerialHellRarities.MYTHICAL).fireResistant()));
    public static final Item ARSONIST_BOOTS = register(Keys.ARSONIST_BOOTS.identifier().getPath(), new Item(new Item.Properties().setId(Keys.ARSONIST_BOOTS).humanoidArmor(AerialHellArmorMaterials.ARSONIST, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(37)).rarity(AerialHellRarities.MYTHICAL).fireResistant()));

    public static final Item SHADOW_HELMET = register(Keys.SHADOW_HELMET.identifier().getPath(), new ShadowArmorItem(new Item.Properties().setId(Keys.SHADOW_HELMET).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.HELMET).durability(ArmorType.HELMET.getDurability(25)).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_CHESTPLATE = register(Keys.SHADOW_CHESTPLATE.identifier().getPath(), new ShadowArmorItem(new Item.Properties().setId(Keys.SHADOW_CHESTPLATE).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.CHESTPLATE).durability(ArmorType.CHESTPLATE.getDurability(25)).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_LEGGINGS = register(Keys.SHADOW_LEGGINGS.identifier().getPath(), new ShadowArmorItem(new Item.Properties().setId(Keys.SHADOW_LEGGINGS).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.LEGGINGS).durability(ArmorType.LEGGINGS.getDurability(25)).rarity(AerialHellRarities.CORRUPTED)));
    public static final Item SHADOW_BOOTS = register(Keys.SHADOW_BOOTS.identifier().getPath(), new ShadowArmorItem(new Item.Properties().setId(Keys.SHADOW_BOOTS).humanoidArmor(AerialHellArmorMaterials.SHADOW, ArmorType.BOOTS).durability(ArmorType.BOOTS.getDurability(25)).rarity(AerialHellRarities.CORRUPTED)));
