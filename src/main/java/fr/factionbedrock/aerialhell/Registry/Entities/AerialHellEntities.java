...
{
	public static final EntityType<StellarStoneAutomatonEntity> STELLAR_STONE_AUTOMATON = register("stellar_stone_automaton", StellarStoneAutomatonEntity::new, 0.9F,2.1F, MobCategory.MONSTER);
	public static final EntityType<MudGolemEntity> MUD_GOLEM = register("mud_golem", MudGolemEntity::new, 1.4F,2.3F, MobCategory.MONSTER);
	public static final EntityType<MudSpectralGolemEntity> MUD_SPECTRAL_GOLEM = register("mud_spectral_golem", MudSpectralGolemEntity::new, 1.4F,2.3F, MobCategory.MONSTER);
	public static final EntityType<CrystalGolemEntity> CRYSTAL_GOLEM = register("crystal_golem", CrystalGolemEntity::new, 0.9F,1.95F, MobCategory.MONSTER);
	public static final EntityType<LunaticPriestEntity> LUNATIC_PRIEST = register("lunatic_priest", LunaticPriestEntity::new, 0.8F,2.5F, MobCategory.MONSTER);
	public static final EntityType<EvilCowEntity> EVIL_COW = register("evil_cow", EvilCowEntity::new, 0.99F, 1.4F, MobCategory.MONSTER);
	public static final EntityType<EvilCowEntity> CORTINARIUS_COW = register("cortinarius_cow", EvilCowEntity::new, 0.99F, 1.4F, MobCategory.MONSTER);
	public static final EntityType<EntEntity> STELLAR_ENT = register("stellar_ent", EntEntity::new, 0.7F,2.0F, MobCategory.MONSTER);
	public static final EntityType<VenomousSnakeEntity> VENOMOUS_SNAKE = register("venomous_snake", VenomousSnakeEntity::new, 0.8F,0.8F, MobCategory.MONSTER);
	public static final EntityType<WormEntity> WORM = register("worm", WormEntity::new, 0.8F,0.8F, MobCategory.MONSTER);
	public static final EntityType<StellarChickenEntity> STELLAR_CHICKEN = register("stellar_chicken", StellarChickenEntity::new, 0.4F, 0.7F, MobCategory.CREATURE);
	public static final EntityType<BoarEntity> STELLAR_BOAR = register("stellar_boar", BoarEntity::new, 0.9F, 0.9F, MobCategory.CREATURE);
	public static final EntityType<ShroomBoomEntity> SHROOMBOOM = register("shroomboom", ShroomBoomEntity::new, 0.6F, 1.7F, MobCategory.MONSTER);
	public static final EntityType<VerdigrisZombieEntity> VERDIGRIS_ZOMBIE = register("verdigris_zombie", VerdigrisZombieEntity::new, 0.7F,2.0F, MobCategory.MONSTER);
	public static final EntityType<MummyEntity> MUMMY = register("mummy", MummyEntity::new, 0.7F,1.9F, MobCategory.MONSTER);
	public static final EntityType<SlimePirateEntity> SLIME_PIRATE = register("slime_pirate", SlimePirateEntity::new, 0.7F,1.9F, MobCategory.MONSTER);
	public static final EntityType<SlimeNinjaPirateEntity> SLIME_NINJA_PIRATE = register("slime_ninja_pirate", SlimeNinjaPirateEntity::new, 0.7F,1.9F, MobCategory.MONSTER);
	public static final EntityType<GhostSlimePirateEntity> GHOST_SLIME_PIRATE = register("ghost_slime_pirate", GhostSlimePirateEntity::new, 0.7F,1.9F, MobCategory.MONSTER);
	public static final EntityType<GhostSlimeNinjaPirateEntity> GHOST_SLIME_NINJA_PIRATE = register("ghost_slime_ninja_pirate", GhostSlimeNinjaPirateEntity::new, 0.7F,1.9F, MobCategory.MONSTER);
	public static final EntityType<SandySheepEntity> SANDY_SHEEP = register("sandy_sheep", SandySheepEntity::new, 0.9F, 1.4F, MobCategory.CREATURE);
	public static final EntityType<GlidingTurtleEntity> GLIDING_TURTLE = register("gliding_turtle", GlidingTurtleEntity::new, 1.4F, 1.9F, MobCategory.CREATURE);
	public static final EntityType<FatPhantomEntity> FAT_PHANTOM = register("fat_phantom", FatPhantomEntity::new, 2.6F, 1.5F, MobCategory.CREATURE);
	public static final EntityType<KodamaEntity> KODAMA = register("kodama", KodamaEntity::new, 0.7F, 0.9F, MobCategory.CREATURE);
	public static final EntityType<CrystalSlimeEntity> CRYSTAL_SLIME = register("crystal_slime", CrystalSlimeEntity::new, 1.0F, 1.0F, MobCategory.MONSTER);
	public static final EntityType<MudSoldierEntity> MUD_SOLDIER = register("mud_soldier", MudSoldierEntity::new, 0.6F, 1.99F, MobCategory.MONSTER);
	public static final EntityType<MudSpectralSoldierEntity> MUD_SPECTRAL_SOLDIER = register("mud_spectral_soldier", MudSpectralSoldierEntity::new, 0.6F, 1.99F, MobCategory.MONSTER);
	public static final EntityType<MudCycleMageEntity> MUD_CYCLE_MAGE = register("mud_cycle_mage", MudCycleMageEntity::new, 0.6F, 1.99F, MobCategory.MONSTER);
	public static final EntityType<MudSpectralCycleMageEntity> MUD_SPECTRAL_CYCLE_MAGE = register("mud_spectral_cycle_mage", MudSpectralCycleMageEntity::new, 0.6F, 1.99F, MobCategory.MONSTER);
	public static final EntityType<TornSpiritEntity> TORN_SPIRIT = register("torn_spirit", TornSpiritEntity::new, 0.8F,1.95F, MobCategory.MONSTER);
	public static final EntityType<IceSpiritEntity> ICE_SPIRIT = register("ice_spirit", IceSpiritEntity::new, 0.7F, 1.0F, MobCategory.MONSTER);
	public static final EntityType<FireSpiritEntity> FIRE_SPIRIT = register("fire_spirit", FireSpiritEntity::new, 0.7F, 1.0F, MobCategory.MONSTER);
	public static final EntityType<ElectroSpiritEntity> ELECTRO_SPIRIT = register("electro_spirit", ElectroSpiritEntity::new, 0.7F, 1.0F, MobCategory.MONSTER);
	public static final EntityType<ChainedGodEntity> CHAINED_GOD = register("chained_god", ChainedGodEntity::new, 2.8F,5F, MobCategory.MONSTER);
	public static final EntityType<PoisonballEntity> POISONBALL = register("poisonball", PoisonballEntity::new, 1.0F, 1.0F, MobCategory.MISC);
	public static final EntityType<DimensionShattererProjectileEntity> DIMENSION_SHATTERER_PROJECTILE = register("dimension_shatterer_projectile", DimensionShattererProjectileEntity::new, 1.0F, 1.0F, MobCategory.MISC);
	public static final EntityType<FlyingJellyfishEntity> FLYING_JELLYFISH = register("flying_jellyfish", FlyingJellyfishEntity::new, 3.0F, 3.0F, MobCategory.MONSTER);
	public static final EntityType<ThrownStellarEgg> THROWN_STELLAR_EGG = register("thrown_stellar_egg", ThrownStellarEgg::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ShurikenEntity> IRON_SHURIKEN = register("iron_shuriken", (entityType, level) -> new ShurikenEntity(entityType, level, 8.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ShurikenEntity> GOLD_SHURIKEN = register("gold_shuriken", (entityType, level) -> new ShurikenEntity(entityType, level, 9.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ShurikenEntity> DIAMOND_SHURIKEN = register("diamond_shuriken", (entityType, level) -> new ShurikenEntity(entityType, level, 11.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ShurikenEntity> NETHERITE_SHURIKEN = register("netherite_shuriken", (entityType, level) -> new ShurikenEntity(entityType, level, 12.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ShurikenEntity> RUBY_SHURIKEN = register("ruby_shuriken", (entityType, level) -> new ShurikenEntity(entityType, level, 9.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ShurikenEntity> AZURITE_SHURIKEN = register("azurite_shuriken", (entityType, level) -> new ShurikenEntity(entityType, level, 9.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<SlowingShurikenEntity> MAGMATIC_GEL_SHURIKEN = register("magmatic_gel_shuriken", (entityType, level) -> new SlowingShurikenEntity(entityType, level, 9.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<NoGravityShurikenEntity> VOLUCITE_SHURIKEN = register("volucite_shuriken", (entityType, level) -> new NoGravityShurikenEntity(entityType, level, 13.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ShurikenEntity> OBSIDIAN_SHURIKEN = register("obsidian_shuriken", (entityType, level) -> new ShurikenEntity(entityType, level, 11.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ShurikenEntity> LUNATIC_CRYSTAL_SHURIKEN = register("lunatic_crystal_shuriken", (entityType, level) -> new ShurikenEntity(entityType, level, 12.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<FlamingShurikenEntity> ARSONIST_SHURIKEN = register("arsonist_shuriken", (entityType, level) -> new FlamingShurikenEntity(entityType, level, 14.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<LightningShurikenEntity> LIGHTNING_SHURIKEN = register("lightning_shuriken", (entityType, level) -> new LightningShurikenEntity(entityType, level, 2.0F), 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<VoluciteShardEntity> VOLUCITE_SHARD = register("volucite_shard", VoluciteShardEntity::new, 0.5F, 0.5F, MobCategory.MISC);
	public static final EntityType<RubyShardEntity> RUBY_SHARD = register("ruby_shard", RubyShardEntity::new, 0.5F, 0.5F, MobCategory.MISC);
	public static final EntityType<LunaticProjectileEntity> LUNATIC_PROJECTILE = register("lunatic_projectile", LunaticProjectileEntity::new, 1.1F, 1.1F, MobCategory.MISC);
	public static final EntityType<ShadowProjectileEntity> SHADOW_PROJECTILE = register("shadow_projectile", ShadowProjectileEntity::new, 1.1F, 1.1F, MobCategory.MISC);
	public static final EntityType<ShadowFlyingSkullEntity> SHADOW_FLYING_SKULL = register("shadow_flying_skull", ShadowFlyingSkullEntity::new, 0.8F, 0.8F, MobCategory.MONSTER);
	public static final EntityType<ShadowTrollEntity> SHADOW_TROLL = register("shadow_troll", ShadowTrollEntity::new, 1.2F, 2.5F, MobCategory.MONSTER);
	public static final EntityType<ShadowAutomatonEntity> SHADOW_AUTOMATON = register("shadow_automaton", ShadowAutomatonEntity::new, 0.8F,1.95F, MobCategory.MONSTER);
	public static final EntityType<LilithEntity> LILITH = register("lilith", LilithEntity::new, 0.8F,1.8F, MobCategory.MONSTER);
	public static final EntityType<AerialTreeChestMimicEntity> AERIAL_TREE_MIMIC = register("aerial_tree_mimic", AerialTreeChestMimicEntity::new, 0.99F, 2.0F, MobCategory.MONSTER);
	public static final EntityType<GoldenBeechChestMimicEntity> GOLDEN_BEECH_MIMIC = register("golden_beech_mimic", GoldenBeechChestMimicEntity::new, 0.99F, 2.0F, MobCategory.MONSTER);
	public static final EntityType<SkyCactusFiberChestMimicEntity> SKY_CACTUS_FIBER_MIMIC = register("sky_cactus_fiber_mimic", SkyCactusFiberChestMimicEntity::new, 0.99F, 2.0F, MobCategory.MONSTER);
	public static final EntityType<CopperPineChestMimicEntity> COPPER_PINE_MIMIC = register("copper_pine_mimic", CopperPineChestMimicEntity::new, 0.99F, 2.0F, MobCategory.MONSTER);
	public static final EntityType<ShadowPineBarrelMimicEntity> SHADOW_PINE_MIMIC = register("shadow_pine_mimic", ShadowPineBarrelMimicEntity::new, 0.99F, 0.9F, MobCategory.MONSTER);
	public static final EntityType<HellSpiderEntity> HELL_SPIDER = register("hell_spider", HellSpiderEntity::new, 0.85F, 0.8F, MobCategory.MONSTER);
	public static final EntityType<CrystalSpiderEntity> CRYSTAL_SPIDER = register("crystal_spider", CrystalSpiderEntity::new, 1.1F, 0.9F, MobCategory.MONSTER);
	public static final EntityType<ShadowSpiderEntity> SHADOW_SPIDER = register("shadow_spider", ShadowSpiderEntity::new, 0.85F, 0.8F, MobCategory.MONSTER);
	public static final EntityType<ForestCaterpillarEntity> FOREST_CATERPILLAR = register("forest_caterpillar", ForestCaterpillarEntity::new, 0.4F, 0.4F, MobCategory.MONSTER);
	public static final EntityType<CrystalCaterpillarEntity> CRYSTAL_CATERPILLAR = register("crystal_caterpillar", CrystalCaterpillarEntity::new, 0.4F, 0.4F, MobCategory.MONSTER);
	public static final EntityType<AerialHellPaintingEntity> AERIAL_HELL_PAINTING = registerPainting("aerial_hell_painting", AerialHellPaintingEntity::new, 0.5F, 0.5F, MobCategory.MISC);

	public static <E extends Entity> EntityType<E> registerPainting(String id, EntityType.EntityFactory<E> factory, float width, float height, MobCategory group)
	{
		return register(id, EntityType.Builder.of(factory, group).clientTrackingRange(10).updateInterval(Integer.MAX_VALUE).sized(width, height).build(id));
	}

	public static <E extends Entity> EntityType<E> register(String id, EntityType.EntityFactory<E> factory, float width, float height, MobCategory group)
	{
		return register(id, EntityType.Builder.of(factory, group).sized(width, height).build(id));
	}
