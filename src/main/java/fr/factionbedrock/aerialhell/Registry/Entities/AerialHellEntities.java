...
public class AerialHellEntities
{
	...
	public static final EntityType<IronShurikenEntity> IRON_SHURIKEN = register(Keys.IRON_SHURIKEN, IronShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<GoldShurikenEntity> GOLD_SHURIKEN = register(Keys.GOLD_SHURIKEN, GoldShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<DiamondShurikenEntity> DIAMOND_SHURIKEN = register(Keys.DIAMOND_SHURIKEN, DiamondShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<NetheriteShurikenEntity> NETHERITE_SHURIKEN = register(Keys.NETHERITE_SHURIKEN, NetheriteShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<RubyShurikenEntity> RUBY_SHURIKEN = register(Keys.RUBY_SHURIKEN, RubyShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<AzuriteShurikenEntity> AZURITE_SHURIKEN = register(Keys.AZURITE_SHURIKEN, AzuriteShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<MagmaticGelShurikenEntity> MAGMATIC_GEL_SHURIKEN = register(Keys.MAGMATIC_GEL_SHURIKEN, MagmaticGelShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<VoluciteShurikenEntity> VOLUCITE_SHURIKEN = register(Keys.VOLUCITE_SHURIKEN, VoluciteShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ObsidianShurikenEntity> OBSIDIAN_SHURIKEN = register(Keys.OBSIDIAN_SHURIKEN, ObsidianShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<LunaticCrystalShurikenEntity> LUNATIC_CRYSTAL_SHURIKEN = register(Keys.LUNATIC_CRYSTAL_SHURIKEN, LunaticCrystalShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ArsonistShurikenEntity> ARSONIST_SHURIKEN = register(Keys.ARSONIST_SHURIKEN, ArsonistShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<LightningShurikenEntity> LIGHTNING_SHURIKEN = register(Keys.LIGHTNING_SHURIKEN, LightningShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
