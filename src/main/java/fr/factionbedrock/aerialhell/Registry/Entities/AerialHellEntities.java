...
public class AerialHellEntities
{
	...
	public static final EntityType<IronShurikenEntity> IRON_SHURIKEN = register("iron_shuriken", IronShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<GoldShurikenEntity> GOLD_SHURIKEN = register("gold_shuriken", GoldShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<DiamondShurikenEntity> DIAMOND_SHURIKEN = register("diamond_shuriken", DiamondShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<NetheriteShurikenEntity> NETHERITE_SHURIKEN = register("netherite_shuriken", NetheriteShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<RubyShurikenEntity> RUBY_SHURIKEN = register("ruby_shuriken", RubyShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<AzuriteShurikenEntity> AZURITE_SHURIKEN = register("azurite_shuriken", AzuriteShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<MagmaticGelShurikenEntity> MAGMATIC_GEL_SHURIKEN = register("magmatic_gel_shuriken", MagmaticGelShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<VoluciteShurikenEntity> VOLUCITE_SHURIKEN = register("volucite_shuriken", VoluciteShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ObsidianShurikenEntity> OBSIDIAN_SHURIKEN = register("obsidian_shuriken", ObsidianShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<LunaticCrystalShurikenEntity> LUNATIC_CRYSTAL_SHURIKEN = register("lunatic_crystal_shuriken", LunaticCrystalShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<ArsonistShurikenEntity> ARSONIST_SHURIKEN = register("arsonist_shuriken", ArsonistShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<LightningShurikenEntity> LIGHTNING_SHURIKEN = register("lightning_shuriken", LightningShurikenEntity::new, 0.25F, 0.25F, MobCategory.MISC);
	public static final EntityType<VoluciteArrowEntity> VOLUCITE_BLOWPIPE_ARROW = register("volucite_blowpipe_arrow", VoluciteArrowEntity::new, 0.5F, 0.5F, MobCategory.MISC);
	public static final EntityType<RubyArrowEntity> RUBY_BLOWPIPE_ARROW = register("ruby_blowpipe_arrow", RubyArrowEntity::new, 0.5F, 0.5F, MobCategory.MISC);
