...
import fr.factionbedrock.aerialhell.Enchantments.*;
...
public class AerialHellEnchantments
{
    ...
    public static final RegistryObject<Enchantment> VULNERABILITY_ASPECT = ENCHANTMENTS.register("vulnerability_aspect", () -> new VulnerabilityAspect(Enchantment.Rarity.RARE, MAIN_HAND));
}
