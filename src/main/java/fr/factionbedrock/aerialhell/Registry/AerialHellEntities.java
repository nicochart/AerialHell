...
public class AerialHellEntities
{
	...
	public static final EntityType<ShadowFlyingSkullEntity> SHADOW_FLYING_SKULL_TYPE = EntityType.Builder.create(ShadowFlyingSkullEntity::new, EntityClassification.MONSTER)
				.size(0.8F, 0.8F).build("shadow_flying_skull");
	...
	public static void entitySpawnPlacements()
	{
		...
		EntitySpawnPlacementRegistry.register(SHADOW_AUTOMATON.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AerialHellHostileEntity::canHostileEntitySpawn);
