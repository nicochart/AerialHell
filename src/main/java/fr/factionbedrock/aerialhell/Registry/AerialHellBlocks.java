...
public class AerialHellBlocks
{
    ...
    //grass
    public static final Block STELLAR_GRASS = register("stellar_grass", new ShiftableRenderTallGrassBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block STELLAR_GRASS_BALL = register("stellar_grass_ball", new ShiftableRenderTallGrassBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block STELLAR_FERN = register("stellar_fern", new AerialHellTallGrassBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block STELLAR_TALL_GRASS = register("stellar_tall_grass", new TallPlantBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block STELLAR_TALL_FERN = register("stellar_tall_fern", new TallPlantBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    ...
    public static final Block BLUISH_FERN = register("bluish_fern", new AerialHellTallGrassBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block TALL_BLUISH_FERN = register("tall_bluish_fern", new TallPlantBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block POLYCHROME_FERN = register("polychrome_fern", new AerialHellTallGrassBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block TALL_POLYCHROME_FERN = register("tall_polychrome_fern", new TallPlantBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block STELLAR_DEAD_BUSH = register("stellar_dead_bush", new AerialHellDeadBushBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).mapColor(MapColor.BROWN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    ...
    public static final Block SHADOW_GRASS = register("shadow_grass", new ShadowPlantBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block SHADOW_GRASS_BALL = register("shadow_grass_ball", new ShadowPlantBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block PURPLISH_STELLAR_GRASS = register("purplish_stellar_grass", new AerialHellTallGrassBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block STELLAR_CLOVERS = register("stellar_clovers", new AerialHellTallGrassBlock(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    public static final Block GLOWING_STELLAR_GRASS = register("glowing_stellar_grass", new GlowingStellarTallGrass(AbstractBlock.Settings.create().mapColor(MapColor.GREEN).ticksRandomly().noCollision().luminance((state) -> {return state.get(Properties.LIT) ? 10 : 0;}).breakInstantly().sounds(BlockSoundGroup.GRASS)));
