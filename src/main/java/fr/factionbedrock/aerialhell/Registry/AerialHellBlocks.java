...
public class AerialHellBlocks
{
    ...
    public static final Block VOLUCITE_STONE = register(Keys.VOLUCITE_STONE.getValue().getPath(), new VoluciteStoneBlock(AbstractBlock.Settings.create().registryKey(Keys.VOLUCITE_STONE).strength(2.0F, 6.0F).sounds(BlockSoundGroup.STONE).luminance(getLightValueLit(AerialHellBooleanProperties.SELF_LUMINESCENT, 8))));
    ...
    public static final Block LIGHT_VOLUCITE_STONE = register(Keys.LIGHT_VOLUCITE_STONE.getValue().getPath(), new CoreProtectedBlock(AbstractBlock.Settings.create().registryKey(Keys.LIGHT_VOLUCITE_STONE).strength(2.0F, 6.0F).sounds(BlockSoundGroup.STONE).luminance((state) -> 13)));
    ...
    public static final SlabBlock VOLUCITE_STONE_SLAB = register(Keys.VOLUCITE_STONE_SLAB.getValue().getPath(), new CoreProtectedSlabBlock(AbstractBlock.Settings.copy(CRACKED_VOLUCITE_STONE).registryKey(Keys.VOLUCITE_STONE_SLAB)));
    public static final StairsBlock VOLUCITE_STONE_STAIRS = register(Keys.VOLUCITE_STONE_STAIRS.getValue().getPath(), new CoreProtectedStairsBlock(VOLUCITE_STONE.getDefaultState(), AbstractBlock.Settings.copy(CRACKED_VOLUCITE_STONE).registryKey(Keys.VOLUCITE_STONE_STAIRS)));
    public static final WallBlock VOLUCITE_STONE_WALL = register(Keys.VOLUCITE_STONE_WALL.getValue().getPath(), new CoreProtectedWallBlock(AbstractBlock.Settings.copy(CRACKED_VOLUCITE_STONE).registryKey(Keys.VOLUCITE_STONE_WALL)));
    ...
    public static final StairsBlock CRACKED_VOLUCITE_STONE_STAIRS = register(Keys.CRACKED_VOLUCITE_STONE_STAIRS.getValue().getPath(), new CoreProtectedStairsBlock(CRACKED_VOLUCITE_STONE.getDefaultState(), AbstractBlock.Settings.copy(CRACKED_VOLUCITE_STONE).registryKey(Keys.CRACKED_VOLUCITE_STONE_STAIRS)));
    ...
    public static final StairsBlock CRACKED_LUNATIC_STONE_STAIRS = register(Keys.CRACKED_LUNATIC_STONE_STAIRS.getValue().getPath(), new CoreProtectedStairsBlock(CRACKED_LUNATIC_STONE.getDefaultState(), AbstractBlock.Settings.copy(CRACKED_LUNATIC_STONE).registryKey(Keys.CRACKED_LUNATIC_STONE_STAIRS)));
    ...
    public static final StairsBlock GOLDEN_NETHER_BRICKS_STAIRS = register(Keys.GOLDEN_NETHER_BRICKS_STAIRS.getValue().getPath(), new CoreProtectedStairsBlock(GOLDEN_NETHER_BRICKS.getDefaultState(), AbstractBlock.Settings.copy(GOLDEN_NETHER_BRICKS).registryKey(Keys.GOLDEN_NETHER_BRICKS_STAIRS)));
    ...
    public static final Block VOLUCITE_BOOKSHELF = register(Keys.VOLUCITE_BOOKSHELF.getValue().getPath(), new CoreProtectedBlock(AbstractBlock.Settings.copy(CRACKED_VOLUCITE_STONE).registryKey(Keys.VOLUCITE_BOOKSHELF)));
    ...
    public static final Block VOLUCITE_GLYPH_BLOCK = register(Keys.VOLUCITE_GLYPH_BLOCK.getValue().getPath(), new CoreProtectedGlyphBlock(AbstractBlock.Settings.copy(CRACKED_VOLUCITE_STONE).registryKey(Keys.VOLUCITE_GLYPH_BLOCK).luminance((state) -> 9)));
    ...
    public static final Block STELLAR_FURNACE = register(Keys.STELLAR_FURNACE.getValue().getPath(), new StellarFurnaceBlock(AbstractBlock.Settings.create().registryKey(Keys.STELLAR_FURNACE).requiresTool().strength(3.5F).luminance(getLightValueLit(Properties.LIT, 13))));
    public static final Block GHOST_STELLAR_FURNACE = register(Keys.GHOST_STELLAR_FURNACE.getValue().getPath(), new GhostStellarFurnaceBlock(AbstractBlock.Settings.create().registryKey(Keys.GHOST_STELLAR_FURNACE).requiresTool().nonOpaque().strength(3.5F).luminance(getLightValueLit(Properties.LIT, 13))));

    private static ToIntFunction<BlockState> getLightValueLit(BooleanProperty property, int lightValue) {return (state) -> {return state.get(property) ? lightValue : 0;};}
