...
public class AerialHellPotionEffects
{
    ...
    public static final RegistryObject<Effect> GOD = EFFECTS.register("god", () -> (new GodEffect(EffectType.BENEFICIAL, 9740385)).addAttributesModifier(Attributes.ATTACK_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", (double)0.1F, AttributeModifier.Operation.MULTIPLY_TOTAL).addAttributesModifier(Attributes.MAX_HEALTH, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 10.0D, AttributeModifier.Operation.ADDITION));
}