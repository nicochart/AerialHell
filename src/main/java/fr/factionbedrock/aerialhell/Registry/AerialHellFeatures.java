...
public class AerialHellFeatures
{
    ...
    public static ConfiguredFeature<BigMushroomFeatureConfig, ?> GIANT_VERDIGRIS_AGARIC_PLANTED = Feature.HUGE_RED_MUSHROOM.withConfiguration(Configs.GIANT_VERDIGRIS_AGARIC_MUSHROOM_CONFIG);
    ...
    public static ConfiguredFeature<BigMushroomFeatureConfig, ?> HUGE_VERDIGRIS_AGARIC_PLANTED = new HugeMushroomFeature(BigMushroomFeatureConfig.CODEC).withConfiguration(Configs.GIANT_VERDIGRIS_AGARIC_MUSHROOM_CONFIG);
    ...
    public static ConfiguredFeature<?, ?> GIANT_GANODERMA_APPLANATUM = new GiantGanodermaApplanatumFeature(NoFeatureConfig.field_236558_a_).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).range(256).square().func_242731_b(20);
    public static ConfiguredFeature<?, ?> GIANT_RED_MUSHROOM = Feature.HUGE_RED_MUSHROOM.withConfiguration(Configs.GIANT_RED_MUSHROOM_CONFIG).withPlacement(Placement.COUNT_MULTILAYER.configure(new FeatureSpreadConfig(1)));
    ...
    public static ConfiguredFeature<?, ?> DANGLING_CHAIN_RARE = new DanglingChainFeature(NoFeatureConfig.field_236558_a_).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).range(256).square().func_242731_b(10);
    public static ConfiguredFeature<?, ?> DANGLING_CHAIN = new DanglingChainFeature(NoFeatureConfig.field_236558_a_).withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).range(256).square().func_242731_b(120);
