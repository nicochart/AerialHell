...
public class AerialHellFoods
{
    public static class Properties
    {
        ...
        public static final FoodProperties FROZEN_AERIAL_BERRY = new FoodProperties.Builder().nutrition(4).saturationModifier(0.4F).alwaysEdible().build();
        public static final FoodProperties STELLAR_BREAD = new FoodProperties.Builder().nutrition(5).saturationModifier(0.6F).build();
        public static final FoodProperties FROZEN_MUTTON = new FoodProperties.Builder().nutrition(6).saturationModifier(0.8F).alwaysEdible().build();
        public static final FoodProperties VIBRANT_CHICKEN = new FoodProperties.Builder().nutrition(6).saturationModifier(0.8F).build();
        public static final FoodProperties FROZEN_CHICKEN = new FoodProperties.Builder().nutrition(6).saturationModifier(0.8F).alwaysEdible().build();
        ...
        public static final FoodProperties FROZEN_GLOWING_STICK_FRUIT = new FoodProperties.Builder().nutrition(6).saturationModifier(0.6F).alwaysEdible().build();
        ...
        public static final FoodProperties FROZEN_PHANTOM_MEAT = new FoodProperties.Builder().nutrition(6).saturationModifier(0.6F).alwaysEdible().build();
        ...
        public static final FoodProperties FROZEN_TURTLE_MEAT = new FoodProperties.Builder().nutrition(6).saturationModifier(0.6F).alwaysEdible().build();
    ...
    {
        public static final Consumable FROZEN_AERIAL_BERRY = defautEffectConsumableComponent(effectList(MobEffects.SLOWNESS, 310, 0, MobEffects.RESISTANCE, 210, 0));
        public static final Consumable FROZEN_MUTTON = defautEffectConsumableComponent(effectList(MobEffects.SLOWNESS, 310, 0, MobEffects.RESISTANCE, 210, 0));
        public static final Consumable VIBRANT_CHICKEN = defautEffectConsumableComponent(effectList(MobEffects.SLOW_FALLING, 60, 0));
        public static final Consumable FROZEN_CHICKEN = defautEffectConsumableComponent(effectList(MobEffects.SLOWNESS, 310, 0, MobEffects.RESISTANCE, 210, 0, MobEffects.HUNGER, 80, 0));
        public static final Consumable RUBY_AERIAL_BERRY = defautEffectConsumableComponent(effectList(MobEffects.HEALTH_BOOST, 2400, 0));
        public static final Consumable VOLUCITE_AERIAL_BERRY = defautEffectConsumableComponent(effectList(AerialHellMobEffects.HEAD_IN_THE_CLOUDS, 5000, 1));
        public static final Consumable FROZEN_GLOWING_STICK_FRUIT = defautEffectConsumableComponent(effectList(MobEffects.SLOWNESS, 120, 0, MobEffects.RESISTANCE, 180, 0));
        public static final Consumable CORTINARIUS_VIOLACEUS_PIECE = defautEffectConsumableComponent(effectList(MobEffects.NAUSEA, 100, 0));
        public static final Consumable GANODERMA_APPLANATUM_PIECE = defautEffectConsumableComponent(effectList(MobEffects.HUNGER, 100, 0));
        public static final Consumable DARK_SHADOW_FRUIT = defautEffectConsumableComponent(effectList(MobEffects.BLINDNESS, 20, 0, MobEffects.NIGHT_VISION, 120, 0));
        public static final Consumable PURPLE_SHADOW_FRUIT = defautEffectConsumableComponent(effectList(MobEffects.BLINDNESS, 20, 0, AerialHellMobEffects.SHADOW_IMMUNITY, 80, 0));
        public static final Consumable SHADOW_FRUIT_STEW = defautEffectConsumableComponent(effectList(MobEffects.BLINDNESS, 20, 0, AerialHellMobEffects.SHADOW_IMMUNITY, 1200, 0));
        public static final Consumable SOLID_ETHER_SOUP = defautEffectConsumableComponent(effectList(MobEffects.SLOW_FALLING, 160, 0, AerialHellMobEffects.HEAD_IN_THE_CLOUDS, 160, 0));
        public static final Consumable VIBRANT_SOLID_ETHER_SOUP = defautEffectConsumableComponent(effectList(MobEffects.SLOW_FALLING, 160, 0, AerialHellMobEffects.HEAD_IN_THE_CLOUDS, 160, 1));
        public static final Consumable FROZEN_SOLID_ETHER_SOUP = defautEffectConsumableComponent(effectList(MobEffects.SLOW_FALLING, 180, 0, AerialHellMobEffects.HEAD_IN_THE_CLOUDS, 160, 0, MobEffects.RESISTANCE, 210, 0));
        public static final Consumable SHADOW_SPIDER_EYE = defautEffectConsumableComponent(effectList(MobEffects.BLINDNESS, 20, 0, MobEffects.SLOWNESS, 120, 0));
        public static final Consumable PHANTOM_MEAT = defautEffectConsumableComponent(effectList(MobEffects.RESISTANCE, 120, 0));
        public static final Consumable VIBRANT_PHANTOM_MEAT = defautEffectConsumableComponent(effectList(MobEffects.RESISTANCE, 400, 1));
        public static final Consumable FROZEN_PHANTOM_MEAT = defautEffectConsumableComponent(effectList(MobEffects.RESISTANCE, 800, 1));
        public static final Consumable VIBRANT_TURTLE_MEAT = defautEffectConsumableComponent(effectList(MobEffects.SLOW_FALLING, 400, 0));
        public static final Consumable FROZEN_TURTLE_MEAT = defautEffectConsumableComponent(effectList(MobEffects.RESISTANCE, 400, 0));
        public static final Consumable GODS_VOLUCITE_AERIAL_BERRY = godsVoluciteAerialBerry();
        public static final Consumable AZURITE_COPPER_PINE_CONE = defautEffectConsumableComponent(effectList(MobEffects.HASTE, 400, 0));
        public static final Consumable PHOENIX_FEATHER = defautEffectConsumableComponent(effectList(MobEffects.SLOW_FALLING, 1200, 0, MobEffects.FIRE_RESISTANCE, 1200, 0));
        ...
        public static final Consumable BLUE_SOLID_ETHER_FRAGMENT = defautEffectConsumableComponent(effectList(AerialHellMobEffects.HEAD_IN_THE_CLOUDS, 90, 0));
        public static final Consumable GOLDEN_SOLID_ETHER_FRAGMENT = defautEffectConsumableComponent(effectList(MobEffects.SLOW_FALLING, 110, 0));
        public static final Consumable GREEN_SOLID_ETHER_FRAGMENT = defautEffectConsumableComponent(effectList(MobEffects.JUMP_BOOST, 90, 1));
        public static final Consumable PURPLE_SOLID_ETHER_FRAGMENT = defautEffectConsumableComponent(effectList(AerialHellMobEffects.SHADOW_IMMUNITY, 90, 1));
        public static final Consumable GOLDEN_NETHER_MEAT_PIECE = defautEffectConsumableComponent(effectList(MobEffects.FIRE_RESISTANCE, 110, 0));
        public static final Consumable GOLDEN_NETHER_STEAK = defautEffectConsumableComponent(effectList(MobEffects.FIRE_RESISTANCE, 500, 0));
        public static final Consumable VIBRANT_GOLDEN_NETHER_STEAK = defautEffectConsumableComponent(effectList(MobEffects.FIRE_RESISTANCE, 1000, 0));
        ...
        private static Consumable defautEffectConsumableComponent(List<MobEffectInstance> effectList)
        {
