...
public class AerialHellBlocksAndItems
{
	...
	public static final RegistryObject<Block> BONE_SHADOW_CATACOMBS_BRICKS = BLOCKS.register("bone_shadow_catacombs_bricks", () -> new CoreProtectedBlock(AbstractBlock.Properties.from(SHADOW_CATACOMBS_BRICKS.get())));
	public static final RegistryObject<Block> SKULL_SHADOW_CATACOMBS_BRICKS = BLOCKS.register("skull_shadow_catacombs_bricks", () -> new CoreProtectedBlock(AbstractBlock.Properties.from(SHADOW_CATACOMBS_BRICKS.get())));
