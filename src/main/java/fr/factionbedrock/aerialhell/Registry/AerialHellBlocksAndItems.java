...
public class AerialHellBlocksAndItems
{
	...
	public static final RegistryObject<Item> SHADOW_CHAIN_ITEM = ITEMS.register("shadow_chain", () -> new BlockItem(SHADOW_CHAIN.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> MUD_BRICKS_ITEM = ITEMS.register("mud_bricks", () -> new BlockItem(MUD_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_MUD_BRICKS_ITEM = ITEMS.register("cracked_mud_bricks", () -> new BlockItem(CRACKED_MUD_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MOSSY_MUD_BRICKS_ITEM = ITEMS.register("mossy_mud_bricks", () -> new BlockItem(MOSSY_MUD_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CHISELED_MUD_BRICKS_ITEM = ITEMS.register("chiseled_mud_bricks", () -> new BlockItem(CHISELED_MUD_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LIGHT_MUD_BRICKS_ITEM = ITEMS.register("light_mud_bricks", () -> new BlockItem(LIGHT_MUD_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LIGHT_MUD_BRICKS_ITEM = ITEMS.register("cracked_light_mud_bricks", () -> new BlockItem(CRACKED_LIGHT_MUD_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LUNATIC_STONE_ITEM = ITEMS.register("lunatic_stone", () -> new BlockItem(LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> DARK_LUNATIC_STONE_ITEM = ITEMS.register("dark_lunatic_stone", () -> new BlockItem(DARK_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> ROOF_LUNATIC_STONE_ITEM = ITEMS.register("roof_lunatic_stone", () -> new BlockItem(ROOF_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LUNATIC_STONE_ITEM = ITEMS.register("cracked_lunatic_stone", () -> new BlockItem(CRACKED_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CHISELED_LUNATIC_STONE_ITEM = ITEMS.register("chiseled_lunatic_stone", () -> new BlockItem(CHISELED_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LIGHT_LUNATIC_STONE_ITEM = ITEMS.register("light_lunatic_stone", () -> new BlockItem(LIGHT_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> ROOF_LIGHT_LUNATIC_STONE_ITEM = ITEMS.register("roof_light_lunatic_stone", () -> new BlockItem(ROOF_LIGHT_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LIGHT_LUNATIC_STONE_ITEM = ITEMS.register("cracked_light_lunatic_stone", () -> new BlockItem(CRACKED_LIGHT_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> SHADOW_CATACOMBS_BRICKS_ITEM = ITEMS.register("shadow_catacombs_bricks", () -> new BlockItem(SHADOW_CATACOMBS_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_SHADOW_CATACOMBS_BRICKS_ITEM = ITEMS.register("cracked_shadow_catacombs_bricks", () -> new BlockItem(CRACKED_SHADOW_CATACOMBS_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MOSSY_SHADOW_CATACOMBS_BRICKS_ITEM = ITEMS.register("mossy_shadow_catacombs_bricks", () -> new BlockItem(MOSSY_SHADOW_CATACOMBS_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CHISELED_SHADOW_CATACOMBS_BRICKS_ITEM = ITEMS.register("chiseled_shadow_catacombs_bricks", () -> new BlockItem(CHISELED_SHADOW_CATACOMBS_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> BONE_SHADOW_CATACOMBS_BRICKS_ITEM = ITEMS.register("bone_shadow_catacombs_bricks", () -> new BlockItem(BONE_SHADOW_CATACOMBS_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> SKULL_SHADOW_CATACOMBS_BRICKS_ITEM = ITEMS.register("skull_shadow_catacombs_bricks", () -> new BlockItem(SKULL_SHADOW_CATACOMBS_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LIGHT_SHADOW_CATACOMBS_BRICKS_ITEM = ITEMS.register("light_shadow_catacombs_bricks", () -> new BlockItem(LIGHT_SHADOW_CATACOMBS_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LIGHT_SHADOW_CATACOMBS_BRICKS_ITEM = ITEMS.register("cracked_light_shadow_catacombs_bricks", () -> new BlockItem(CRACKED_LIGHT_SHADOW_CATACOMBS_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> GOLDEN_NETHER_BRICKS_ITEM = ITEMS.register("golden_nether_bricks", () -> new BlockItem(GOLDEN_NETHER_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_GOLDEN_NETHER_BRICKS_ITEM = ITEMS.register("cracked_golden_nether_bricks", () -> new BlockItem(CRACKED_GOLDEN_NETHER_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CHISELED_GOLDEN_NETHER_BRICKS_ITEM = ITEMS.register("chiseled_golden_nether_bricks", () -> new BlockItem(CHISELED_GOLDEN_NETHER_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LIGHT_GOLDEN_NETHER_BRICKS_ITEM = ITEMS.register("light_golden_nether_bricks", () -> new BlockItem(LIGHT_GOLDEN_NETHER_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LIGHT_GOLDEN_NETHER_BRICKS_ITEM = ITEMS.register("cracked_light_golden_nether_bricks", () -> new BlockItem(CRACKED_LIGHT_GOLDEN_NETHER_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LUNATIC_PILLAR_ITEM = ITEMS.register("lunatic_pillar", () -> new BlockItem(LUNATIC_PILLAR.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LUNATIC_PILLAR_TOP_ITEM = ITEMS.register("lunatic_pillar_top", () -> new BlockItem(LUNATIC_PILLAR_TOP.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> VOLUCITE_STONE_ITEM = ITEMS.register("volucite_stone", () -> new BlockItem(VOLUCITE_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_VOLUCITE_STONE_ITEM = ITEMS.register("cracked_volucite_stone", () -> new BlockItem(CRACKED_VOLUCITE_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CHISELED_VOLUCITE_STONE_ITEM = ITEMS.register("chiseled_volucite_stone", () -> new BlockItem(CHISELED_VOLUCITE_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LIGHT_VOLUCITE_STONE_ITEM = ITEMS.register("light_volucite_stone", () -> new BlockItem(LIGHT_VOLUCITE_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LIGHT_VOLUCITE_STONE_ITEM = ITEMS.register("cracked_light_volucite_stone", () -> new BlockItem(CRACKED_LIGHT_VOLUCITE_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> MUD_DUNGEON_CORE_ITEM = ITEMS.register("mud_dungeon_core", () -> new BlockItem(MUD_DUNGEON_CORE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LUNATIC_DUNGEON_CORE_ITEM = ITEMS.register("lunatic_dungeon_core", () -> new BlockItem(LUNATIC_DUNGEON_CORE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> SHADOW_CATACOMBS_DUNGEON_CORE_ITEM = ITEMS.register("shadow_catacombs_dungeon_core", () -> new BlockItem(SHADOW_CATACOMBS_DUNGEON_CORE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> GOLDEN_NETHER_DUNGEON_CORE_ITEM = ITEMS.register("golden_nether_dungeon_core", () -> new BlockItem(GOLDEN_NETHER_DUNGEON_CORE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> VOLUCITE_DUNGEON_CORE_ITEM = ITEMS.register("volucite_dungeon_core", () -> new BlockItem(VOLUCITE_DUNGEON_CORE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> MUD_BRICKS_SLAB_ITEM = ITEMS.register("mud_bricks_slab", () -> new BlockItem(MUD_BRICKS_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MUD_BRICKS_STAIRS_ITEM = ITEMS.register("mud_bricks_stairs", () -> new BlockItem(MUD_BRICKS_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MUD_BRICKS_WALL_ITEM = ITEMS.register("mud_bricks_wall", () -> new BlockItem(MUD_BRICKS_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_MUD_BRICKS_SLAB_ITEM = ITEMS.register("cracked_mud_bricks_slab", () -> new BlockItem(CRACKED_MUD_BRICKS_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_MUD_BRICKS_STAIRS_ITEM = ITEMS.register("cracked_mud_bricks_stairs", () -> new BlockItem(CRACKED_MUD_BRICKS_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_MUD_BRICKS_WALL_ITEM = ITEMS.register("cracked_mud_bricks_wall", () -> new BlockItem(CRACKED_MUD_BRICKS_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MOSSY_MUD_BRICKS_SLAB_ITEM = ITEMS.register("mossy_mud_bricks_slab", () -> new BlockItem(MOSSY_MUD_BRICKS_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MOSSY_MUD_BRICKS_STAIRS_ITEM = ITEMS.register("mossy_mud_bricks_stairs", () -> new BlockItem(MOSSY_MUD_BRICKS_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MOSSY_MUD_BRICKS_WALL_ITEM = ITEMS.register("mossy_mud_bricks_wall", () -> new BlockItem(MOSSY_MUD_BRICKS_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> VOLUCITE_STONE_SLAB_ITEM = ITEMS.register("volucite_stone_slab", () -> new BlockItem(VOLUCITE_STONE_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> VOLUCITE_STONE_STAIRS_ITEM = ITEMS.register("volucite_stone_stairs", () -> new BlockItem(VOLUCITE_STONE_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> VOLUCITE_STONE_WALL_ITEM = ITEMS.register("volucite_stone_wall", () -> new BlockItem(VOLUCITE_STONE_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_VOLUCITE_STONE_SLAB_ITEM = ITEMS.register("cracked_volucite_stone_slab", () -> new BlockItem(CRACKED_VOLUCITE_STONE_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_VOLUCITE_STONE_STAIRS_ITEM = ITEMS.register("cracked_volucite_stone_stairs", () -> new BlockItem(CRACKED_VOLUCITE_STONE_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_VOLUCITE_STONE_WALL_ITEM = ITEMS.register("cracked_volucite_stone_wall", () -> new BlockItem(CRACKED_VOLUCITE_STONE_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LUNATIC_STONE_SLAB_ITEM = ITEMS.register("lunatic_stone_slab", () -> new BlockItem(LUNATIC_STONE_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LUNATIC_STONE_STAIRS_ITEM = ITEMS.register("lunatic_stone_stairs", () -> new BlockItem(LUNATIC_STONE_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LUNATIC_STONE_WALL_ITEM = ITEMS.register("lunatic_stone_wall", () -> new BlockItem(LUNATIC_STONE_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> DARK_LUNATIC_STONE_SLAB_ITEM = ITEMS.register("dark_lunatic_stone_slab", () -> new BlockItem(DARK_LUNATIC_STONE_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> DARK_LUNATIC_STONE_STAIRS_ITEM = ITEMS.register("dark_lunatic_stone_stairs", () -> new BlockItem(DARK_LUNATIC_STONE_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> DARK_LUNATIC_STONE_WALL_ITEM = ITEMS.register("dark_lunatic_stone_wall", () -> new BlockItem(DARK_LUNATIC_STONE_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LUNATIC_STONE_SLAB_ITEM = ITEMS.register("cracked_lunatic_stone_slab", () -> new BlockItem(CRACKED_LUNATIC_STONE_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LUNATIC_STONE_STAIRS_ITEM = ITEMS.register("cracked_lunatic_stone_stairs", () -> new BlockItem(CRACKED_LUNATIC_STONE_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> CRACKED_LUNATIC_STONE_WALL_ITEM = ITEMS.register("cracked_lunatic_stone_wall", () -> new BlockItem(CRACKED_LUNATIC_STONE_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> SHADOW_CATACOMBS_BRICKS_SLAB_ITEM = ITEMS.register("shadow_catacombs_bricks_slab", () -> new BlockItem(SHADOW_CATACOMBS_BRICKS_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> SHADOW_CATACOMBS_BRICKS_STAIRS_ITEM = ITEMS.register("shadow_catacombs_bricks_stairs", () -> new BlockItem(SHADOW_CATACOMBS_BRICKS_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> SHADOW_CATACOMBS_BRICKS_WALL_ITEM = ITEMS.register("shadow_catacombs_bricks_wall", () -> new BlockItem(SHADOW_CATACOMBS_BRICKS_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> MOSSY_SHADOW_CATACOMBS_BRICKS_SLAB_ITEM = ITEMS.register("mossy_shadow_catacombs_bricks_slab", () -> new BlockItem(MOSSY_SHADOW_CATACOMBS_BRICKS_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MOSSY_SHADOW_CATACOMBS_BRICKS_STAIRS_ITEM = ITEMS.register("mossy_shadow_catacombs_bricks_stairs", () -> new BlockItem(MOSSY_SHADOW_CATACOMBS_BRICKS_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> MOSSY_SHADOW_CATACOMBS_BRICKS_WALL_ITEM = ITEMS.register("mossy_shadow_catacombs_bricks_wall", () -> new BlockItem(MOSSY_SHADOW_CATACOMBS_BRICKS_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> TRAPPED_MUD_BRICKS_ITEM = ITEMS.register("trapped_mud_bricks", () -> new BlockItem(TRAPPED_MUD_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> TRAPPED_LIGHT_MUD_BRICKS_ITEM = ITEMS.register("trapped_light_mud_bricks", () -> new BlockItem(TRAPPED_LIGHT_MUD_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> TRAPPED_LUNATIC_STONE_ITEM = ITEMS.register("trapped_lunatic_stone", () -> new BlockItem(TRAPPED_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> TRAPPED_LIGHT_LUNATIC_STONE_ITEM = ITEMS.register("trapped_light_lunatic_stone", () -> new BlockItem(TRAPPED_LIGHT_LUNATIC_STONE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> TRAPPED_GOLDEN_NETHER_BRICKS_ITEM = ITEMS.register("trapped_golden_nether_bricks", () -> new BlockItem(TRAPPED_GOLDEN_NETHER_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> TRAPPED_LIGHT_GOLDEN_NETHER_BRICKS_ITEM = ITEMS.register("trapped_light_golden_nether_bricks", () -> new BlockItem(TRAPPED_LIGHT_GOLDEN_NETHER_BRICKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> AERIAL_NETHERRACK_ITEM = ITEMS.register("aerial_netherrack", () -> new BlockItem(AERIAL_NETHERRACK.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> AERIAL_NETHERRACK_SLAB_ITEM = ITEMS.register("aerial_netherrack_slab", () -> new BlockItem(AERIAL_NETHERRACK_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> AERIAL_NETHERRACK_STAIRS_ITEM = ITEMS.register("aerial_netherrack_stairs", () -> new BlockItem(AERIAL_NETHERRACK_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> AERIAL_NETHERRACK_WALL_ITEM = ITEMS.register("aerial_netherrack_wall", () -> new BlockItem(AERIAL_NETHERRACK_WALL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> MUD_BOOKSHELF_ITEM = ITEMS.register("mud_bookshelf", () -> new BlockItem(MUD_BOOKSHELF.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> LUNATIC_BOOKSHELF_ITEM = ITEMS.register("lunatic_bookshelf", () -> new BlockItem(LUNATIC_BOOKSHELF.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> GOLDEN_NETHER_BOOKSHELF_ITEM = ITEMS.register("golden_nether_bookshelf", () -> new BlockItem(GOLDEN_NETHER_BOOKSHELF.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> SHADOW_CATACOMBS_BOOKSHELF_ITEM = ITEMS.register("shadow_catacombs_bookshelf", () -> new BlockItem(SHADOW_CATACOMBS_BOOKSHELF.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	public static final RegistryObject<Item> VOLUCITE_BOOKSHELF_ITEM = ITEMS.register("volucite_bookshelf", () -> new BlockItem(VOLUCITE_BOOKSHELF.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS)));
	...
	public static final RegistryObject<Item> MUD_CHEST_ITEM = ITEMS.register("mud_chest", () -> new BlockItem(MUD_CHEST.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS).setISTER(() -> AerialHellChestItemTileEntityRenderer::new)));
	...
	public static final RegistryObject<Item> LUNATIC_CHEST_ITEM = ITEMS.register("lunatic_chest", () -> new BlockItem(LUNATIC_CHEST.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS).setISTER(() -> AerialHellChestItemTileEntityRenderer::new)));
	...
	public static final RegistryObject<Item> VOLUCITE_CHEST_ITEM = ITEMS.register("volucite_chest", () -> new BlockItem(VOLUCITE_CHEST.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS).setISTER(() -> AerialHellChestItemTileEntityRenderer::new)));
	...
	public static final RegistryObject<Item> SHADOW_CATACOMBS_CHEST_ITEM = ITEMS.register("shadow_catacombs_chest", () -> new BlockItem(SHADOW_CATACOMBS_CHEST.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS).setISTER(() -> AerialHellChestItemTileEntityRenderer::new)));
	...
	public static final RegistryObject<Item> GOLDEN_NETHER_CHEST_ITEM = ITEMS.register("golden_nether_chest", () -> new BlockItem(GOLDEN_NETHER_CHEST.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_BLOCKS).setISTER(() -> AerialHellChestItemTileEntityRenderer::new)));
    ...
    public static final RegistryObject<SwordItem> CURSED_SWORD = ITEMS.register("cursed_sword", () -> new AerialHellSwordItem(ToolMaterials.cursed, 5, -2.5F, 0.0F, 0.0F, (new Item.Properties()).setNoRepair().rarity(AerialHellRarities.CORRUPTED).group(AerialHellItemGroups.AERIAL_HELL_COMBAT)));
