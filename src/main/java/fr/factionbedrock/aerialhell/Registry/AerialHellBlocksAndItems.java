...
import fr.factionbedrock.aerialhell.Item.OreBerryItem;
...
import fr.factionbedrock.aerialhell.Item.AercloudFragmentItem;
...
public class AerialHellBlocksAndItems
{
	...
	public static final RegistryObject<Block> LAPIS_ROBINIA_BOOKSHELF = BLOCKS.register("lapis_robinia_bookshelf", () -> new Block(AbstractBlock.Properties.from(LAPIS_ROBINIA_PLANKS.get())));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_LOG_ITEM = ITEMS.register("lapis_robinia_log", () -> new BlockItem(LAPIS_ROBINIA_LOG.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	public static final RegistryObject<Item> STRIPPED_LAPIS_ROBINIA_LOG_ITEM = ITEMS.register("stripped_lapis_robinia_log", () -> new BlockItem(STRIPPED_LAPIS_ROBINIA_LOG.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_PLANKS_ITEM = ITEMS.register("lapis_robinia_planks", () -> new BlockItem(LAPIS_ROBINIA_PLANKS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Block> STELLAR_COARSE_DIRT = BLOCKS.register("stellar_coarse_dirt", () -> new Block(AbstractBlock.Properties.from(Blocks.COARSE_DIRT)));
	...
	public static final RegistryObject<Block> SLIPPERY_SAND_GLASS = BLOCKS.register("slippery_sand_glass", () -> new GlassBlock(AbstractBlock.Properties.from(Blocks.GLASS).slipperiness(1.04F).setLightLevel((state) -> 11).setAllowsSpawn((state, reader, pos, entity) -> false).setOpaque((state, reader, pos) -> false).setSuffocates((state, reader, pos) -> false).setBlocksVision((state, reader, pos) -> false)));
	...
	public static final RegistryObject<Item> OBSIDIAN_ORE_ITEM = ITEMS.register("obsidian_ore", () -> new BlockItem(OBSIDIAN_ORE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_FENCE_ITEM = ITEMS.register("lapis_robinia_fence", () -> new BlockItem(LAPIS_ROBINIA_FENCE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_GATE_ITEM = ITEMS.register("lapis_robinia_gate", () -> new BlockItem(LAPIS_ROBINIA_GATE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<DoorBlock> LAPIS_ROBINIA_DOOR = BLOCKS.register("lapis_robinia_door", () -> new DoorBlock(AERIAL_TREE_MATERIAL));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_BUTTON_ITEM = ITEMS.register("lapis_robinia_button", () -> new BlockItem(LAPIS_ROBINIA_BUTTON.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_PRESSURE_PLATE_ITEM = ITEMS.register("lapis_robinia_pressure_plate", () -> new BlockItem(LAPIS_ROBINIA_PRESSURE_PLATE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_SLAB_ITEM = ITEMS.register("lapis_robinia_slab", () -> new BlockItem(LAPIS_ROBINIA_SLAB.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_STAIRS_ITEM = ITEMS.register("lapis_robinia_stairs", () -> new BlockItem(LAPIS_ROBINIA_STAIRS.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_SIGN_ITEM = ITEMS.register("lapis_robinia_sign", () -> new BlockItem(LAPIS_ROBINIA_SIGN.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_CRAFTING_TABLE_ITEM = ITEMS.register("lapis_robinia_crafting_table", () -> new BlockItem(LAPIS_ROBINIA_CRAFTING_TABLE.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_BARREL_ITEM = ITEMS.register("lapis_robinia_barrel", () -> new BlockItem(LAPIS_ROBINIA_BARREL.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> LAPIS_ROBINIA_COMPOSTER_ITEM = ITEMS.register("lapis_robinia_composter", () -> new BlockItem(LAPIS_ROBINIA_COMPOSTER.get(), new Item.Properties().group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
	...
	public static final RegistryObject<Item> RUBY_AERIAL_BERRY = ITEMS.register("ruby_aerial_berry", () -> new OreBerryItem(AerialHellItemGroups.AERIAL_HELL_DIMENSION, Rarity.RARE, new EffectInstance(Effects.HEALTH_BOOST, 2400, 0)));
	public static final RegistryObject<Item> VOLUCITE_AERIAL_BERRY = ITEMS.register("volucite_aerial_berry", () -> new OreBerryItem(AerialHellItemGroups.AERIAL_HELL_DIMENSION, AerialHellRarities.VIBRANT, new EffectInstance(Effects.SLOW_FALLING, 2400, 2)));
	...
	public static final RegistryObject<Item> BLUE_SOLID_ETHER_FRAGMENT = ITEMS.register("blue_solid_ether_fragment", () -> new AercloudFragmentItem(AerialHellItemGroups.AERIAL_HELL_DIMENSION, () -> new EffectInstance(AerialHellPotionEffects.HEAD_IN_THE_CLOUDS.get(), 90, 0)));
	public static final RegistryObject<Item> GOLDEN_SOLID_ETHER_FRAGMENT = ITEMS.register("golden_solid_ether_fragment", () -> new AercloudFragmentItem(AerialHellItemGroups.AERIAL_HELL_DIMENSION, () -> new EffectInstance(Effects.SLOW_FALLING, 110, 0)));
	public static final RegistryObject<Item> GREEN_SOLID_ETHER_FRAGMENT = ITEMS.register("green_solid_ether_fragment", () -> new AercloudFragmentItem(AerialHellItemGroups.AERIAL_HELL_DIMENSION, () -> new EffectInstance(AerialHellPotionEffects.HEAD_IN_THE_CLOUDS.get(), 90, 0)));
	public static final RegistryObject<Item> GOLDEN_NETHER_MEAT_PIECE = ITEMS.register("golden_nether_meat_piece", () -> new GoldenNetherMeatItem(1,0.1F,110,AerialHellItemGroups.AERIAL_HELL_DIMENSION, AerialHellRarities.VIBRANT));
	public static final RegistryObject<Item> GOLDEN_NETHER_STEAK = ITEMS.register("golden_nether_steak", () -> new GoldenNetherMeatItem(4,0.4F,500,AerialHellItemGroups.AERIAL_HELL_DIMENSION, AerialHellRarities.VIBRANT));
	public static final RegistryObject<Item> VIBRANT_GOLDEN_NETHER_STEAK = ITEMS.register("vibrant_golden_nether_steak", () -> new GoldenNetherMeatItem(6,0.8F,1000,AerialHellItemGroups.AERIAL_HELL_DIMENSION, AerialHellRarities.VIBRANT));
    ...
    public static final RegistryObject<PickaxeItem> OBSIDIAN_PICKAXE = ITEMS.register("obsidian_pickaxe", () -> new PickaxeItem(ToolMaterials.obsidian, 1, -2.8F, (new Item.Properties()).addToolType(ToolType.PICKAXE, ToolMaterials.obsidian.getHarvestLevel()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    ...
    public static final RegistryObject<ShovelItem> OBSIDIAN_SHOVEL = ITEMS.register("obsidian_shovel", () -> new ShovelItem(ToolMaterials.obsidian, 1.5F, -3F, (new Item.Properties()).addToolType(ToolType.SHOVEL, ToolMaterials.obsidian.getHarvestLevel()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    ...
    public static final RegistryObject<AxeItem> OBSIDIAN_AXE = ITEMS.register("obsidian_axe", () -> new AxeItem(ToolMaterials.obsidian, 6, -3.1F, (new Item.Properties()).addToolType(ToolType.AXE, ToolMaterials.obsidian.getHarvestLevel()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    ...
    public static final RegistryObject<HoeItem> OBSIDIAN_HOE = ITEMS.register("obsidian_hoe", () -> new HoeItem(ToolMaterials.obsidian, -3, 0.0F, (new Item.Properties()).addToolType(ToolType.HOE, ToolMaterials.obsidian.getHarvestLevel()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    ...
    public static final RegistryObject<SwordItem> OBSIDIAN_SWORD = ITEMS.register("obsidian_sword", () -> new SwordItem(ToolMaterials.obsidian, 3, -2.4F, (new Item.Properties()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    ...
    public static final RegistryObject<SwordItem> ARSONIST_SWORD = ITEMS.register("arsonist_sword", () -> new SwordItem(ToolMaterials.arsonist, 3, -2.4F, (new Item.Properties()).rarity(AerialHellRarities.LEGENDARY).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION).isImmuneToFire()));
    ...
    public static final RegistryObject<ArmorItem> OBSIDIAN_HELMET = ITEMS.register("obsidian_helmet", () -> new ArmorItem(ArmorMaterials.obsidian, EquipmentSlotType.HEAD, (new Item.Properties()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    public static final RegistryObject<ArmorItem> OBSIDIAN_CHESTPLATE = ITEMS.register("obsidian_chestplate", () -> new ArmorItem(ArmorMaterials.obsidian, EquipmentSlotType.CHEST, (new Item.Properties()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    public static final RegistryObject<ArmorItem> OBSIDIAN_LEGGINGS = ITEMS.register("obsidian_leggings", () -> new ArmorItem(ArmorMaterials.obsidian, EquipmentSlotType.LEGS, (new Item.Properties()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    public static final RegistryObject<ArmorItem> OBSIDIAN_BOOTS = ITEMS.register("obsidian_boots", () -> new ArmorItem(ArmorMaterials.obsidian, EquipmentSlotType.FEET, (new Item.Properties()).rarity(Rarity.RARE).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION)));
    ...
    public static final RegistryObject<ArmorItem> ARSONIST_HELMET = ITEMS.register("arsonist_helmet", () -> new ArmorItem(ArmorMaterials.arsonist, EquipmentSlotType.HEAD, (new Item.Properties()).rarity(AerialHellRarities.LEGENDARY).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION).isImmuneToFire()));
    public static final RegistryObject<ArmorItem> ARSONIST_CHESTPLATE = ITEMS.register("arsonist_chestplate", () -> new ArmorItem(ArmorMaterials.arsonist, EquipmentSlotType.CHEST, (new Item.Properties()).rarity(AerialHellRarities.LEGENDARY).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION).isImmuneToFire()));
    public static final RegistryObject<ArmorItem> ARSONIST_LEGGINGS = ITEMS.register("arsonist_leggings", () -> new ArmorItem(ArmorMaterials.arsonist, EquipmentSlotType.LEGS, (new Item.Properties()).rarity(AerialHellRarities.LEGENDARY).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION).isImmuneToFire()));
    public static final RegistryObject<ArmorItem> ARSONIST_BOOTS = ITEMS.register("arsonist_boots", () -> new ArmorItem(ArmorMaterials.arsonist, EquipmentSlotType.FEET, (new Item.Properties()).rarity(AerialHellRarities.LEGENDARY).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION).isImmuneToFire()));
    ...
    public static final RegistryObject<Item> GOD_TOTEM = ITEMS.register("god_totem", () -> new EffectTotemItem(new Item.Properties().maxStackSize(1).rarity(AerialHellRarities.MYTHICAL).group(AerialHellItemGroups.AERIAL_HELL_DIMENSION).isImmuneToFire()));
