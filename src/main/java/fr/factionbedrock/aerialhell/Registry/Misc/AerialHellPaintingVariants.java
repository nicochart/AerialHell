...
public class AerialHellPaintingVariants
{
    ...
    public static final RegistryObject<PaintingVariant> MUD_CYCLE_MAGE = PAINTING_TYPES.register("mud_cycle_mage", () -> new PaintingVariant(32, 32));
    ...
    public static final RegistryObject<PaintingVariant> CHAINED_GOD = PAINTING_TYPES.register("chained_god", () -> new PaintingVariant(64, 64));
    public static final RegistryObject<PaintingVariant> LILITH = PAINTING_TYPES.register("lilith", () -> new PaintingVariant(64, 64));
    ...
    public static List<Holder<PaintingVariant>> getAerialHellPaintingVariantList()
    {
        ...
        list.add(AerialHellPaintingVariants.MUD_CYCLE_MAGE.getHolder().get());
        ...
        list.add(AerialHellPaintingVariants.CHAINED_GOD.getHolder().get());
        list.add(AerialHellPaintingVariants.LILITH.getHolder().get());
        return list;
    }
}
