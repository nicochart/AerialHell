...
public class StellarGrassItemTint implements ItemTintSource
{
    ...
    @Override public int calculate(ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity user) {return ColorHandlerHelper.AERIAL_HELL_PLAINS_GRASS_COLOR;}
