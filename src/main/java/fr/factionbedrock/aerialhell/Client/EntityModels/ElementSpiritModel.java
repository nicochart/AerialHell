...
public class ElementSpiritModel<T extends AbstractElementSpiritEntity> extends EntityModel<T>
{
	...
	public static TexturedModelData createBodyLayer()
	{
		...
		ModelPartData head = partdefinition.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-5.0F, -10.0F, -5.0F, 10.0F, 10.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 6.0F, 0.0F));

		ModelPartData headShard = partdefinition.addChild("headShard", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 6.0F, 0.0F));
		...
		ModelPartData body = partdefinition.addChild("body", ModelPartBuilder.create().uv(0, 20).cuboid(-4.0F, -17.0F, -2.0F, 8.0F, 12.0F, 4.0F, new Dilation(1.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

		ModelPartData leftArm = partdefinition.addChild("leftArm", ModelPartBuilder.create().uv(24, 20).cuboid(0.0F, 0.0F, -3.0F, 3.0F, 5.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(5.0F, 6.0F, 0.0F));

		ModelPartData rightArm = partdefinition.addChild("rightArm", ModelPartBuilder.create().uv(24, 20).mirrored().cuboid(-3.0F, 0.0F, -3.0F, 3.0F, 5.0F, 6.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-5.0F, 6.0F, 0.0F));

		ModelPartData leftLeg = partdefinition.addChild("leftLeg", ModelPartBuilder.create().uv(0, 36).mirrored().cuboid(-2.0F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-2.0F, 17.0F, 0.0F));

		ModelPartData rightLeg = partdefinition.addChild("rightLeg", ModelPartBuilder.create().uv(0, 36).cuboid(-2.0F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(2.0F, 17.0F, 0.0F));
