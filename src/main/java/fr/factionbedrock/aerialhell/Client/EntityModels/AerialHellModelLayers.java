...
public class AerialHellModelLayers
{
    ...
    public static final ModelLayerLocation VOLUCITE_WARDEN_ARM_SEGMENT = createModelLayerLocation("volucite_warden_arm_segment");
    ...
    public static final ModelLayerLocation RESONATOR_SHARD = createModelLayerLocation("resonator_shard");
