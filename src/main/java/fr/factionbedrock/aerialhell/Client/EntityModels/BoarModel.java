...
public class BoarModel<S extends LivingEntityRenderState> extends EntityModel<S>
{
	...
	public static TexturedModelData createBodyLayer()
	{
		...
		ModelPartData body = partdefinition.addChild("body", ModelPartBuilder.create().uv(0, 40).cuboid(-5.0F, -1.0F, -9.0F, 10.0F, 8.0F, 16.0F, new Dilation(0.0F))
				...
				.uv(42, 28).cuboid(5.0F, 1.0F, 1.0F, 1.0F, 6.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 11.0F, 2.0F));
		...
		ModelPartData head = partdefinition.addChild("head", ModelPartBuilder.create().uv(0, 9).cuboid(-4.0F, -3.0F, -7.0F, 8.0F, 7.0F, 7.0F, new Dilation(0.0F))
				.uv(30, 15).cuboid(-2.0F, 0.0F, -11.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 12.0F, -5.0F));
		...
		ModelPartData tusk = partdefinition.addChild("tusk", ModelPartBuilder.create().uv(50, 7).cuboid(3.0F, 1.0F, -10.0F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F))
				.uv(50, 11).cuboid(2.0F, 3.0F, -10.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 12.0F, -5.0F));
		...
		ModelPartData backLeftLeg = partdefinition.addChild("backLeftLeg", ModelPartBuilder.create().uv(18, 28).cuboid(-2.0F, 0.0F, -3.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(3.0F, 18.0F, 7.0F));

		ModelPartData backRightLeg = partdefinition.addChild("backRightLeg", ModelPartBuilder.create().uv(18, 28).cuboid(-2.0F, 0.0F, -3.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-3.0F, 18.0F, 7.0F));

		ModelPartData frontLeftLeg = partdefinition.addChild("frontLeftLeg", ModelPartBuilder.create().uv(0, 28).cuboid(-2.0F, 0.0F, -1.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(3.0F, 18.0F, -5.0F));

		ModelPartData frontRightLeg = partdefinition.addChild("frontRightLeg", ModelPartBuilder.create().uv(0, 28).cuboid(-2.0F, 0.0F, -1.0F, 4.0F, 6.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-3.0F, 18.0F, -5.0F));
