...
public class VerdigrisZombieModel extends EntityModel<VerdigrisZombieRenderState>//HumanoidModel<VerdigrisZombieEntity>
{
	...
	public static TexturedModelData createBodyLayer()
	{
		...
		ModelPartData leftLeg = partdefinition.addChild("leftLeg", ModelPartBuilder.create().uv(0, 48).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-1.9F, 12.0F, 0.0F));

		ModelPartData rightLeg = partdefinition.addChild("rightLeg", ModelPartBuilder.create().uv(0, 48).mirrored().cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.origin(1.9F, 12.0F, 0.0F));
	...
	@Override public void setAngles(VerdigrisZombieRenderState renderState)
	{
		...
		ArmPosing.zombieArms(this.leftArm, this.rightArm, renderState.isAggressive, renderState.attackTime, renderState.age);
