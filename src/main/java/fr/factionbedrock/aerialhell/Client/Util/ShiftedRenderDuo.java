...
public class ShiftedRenderDuo
{
    ...
    protected ShiftedRenderDuo(Block baseBlock, BlockState shiftedBlockState, ChunkRenderTypeSet renderType, ModelEvent.ModifyBakingResult event)
    {
        ...
        this.newBakedModel = new ShiftingBlockBakedModel(event.getModels().get(baseModelRL), shiftedModel, (forceShifted) -> BlocksAndItemsColorHandler.isShadowBindEnabled() || forceShifted, renderType);
    }
