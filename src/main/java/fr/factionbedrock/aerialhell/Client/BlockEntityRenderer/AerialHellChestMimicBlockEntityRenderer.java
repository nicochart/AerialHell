...
public class AerialHellChestMimicBlockEntityRenderer implements BlockEntityRenderer<ChestMimicBlockEntity>
{
	...
	@Override
	public void render(ChestMimicBlockEntity blockEntity, float partialTicks, PoseStack poseStackIn, MultiBufferSource buffer, int combinedLightIn, int combinedOverlay)
	{
		...
		if (block instanceof AbstractChestBlock)
		{
			...
			if (flagDoubleChest)
			{
				...
				{
					this.render(poseStackIn, vertexconsumer, this.doubleLeftLid, this.doubleLeftLock, this.doubleLeftBottom, combinedLight, combinedOverlay);
				}
				else
				{
					this.render(poseStackIn, vertexconsumer, this.doubleRightLid, this.doubleRightLock, this.doubleRightBottom, combinedLight, combinedOverlay);
				}
			}
			else
			{
				this.render(poseStackIn, vertexconsumer, this.lid, this.lock, this.bottom, combinedLight, combinedOverlay);
			}
			poseStackIn.popPose();
		}
	}

	private void render(PoseStack poseStackIn, VertexConsumer vertexconsumer, ModelPart chestLid, ModelPart chestLatch, ModelPart chestBottom, int combinedLightIn, int combinedOverlayIn)
	{
