...
{
	public static final ResourceLocation FREEZER_GUI_TEXTURES =  AerialHell.id("textures/gui/container/freezer.png");
	public static final ResourceLocation LIT_PROGRESS_SPRITE =  AerialHell.id("container/freezer/freezing_progress");
	public static final ResourceLocation FREEZING_PROGRESS_SPRITE =  AerialHell.id("container/freezer/progress");
