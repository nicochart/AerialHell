...
{
    private static final StationInfo FREEZING_STATION_INFO = new StationInfo(new TextureInfo(ResourceLocation.fromNamespaceAndPath(AerialHell.MODID, "textures/block/freezer_side_on.png"), 0.0F, 0.0F, 16, 16, 16,48), "block.aerialhell.freezer");
    ...
    {
        super(lineIndex, alignment, scale, () -> ingredient.get().getDefaultInstance(), () -> result.get().getDefaultInstance(), () -> AerialHellBlocksAndItems.MAGMATIC_GEL.get().getDefaultInstance(), FREEZING_STATION_INFO, displayTooltip);
    }
}
