...
{
    private static final ResourceLocation REACTOR_BACKGROUND = new ResourceLocation(AerialHell.MODID, "textures/gui/container/reactor.png");
    private static final ResourceLocation LIGHT_PROGRESS = new ResourceLocation(AerialHell.MODID, "textures/gui/sprites/container/reactor/light_progress.png");
    private static final ResourceLocation SHADOW_PROGRESS = new ResourceLocation(AerialHell.MODID, "textures/gui/sprites/container/reactor/shadow_progress.png");
