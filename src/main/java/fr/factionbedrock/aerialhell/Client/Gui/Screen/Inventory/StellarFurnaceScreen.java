...
{
	private static final Identifier STELLAR_FURNACE_GUI_TEXTURES = Identifier.fromNamespaceAndPath(AerialHell.MODID, "textures/gui/container/stellar_furnace.png");
	private static final Identifier LIT_PROGRESS_SPRITE = Identifier.parse("container/furnace/lit_progress");
	private static final Identifier BURN_PROGRESS_SPRITE = Identifier.parse("container/furnace/burn_progress");
