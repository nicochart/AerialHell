...
public class Page
{
    ...
    public void render(Font font, GuiGraphics graphics, float scale, List<Line> lines, int bookLeft, int bookTop, int mouseX, int mouseY)
    {
        graphics.blit(this.backgroundTexture.texture(), bookLeft, bookTop, this.backgroundTexture.u(), this.backgroundTexture.v(), this.backgroundTexture.width(), this.backgroundTexture.height(), this.backgroundTexture.textureWidth(), this.backgroundTexture.textureHeight());
