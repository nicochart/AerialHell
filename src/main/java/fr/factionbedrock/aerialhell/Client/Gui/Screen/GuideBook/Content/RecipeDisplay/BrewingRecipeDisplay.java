...
{
    private static final StationInfo BREWING_STAND_INFO = new StationInfo(new TextureInfo(ResourceLocation.withDefaultNamespace("textures/item/brewing_stand.png"), 16,16), "block.minecraft.brewing_stand");
