...
{
    private static final StationInfo CRAFTING_TABLE_STATION_INFO = new StationInfo(new TextureInfo(ResourceLocation.fromNamespaceAndPath(AerialHell.MODID, "textures/block/aerial_tree_crafting_table_top.png"), 16,16), "block.aerialhell.aerial_tree_crafting_table");
