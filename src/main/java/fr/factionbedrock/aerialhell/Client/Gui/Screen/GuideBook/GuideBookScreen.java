...
public class GuideBookScreen extends Screen
{
    ...
    private static final List<Page> ALL_PAGES = List.of(
            ...
            new Page("materials_1", BOOK_TEXTURE, 14)
                    ...
                    .addItemTexture(13, Alignment.CENTER, 1.0F, AerialHellItems.LUNATIC_CRYSTAL, true)
                    .addItemTexture(13, Alignment.RIGHT, 1.0F, AerialHellItems.ARSONIST_INGOT, true)
                    .addParagraph(18, MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "fluorite_material")
                    .addItemTexture(18, Alignment.RIGHT, true, 1.0F, AerialHellItems.FLUORITE, true)
                    .addParagraph(20, MAX_LINES_PER_TECHNICAL_PAGE - 1, (int)(LINE_WIDTH_NO_MARGIN * 0.2F), (int)(LINE_WIDTH_NO_MARGIN * 0.8F), Alignment.LEFT, "fluorite_description")
                    .addItemTexture(20, Alignment.LEFT, true, 1.0F, AerialHellItems.FLUORITE_ORE, false)
                    .addItemTexture(22, Alignment.LEFT, true, 1.0F, AerialHellItems.OSCILLATOR, false)
                    .addItemTexture(24, Alignment.LEFT, true, 1.0F, AerialHellItems.AERIAL_TREE_CRAFTING_TABLE, false)
                    .addItemTexture(26, Alignment.LEFT, 1.0F, AerialHellItems.FLUORITE_TORCH, true)
                    .addItemTexture(26, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.STELLAR_LIGHTER, true)
                    .addItemTexture(26, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.RUBY_FLUORITE_LANTERN, true)
                    .addItemTexture(26, Alignment.RIGHT, 1.0F, AerialHellItems.FLUORITE_BLOCK, true)
                    .addItemTexture(28, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 4 - 8, 1.0F, AerialHellItems.OSCILLATOR, true)
                    .addItemTexture(28, Alignment.RIGHT, -LINE_WIDTH_NO_MARGIN / 4 + 8, 1.0F, AerialHellItems.WEAK_LIGHT_REACTOR, true),
            new Page("materials_2", BOOK_TEXTURE, 15)
                    .addParagraph(1, MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "ruby_material")
                    .addItemTexture(1, Alignment.RIGHT, true, 1.0F, AerialHellItems.RUBY, true)
                    .addParagraph(3, MAX_LINES_PER_TECHNICAL_PAGE - 1, (int)(LINE_WIDTH_NO_MARGIN * 0.2F), (int)(LINE_WIDTH_NO_MARGIN * 0.8F), Alignment.LEFT, "ruby_description")
                    .addItemTexture(3, Alignment.LEFT, true, 1.0F, AerialHellItems.RUBY_ORE, false)
                    .addItemTexture(5, Alignment.LEFT, true, 1.0F, AerialHellItems.AERIAL_TREE_CHEST, false)
                    .addItemTexture(7, Alignment.LEFT, true, 1.0F, AerialHellItems.OSCILLATOR, false)
                    .addItemTexture(9, Alignment.LEFT, true, 1.0F, AerialHellItems.COPPER_PINE_CRAFTING_TABLE, false)
                    .addItemTexture(11, Alignment.LEFT, 1.0F, AerialHellItems.RUBY_CHESTPLATE, true)
                    .addItemTexture(11, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.RUBY_SWORD, true)
                    .addItemTexture(11, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.RUBY_FLUORITE_LANTERN, true)
                    .addItemTexture(11, Alignment.RIGHT, 1.0F, AerialHellItems.RUBY_BLOCK, true)
                    .addItemTexture(13, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 4 - 8, 1.0F, AerialHellItems.RUBY_BLOWPIPE, true)
                    .addItemTexture(13, Alignment.RIGHT, -LINE_WIDTH_NO_MARGIN / 4 + 8, 1.0F, AerialHellItems.RUBY_BLOWPIPE_ARROW, true)
                    .addItemTexture(15, Alignment.LEFT, 1.0F, AerialHellItems.RUBY_BUCKET, true)
                    .addItemTexture(15, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.RUBY_BARS, true)
                    .addItemTexture(15, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.STELLAR_LIGHTER, true)
                    .addItemTexture(15, Alignment.RIGHT, 1.0F, AerialHellItems.RUBY_FLUORITE_LANTERN, true),
