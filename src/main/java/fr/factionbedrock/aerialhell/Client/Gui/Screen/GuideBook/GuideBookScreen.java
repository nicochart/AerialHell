...
public class GuideBookScreen extends Screen
{
    ...
    private static final List<Page> ALL_PAGES = List.of(
            ...
            new Page("journey_2", PAGE_TEXTURE, 2)
                    ...
                    .addItemTexture(9, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 4 - 8, 1.0F, AerialHellItems.GLOWING_STICK_FRUIT, true)
                    .addItemTexture(9, Alignment.CENTER, 1.0F, AerialHellItems.AERIAL_BERRY, true)
                    .addItemTexture(9, Alignment.RIGHT, -LINE_WIDTH_NO_MARGIN / 4 + 8, 1.0F, AerialHellItems.SKY_CACTUS_FIBER, true)
            ...
            new Page("journey_3", PAGE_TEXTURE, 3)
                    ...
                    .addItemTexture(30, Alignment.LEFT, 8, 0.8F, AerialHellItems.MAGMATIC_GEL_CHESTPLATE, true)
                    .addItemTexture(31, Alignment.LEFT, 16, 0.8F, AerialHellItems.RUBY_LEGGINGS, true)
                    .addItemTexture(32, Alignment.LEFT, 24, 0.8F, AerialHellItems.RUBY_BOOTS, true)
                    .addItemTexture(29, Alignment.CENTER, -10, 0.85F, AerialHellItems.RUBY_PICKAXE, true)
                    .addItemTexture(30, Alignment.CENTER, 10, 0.85F, AerialHellItems.AZURITE_AXE, true)
                    .addItemTexture(31, Alignment.CENTER, -12, 0.85F, AerialHellItems.RUBY_SWORD, true)
                    .addItemTexture(32, Alignment.CENTER, 12, 0.85F, AerialHellItems.MAGMATIC_GEL_SWORD, true)
                    .addItemTexture(29, Alignment.RIGHT, 0.8F, AerialHellItems.AZURITE_HELMET, true)
                    .addItemTexture(30, Alignment.RIGHT, -8, 0.8F, AerialHellItems.AZURITE_CHESTPLATE, true)
                    .addItemTexture(31, Alignment.RIGHT, -16, 0.8F, AerialHellItems.MAGMATIC_GEL_LEGGINGS, true)
                    .addItemTexture(32, Alignment.RIGHT, -24, 0.8F, AerialHellItems.AZURITE_BOOTS, true),
            new Page("journey_4", PAGE_TEXTURE, 4)
                    ...
                    .addTextureDisplay(12, Alignment.LEFT, 1.6F, "gui/guide_book/content/entities/gliding_turtle", 32, 28, "entity.aerialhell.gliding_turtle")
                    .addItemTexture(13, Alignment.CENTER, 10, 1.0F, AerialHellItems.AERIAL_BERRY, true)
            ...
            new Page("journey_5", PAGE_TEXTURE, 5)
                    ...
                    .addTextureDisplay(11, Alignment.LEFT, 1.6F, "gui/guide_book/content/entities/evil_cow", 30, 30, "entity.aerialhell.evil_cow")
            ...
            new Page("crafting_3", PAGE_TEXTURE, 11)
                    ...
                    .addItemTexture(14, Alignment.LEFT, 1.0F, AerialHellItems.FLUORITE, true)
                    .addItemTexture(14, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.FLUORITE_BLOCK, true)
                    .addItemTexture(14, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.CRYSTAL, true)
            ...
            new Page("crafting_4", PAGE_TEXTURE, 12)
                    ...
                    .addItemTexture(26, Alignment.CENTER, -25, 1.0F, AerialHellItems.MAGMATIC_GEL, true)
                    .addItemTexture(26, Alignment.CENTER, 25, 1.0F, AerialHellItems.MAGMATIC_GEL_BLOCK, true)
            ...
            new Page("materials_1", PAGE_TEXTURE, 14)
                    ...
                    .addItemTexture(23, Alignment.LEFT, true, 0.6F, AerialHellItems.STELLAR_COBBLESTONE, true)
                    .addItemTexture(24, Alignment.LEFT, true, 0.6F, AerialHellItems.RUBY, true)
                    .addItemTexture(25, Alignment.LEFT, true, 0.6F, AerialHellItems.MAGMATIC_GEL, true)
                    .addItemTexture(26, Alignment.LEFT, true, 0.6F, AerialHellItems.AZURITE_CRYSTAL, true)
                    .addItemTexture(27, Alignment.LEFT, true, 0.6F, AerialHellItems.OBSIDIAN_SHARD, true)
                    .addItemTexture(28, Alignment.LEFT, false, 0.6F, AerialHellItems.LUNATIC_CRYSTAL, true)
                    .addItemTexture(30, Alignment.LEFT, true, 0.6F, AerialHellItems.CURSED_CRYSTAL, true)
                    .addItemTexture(31, Alignment.LEFT, true, 0.6F, AerialHellItems.VOLUCITE_VIBRANT, true)
                    .addItemTexture(32, Alignment.LEFT, true, 0.6F, AerialHellItems.ARSONIST_INGOT, true),
            new Page("materials_2", PAGE_TEXTURE, 15)
                    ...
                    .addItemTexture(1, Alignment.RIGHT, true, 1.0F, AerialHellItems.FLUORITE, true)
                    ...
                    .addItemTexture(24, Alignment.LEFT, true, 1.0F, AerialHellItems.OSCILLATOR, false)
                    .addItemTexture(26, Alignment.LEFT, true, 1.0F, AerialHellItems.COPPER_PINE_CRAFTING_TABLE, false)
                    .addItemTexture(28, Alignment.LEFT, 1.0F, AerialHellItems.RUBY_CHESTPLATE, true)
                    .addItemTexture(28, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.RUBY_SWORD, true)
                    .addItemTexture(28, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.RUBY_FLUORITE_LANTERN, true)
                    .addItemTexture(28, Alignment.RIGHT, 1.0F, AerialHellItems.RUBY_BLOCK, true)
                    .addItemTexture(30, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 4 - 8, 1.0F, AerialHellItems.RUBY_BLOWPIPE, true)
                    .addItemTexture(30, Alignment.RIGHT, -LINE_WIDTH_NO_MARGIN / 4 + 8, 1.0F, AerialHellItems.RUBY_BLOWPIPE_ARROW, true)
                    .addItemTexture(32, Alignment.LEFT, 1.0F, AerialHellItems.RUBY_BUCKET, true)
                    .addItemTexture(32, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.RUBY_BARS, true)
                    .addItemTexture(32, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.STELLAR_LIGHTER, true)
                    .addItemTexture(32, Alignment.RIGHT, 1.0F, AerialHellItems.RUBY_FLUORITE_LANTERN, true),
            new Page("materials_3", PAGE_TEXTURE, 16)
                    ...
                    .addItemTexture(1, Alignment.RIGHT, true, 1.0F, AerialHellItems.MAGMATIC_GEL, true)
                    ...
                    .addItemTexture(3, Alignment.LEFT, 1.0F, AerialHellItems.MAGMATIC_GEL_ORE, false)
                    .addItemTexture(6, Alignment.LEFT, true, 1.0F, AerialHellItems.FREEZER, false)
                    .addItemTexture(8, Alignment.LEFT, 1.0F, AerialHellItems.MAGMATIC_GEL_BOOTS, true)
                    .addItemTexture(11, Alignment.LEFT, true, 1.0F, AerialHellItems.MAGMATIC_GEL_SWORD, true)
                    .addItemTexture(13, Alignment.LEFT, true, 1.0F, AerialHellItems.SKY_CACTUS_FIBER_CRAFTING_TABLE, false)
                    .addItemTexture(15, Alignment.LEFT, 1.0F, AerialHellItems.MAGMATIC_GEL_CHESTPLATE, true)
                    .addItemTexture(15, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.MAGMATIC_GEL_PICKAXE, true)
                    .addItemTexture(15, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.FREEZER, true)
                    .addItemTexture(15, Alignment.LEFT, 3 * LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.MAGMATIC_GEL_BLOCK, true)
                    .addItemTexture(15, Alignment.LEFT, 4 * LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.MAGMATIC_GEL_STAIRS, true)
                    ...
                    .addItemTexture(24, Alignment.LEFT, true, 1.0F, AerialHellItems.OSCILLATOR, false)
                    .addItemTexture(26, Alignment.LEFT, true, 1.0F, AerialHellItems.LAPIS_ROBINIA_CRAFTING_TABLE, false)
                    .addItemTexture(28, Alignment.LEFT, 1.0F, AerialHellItems.AZURITE_CHESTPLATE, true)
                    .addItemTexture(28, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.AZURITE_SWORD, true)
                    .addItemTexture(28, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.AZURITE_PICKAXE, true)
                    .addItemTexture(28, Alignment.RIGHT, 1.0F, AerialHellItems.AZURITE_BLOCK, true)
                    .addItemTexture(30, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 4 - 8, 1.0F, AerialHellItems.AZURITE_COPPER_PINE_CONE, true)
                    .addItemTexture(30, Alignment.RIGHT, -LINE_WIDTH_NO_MARGIN / 4 + 8, 1.0F, AerialHellItems.AZURITE_SHURIKEN, true),
            new Page("materials_4", PAGE_TEXTURE, 17)
                    ...
                    .addItemTexture(3, Alignment.LEFT, true, 0.7F, AerialHellItems.IRON_STELLAR_ORE, true)
                    .addItemTexture(4, Alignment.LEFT, true, 0.7F, AerialHellItems.GOLD_STELLAR_ORE, true)
                    .addItemTexture(5, Alignment.LEFT, true, 0.7F, AerialHellItems.DIAMOND_STELLAR_ORE, true)
                    ...
                    .addItemTexture(9, Alignment.LEFT, true, 0.7F, () -> Items.FLINT, true)
                    .addItemTexture(10, Alignment.LEFT, true, 0.7F, () -> Items.REDSTONE, true)
                    ...
                    .addItemTexture(18, Alignment.RIGHT, true, 1.0F, AerialHellItems.OBSIDIAN_SHARD, true)
                    ...
                    .addItemTexture(20, Alignment.LEFT, true, 1.0F, AerialHellItems.MUD_BRICKS, false)
                    .addItemTexture(22, Alignment.LEFT, true, 1.0F, AerialHellItems.OBSIDIAN_ORE, false)
                    .addItemTexture(24, Alignment.LEFT, 1.0F, () -> Items.ANVIL, false)
                    .addItemTexture(27, Alignment.LEFT, 1.0F, () -> Items.ENCHANTING_TABLE, false)
                    .addItemTexture(30, Alignment.LEFT, true, 1.0F, AerialHellItems.SHADOW_PINE_CRAFTING_TABLE, false)
                    .addItemTexture(32, Alignment.LEFT, 1.0F, AerialHellItems.OBSIDIAN_HELMET, true)
                    .addItemTexture(32, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.OBSIDIAN_CHESTPLATE, true)
                    .addItemTexture(32, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.OBSIDIAN_SWORD, true)
                    .addItemTexture(32, Alignment.LEFT, 3 * LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.OBSIDIAN_PICKAXE, true)
                    .addItemTexture(32, Alignment.LEFT, 4 * LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, () -> Items.OBSIDIAN, true)
                    .addItemTexture(32, Alignment.RIGHT, 1.0F, () -> Items.ENCHANTING_TABLE, true),
            new Page("materials_5", PAGE_TEXTURE, 18)
                    ...
                    .addItemTexture(1, Alignment.RIGHT, true, 1.0F, AerialHellItems.LUNATIC_CRYSTAL, true)
                    ...
                    .addItemTexture(3, Alignment.LEFT, true, 1.0F, AerialHellItems.LUNATIC_STONE, false)
                    .addItemTexture(5, Alignment.LEFT, true, 1.0F, AerialHellItems.LUNATIC_CHESTPLATE, false)
                    .addItemTexture(7, Alignment.LEFT, 1.0F, () -> Items.ANVIL, false)
                    .addItemTexture(10, Alignment.LEFT, true, 1.0F, AerialHellItems.GOLDEN_BEECH_CRAFTING_TABLE, false)
                    .addItemTexture(11, Alignment.LEFT, 1.0F, AerialHellItems.LUNATIC_HELMET, true)
                    .addItemTexture(11, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.LUNATIC_CHESTPLATE, true)
                    .addItemTexture(11, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.LUNATIC_LEGGINGS, true)
                    .addItemTexture(11, Alignment.RIGHT, 1.0F, AerialHellItems.LUNATIC_BOOTS, true)
                    .addItemTexture(13, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 4 - 8, 1.0F, AerialHellItems.LUNATIC_SWORD, true)
                    .addItemTexture(13, Alignment.RIGHT, -LINE_WIDTH_NO_MARGIN / 4 + 8, 1.0F, AerialHellItems.LUNATIC_PICKAXE, true)
                    .addItemTexture(15, Alignment.LEFT, 1.0F, AerialHellItems.LUNATIC_SHOVEL, true)
                    .addItemTexture(15, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.LUNATIC_HOE, true)
                    .addItemTexture(15, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.LUNATIC_AXE, true)
                    .addItemTexture(15, Alignment.RIGHT, 1.0F, AerialHellItems.LUNATIC_CRYSTAL_BLOCK, true)
                    .addParagraph(18, MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "cursed_crystal_material")
                    .addItemTexture(18, Alignment.RIGHT, true, 1.0F, AerialHellItems.CURSED_CRYSTAL, true)
                    ...
                    .addItemTexture(30, Alignment.LEFT, 2 * LINE_WIDTH_NO_MARGIN / 3 - 8, 1.0F, AerialHellItems.SHADOW_LEGGINGS, true)
                    .addItemTexture(30, Alignment.RIGHT, 1.0F, AerialHellItems.SHADOW_BOOTS, true)
                    .addItemTexture(32, Alignment.LEFT, LINE_WIDTH_NO_MARGIN / 4 - 8, 1.0F, AerialHellItems.CURSED_CRYSAL_BLOCK, true)
            ...
            new Page("materials_6", PAGE_TEXTURE, 19)
                    ...
                    .addItemTexture(6, Alignment.LEFT, true, 1.0F, AerialHellItems.LUNATIC_STONE, false)
                    .addItemTexture(8, Alignment.LEFT, true, 1.0F, AerialHellItems.VOLUCITE_CHESTPLATE, true)
                    .addItemTexture(10, Alignment.LEFT, true, 1.0F, AerialHellItems.VOLUCITE_SWORD, true)
                    .addItemTexture(12, Alignment.LEFT, true, 1.0F, AerialHellItems.LAPIS_ROBINIA_CRAFTING_TABLE, false)
                    .addItemTexture(14, Alignment.LEFT, 1.0F, AerialHellItems.VOLUCITE_HELMET, true)
            ...
            new Page("materials_7", PAGE_TEXTURE, 20)
                    ...
                    .addItemTexture(11, Alignment.LEFT, 4 * LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.SMOKY_QUARTZ_BLOCK, true)
                    .addItemTexture(11, Alignment.RIGHT, 1.0F, AerialHellItems.SMOKY_QUARTZ_SLAB, true)
                    .addItemTexture(13, Alignment.LEFT, 4 * LINE_WIDTH_NO_MARGIN / 5 - 8, 1.0F, AerialHellItems.CHISELED_SMOKY_QUARTZ_BLOCK, true)
            ...
            new Page("environment_1", PAGE_TEXTURE,27)
                    ...
                    .addItemTexture(20, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.STELLAR_GRASS_BLOCK.get().getDefaultInstance(), false)
                    ...
                    .addItemTexture(27, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.AERIAL_TREE_LEAVES.get().getDefaultInstance(), false)
                    .addParagraph(29,MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "aerial_tree_forest_desc")
                    .addTextureDisplay(31, Alignment.CENTER, 0.8F, "gui/guide_book/content/entities/flying_jellyfish", 28, 30, "entity.aerialhell.flying_jellyfish"),
            new Page("environment_2", PAGE_TEXTURE,28)
                    ...
                    .addItemTexture(3, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.LAPIS_ROBINIA_LOG.get().getDefaultInstance(), false)
                    .addParagraph(5,MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "lapis_robinia_savana_desc")
                    .addItemTexture(10, Alignment.LEFT, 1.0F, AerialHellItems.LAPIS_ROBINIA_LOG, true)
                    .addItemTexture(10, Alignment.CENTER, 1.0F, AerialHellItems.LAPIS_ROBINIA_LEAVES, true)
                    .addItemTexture(10, Alignment.RIGHT, 1.0F, () -> Items.LAPIS_LAZULI, true)
                    ...
                    .addItemTexture(20, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.COPPER_PINE_LEAVES.get().getDefaultInstance(), false)
                    .addItemTexture(21, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.COPPER_PINE_LOG.get().getDefaultInstance(), false)
                    .addParagraph(23,MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "copper_pine_biomes_desc")
                    .addTextureDisplay(25, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/kodama", 14, 22, "entity.aerialhell.kodama")
                    .addItemTexture(26, Alignment.CENTER, 0, false, 1.0F, () -> AerialHellItems.COPPER_PINE_CONE.get().getDefaultInstance(), false)
                    ...
                    .addItemTexture(28, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.STELLAR_JUNGLE_TREE_LOG.get().getDefaultInstance(), false)
            ...
            new Page("environment_3", PAGE_TEXTURE,29)
                    ...
                    .addItemTexture(3, Alignment.LEFT, 0, true, 0.7F, Items.RED_MUSHROOM::getDefaultInstance, false)
                    .addItemTexture(4, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.VERDIGRIS_AGARIC.get().getDefaultInstance(), false)
                    .addItemTexture(5, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.CORTINARIUS_VIOLACEUS.get().getDefaultInstance(), false)
                    .addParagraph(7,MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "shroomy_biomes_desc")
                    .addTextureDisplay(12, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/cortinarius_cow", 26, 26, "entity.aerialhell.cortinarius_cow")
                    .addTextureDisplay(12, Alignment.CENTER, 0.9F, "gui/guide_book/content/entities/verdigris_zombie", 20, 31, "entity.aerialhell.verdigris_zombie")
                    .addTextureDisplay(12, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/shroomboom", 18, 27, "entity.aerialhell.shroomboom")
                    ...
                    .addItemTexture(20, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.CRYSTAL_BLOCK.get().getDefaultInstance(), false)
                    .addItemTexture(21, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.CRYSTALLIZED_LEAVES.get().getDefaultInstance(), false)
                    .addParagraph(23,MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "crystal_biomes_desc")
                    .addItemTexture(28, Alignment.LEFT, 0.9F, AerialHellItems.CRYSTAL, true)
                    .addItemTexture(28, Alignment.CENTER, 0.9F, AerialHellItems.CRYSTAL_BLOCK, true)
                    .addItemTexture(28, Alignment.RIGHT,0.9F, AerialHellItems.STELLAR_CRYSTAL_PODZOL, true)
                    .addTextureDisplay(30, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/crystal_caterpillar", 26, 22, "entity.aerialhell.crystal_caterpillar")
                    .addTextureDisplay(30, Alignment.CENTER, 1.0F, "gui/guide_book/content/entities/crystal_slime", 30, 30, "entity.aerialhell.crystal_slime")
                    .addTextureDisplay(30, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/crystal_spider", 30, 28, "entity.aerialhell.crystal_spider"),
            new Page("environment_4", PAGE_TEXTURE,30)
                    ...
                    .addItemTexture(3, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.SLIPPERY_SAND.get().getDefaultInstance(), false)
                    .addParagraph(5,MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "desert_biomes_desc")
                    .addItemTexture(13, Alignment.CENTER,0.9F, AerialHellItems.SKY_CACTUS, true)
                    .addItemTexture(15, Alignment.CENTER,0.9F, AerialHellItems.PETRIFIED_AERIAL_TREE_LOG, true)
                    .addTextureDisplay(14, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/venomous_snake", 22, 24, "entity.aerialhell.venomous_snake")
                    .addTextureDisplay(14, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/hell_spider", 32, 24, "entity.aerialhell.hell_spider")
                    ...
                    .addItemTexture(20, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.SHADOW_GRASS_BLOCK.get().getDefaultInstance(), false)
                    .addItemTexture(21, Alignment.LEFT, 0, true, 0.7F, () -> AerialHellItems.SHADOW_PINE_LEAVES.get().getDefaultInstance(), false)
                    .addParagraph(23,MAX_LINES_PER_TECHNICAL_PAGE - 1, LINE_WIDTH_NO_MARGIN, Alignment.LEFT, "shadow_biomes_desc")
                    .addItemTexture(28, Alignment.LEFT, 0.9F, AerialHellItems.SHADOW_CRYSTAL, true)
                    .addItemTexture(28, Alignment.CENTER, -20, 0.9F, AerialHellItems.SHADOW_CRYSTAL_BLOCK, true)
                    .addItemTexture(28, Alignment.RIGHT, -42,0.9F, AerialHellItems.SHADOW_BRAMBLES, true)
                    .addItemTexture(30, Alignment.CENTER,0.9F, AerialHellItems.SHADOW_SHARD, true)
                    .addTextureDisplay(30, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/shadow_automaton", 16, 28, "entity.aerialhell.shadow_automaton")
                    .addTextureDisplay(28, Alignment.RIGHT, 0.9F, "gui/guide_book/content/entities/shadow_troll", 39, 64, "entity.aerialhell.shadow_troll"),
            ...
            new Page("bestiary_4", PAGE_TEXTURE,36)
                    ...
                    .addTextureDisplay(3, Alignment.CENTER, 1.0F, "item/copper_pine_chest_mimic", 16, 16, "entity.aerialhell.copper_pine_mimic")
                    .addTextureDisplay(3, Alignment.RIGHT, 1.0F, "item/golden_beech_chest_mimic", 16, 16, "entity.aerialhell.golden_beech_mimic")
                    .addTextureDisplay(5, Alignment.LEFT, 1.0F, "item/sky_cactus_fiber_chest_mimic",  16, 16, "entity.aerialhell.sky_cactus_fiber_mimic")
                    .addTextureDisplay(5, Alignment.RIGHT, 1.0F, "item/shadow_pine_barrel_mimic", 16, 16, "entity.aerialhell.shadow_pine_mimic")
                    .addTextureDisplay(9, Alignment.LEFT, 0.8F, "gui/guide_book/content/entities/crystal_golem", 34, 54, "entity.aerialhell.crystal_golem")
                    .addTextureDisplay(9, Alignment.CENTER, 1.0F, "gui/guide_book/content/entities/crystal_slime", 30, 30, "entity.aerialhell.crystal_slime")
                    .addTextureDisplay(9, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/fat_phantom", 32, 28, "entity.aerialhell.fat_phantom")
                    .addTextureDisplay(14, Alignment.LEFT, 0.95F, "gui/guide_book/content/entities/worm", 28, 28, "entity.aerialhell.worm")
                    .addTextureDisplay(14, Alignment.CENTER, 1.0F, "gui/guide_book/content/entities/venomous_snake", 22, 24, "entity.aerialhell.venomous_snake")
                    .addTextureDisplay(13, Alignment.RIGHT, 0.7F, "gui/guide_book/content/entities/aerial_tree_mimic", 32, 50, "entity.aerialhell.aerial_tree_mimic")
                    .addTextureDisplay(18, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/cortinarius_cow", 26, 26, "entity.aerialhell.cortinarius_cow")
                    .addTextureDisplay(18, Alignment.CENTER, 1.0F, "gui/guide_book/content/entities/evil_cow", 30, 30, "entity.aerialhell.evil_cow")
                    .addTextureDisplay(18, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/crystal_spider", 30, 28, "entity.aerialhell.crystal_spider")
                    .addTextureDisplay(21, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/forest_caterpillar", 26, 22, "entity.aerialhell.forest_caterpillar")
                    .addTextureDisplay(21, Alignment.CENTER, 1.0F, "gui/guide_book/content/entities/crystal_caterpillar", 26, 22, "entity.aerialhell.crystal_caterpillar")
                    .addTextureDisplay(21, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/hell_spider", 32, 24, "entity.aerialhell.hell_spider")
                    .addTextureDisplay(24, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/shadow_pine_mimic", 32, 20, "entity.aerialhell.shadow_pine_mimic")
                    .addTextureDisplay(24, Alignment.CENTER, 1.2F, "gui/guide_book/content/entities/sandy_sheep", 20, 18, "entity.aerialhell.sandy_sheep")
                    .addTextureDisplay(24, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/torn_spirit", 24, 32, "entity.aerialhell.torn_spirit")
                    .addTextureDisplay(27, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/flying_jellyfish", 28, 30, "entity.aerialhell.flying_jellyfish")
                    .addTextureDisplay(27, Alignment.CENTER, 1.1F, "gui/guide_book/content/entities/slime_pirate", 20, 24, "entity.aerialhell.slime_pirate")
                    .addTextureDisplay(27, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/ghost_slime_pirate", 23, 28, "entity.aerialhell.ghost_slime_pirate")
            ...
            new Page("bestiary_5", PAGE_TEXTURE,37)
                    ...
                    .addTextureDisplay(4, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/verdigris_zombie", 20, 31, "entity.aerialhell.verdigris_zombie")
                    .addTextureDisplay(4, Alignment.CENTER, 1.0F, "gui/guide_book/content/entities/mud_golem", 27, 33, "entity.aerialhell.mud_golem")
                    .addTextureDisplay(4, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/shroomboom", 18, 27, "entity.aerialhell.shroomboom")
                    .addTextureDisplay(8, Alignment.LEFT, 1.1F, "gui/guide_book/content/entities/stellar_ent", 19, 21, "entity.aerialhell.stellar_ent")
                    .addTextureDisplay(8, Alignment.CENTER, 1.1F, "gui/guide_book/content/entities/stellar_boar", 22, 15, "entity.aerialhell.stellar_boar")
                    .addTextureDisplay(7, Alignment.RIGHT, 1.3F, "gui/guide_book/content/entities/stellar_chicken", 10, 12, "entity.aerialhell.stellar_chicken")
                    .addTextureDisplay(11, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/volucite_golem", 26, 36, "entity.aerialhell.volucite_golem")
            ...
            new Page("bosses_1", PAGE_TEXTURE,38)
                    ...
                    .addTextureDisplay(28, Alignment.LEFT, 1.0F, "gui/guide_book/content/entities/lilith", 32, 32, "entity.aerialhell.lilith")
                    .addTextureDisplay(28, Alignment.RIGHT, 1.0F, "gui/guide_book/content/entities/lilith_evil", 32, 32, "entity.aerialhell.lilith")
    );
