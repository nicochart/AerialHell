...
{
    private static final StationInfo STELLAR_FURNACE_STATION_INFO = new StationInfo(new TextureInfo(ResourceLocation.fromNamespaceAndPath(AerialHell.MODID, "textures/block/stellar_furnace_front_on.png"), 16,16), "block.aerialhell.stellar_furnace");
