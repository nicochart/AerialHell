...
{
	public static final ResourceLocation OSCILLATOR_GUI_TEXTURES = AerialHell.id("textures/gui/container/oscillator.png");
	public static final ResourceLocation LIT_PROGRESS_SPRITE =  AerialHell.id("container/oscillator/oscillating_progress");
	public static final ResourceLocation OSCILLATING_PROGRESS_SPRITE =  AerialHell.id("container/oscillator/progress");
