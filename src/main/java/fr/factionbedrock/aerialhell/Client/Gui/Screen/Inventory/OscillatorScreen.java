...
@OnlyIn(Dist.CLIENT)
public class OscillatorScreen extends AerialHellFurnaceScreen<OscillatorMenu>
{
	...
	public OscillatorScreen(OscillatorMenu container, PlayerInventory inventory, Component name)
	{
