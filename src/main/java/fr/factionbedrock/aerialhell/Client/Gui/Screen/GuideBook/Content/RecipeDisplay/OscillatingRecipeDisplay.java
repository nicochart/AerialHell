...
public class OscillatingRecipeDisplay extends SmeltingLikeRecipeDisplay
{
    ...
    {
        super(lineIndex, alignment, scale, () -> ingredient.get().getDefaultInstance(), () -> result.get().getDefaultInstance(), AerialHellItems.FLUORITE::getDefaultInstance, OSCILLATING_STATION_INFO, displayTooltip);
    }
}
