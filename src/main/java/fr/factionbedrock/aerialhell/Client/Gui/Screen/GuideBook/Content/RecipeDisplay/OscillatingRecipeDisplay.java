...
{
    private static final StationInfo OSCILLATING_STATION_INFO = new StationInfo(new TextureInfo(Identifier.fromNamespaceAndPath(AerialHell.MODID, "textures/block/oscillator_side_on.png"), 0.0F, 0.0F, 16, 16, 16,48), "block.aerialhell.oscillator");
