...
{
    private static final StationInfo OSCILLATING_STATION_INFO = new StationInfo(new TextureInfo(ResourceLocation.fromNamespaceAndPath(AerialHell.MODID, "textures/block/oscillator_side_on.png"), 0.0F, 0.0F, 16, 16, 16,48), "block.aerialhell.oscillator");
    ...
    {
        super(lineIndex, alignment, scale, () -> ingredient.get().getDefaultInstance(), () -> result.get().getDefaultInstance(), () -> AerialHellBlocksAndItems.FLUORITE.get().getDefaultInstance(), OSCILLATING_STATION_INFO, displayTooltip);
    }
}
