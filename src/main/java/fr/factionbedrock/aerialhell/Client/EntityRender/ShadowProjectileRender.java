...
public class ShadowProjectileRender extends EntityRenderer<ShadowProjectileEntity>
{
    ...
    public ShadowProjectileRender(EntityRendererManager renderManager)
    {
        super(renderManager);
    ...
    @Override
    public void render(ShadowProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
        matrixStackIn.push();
    ...
    @Override
    protected int getBlockLight(ShadowProjectileEntity entityIn, BlockPos partialTicks)
    {
    	return 13;
    }

    @Override
    public ResourceLocation getEntityTexture(ShadowProjectileEntity entity)
    {
        return SHADOW_PROJECTILE;
    }
