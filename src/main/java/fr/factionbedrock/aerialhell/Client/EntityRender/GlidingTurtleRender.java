...
public class GlidingTurtleRender extends MobEntityRenderer<GlidingTurtleEntity, GlidingTurtleRenderState, GlidingTurtleModel>
{
    ...
    @Override public Identifier getTexture(GlidingTurtleRenderState renderState) {return TURTLE_TEXTURE;}
}