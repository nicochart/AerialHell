...
{
    private static final Identifier CORTINARIUS_COW_TEXTURE = Identifier.fromNamespaceAndPath(AerialHell.MODID, "textures/entity/cortinarius_cow/cortinarius_cow.png");
    ...
    @Override public Identifier getTextureLocation(LivingEntityRenderState renderState) {return CORTINARIUS_COW_TEXTURE;}
}
