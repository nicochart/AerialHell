...
public class ShurikenRender<T extends ShurikenEntity> extends EntityRenderer<T, ShurikenRenderState>
{
	...
	{
		if (entity.getType().is(HolderSet.direct(AerialHellEntities.IRON_SHURIKEN))) {return AerialHellItems.IRON_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.GOLD_SHURIKEN))) {return AerialHellItems.GOLD_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.VOLUCITE_SHURIKEN))) {return AerialHellItems.VOLUCITE_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.OBSIDIAN_SHURIKEN))) {return AerialHellItems.OBSIDIAN_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.LUNATIC_CRYSTAL_SHURIKEN))) {return AerialHellItems.LUNATIC_CRYSTAL_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.ARSONIST_SHURIKEN))) {return AerialHellItems.ARSONIST_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.DIAMOND_SHURIKEN))) {return AerialHellItems.DIAMOND_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.NETHERITE_SHURIKEN))) {return AerialHellItems.NETHERITE_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.RUBY_SHURIKEN))) {return AerialHellItems.RUBY_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.AZURITE_SHURIKEN))) {return AerialHellItems.AZURITE_SHURIKEN.get();}
		else if (entity.getType().is(HolderSet.direct(AerialHellEntities.MAGMATIC_GEL_SHURIKEN))) {return AerialHellItems.MAGMATIC_GEL_SHURIKEN.get();}
