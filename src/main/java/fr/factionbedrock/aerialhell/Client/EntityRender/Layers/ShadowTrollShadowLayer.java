...
public class ShadowTrollShadowLayer extends LayerRenderer<ShadowTrollEntity, ShadowTrollModel>
{
   ...
   public void render(PoseStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, ShadowTrollEntity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
   {
