...
public class BlocksAndItemsColorHandler
{
    ...
    public static void handleItemColors()
    {
        ColorProviderRegistry.ITEM.register((stack, color) -> ColorHandlerHelper.AERIAL_HELL_PLAINS_GRASS_COLOR,
                AerialHellItems.CHISELED_STELLAR_GRASS_BLOCK_ITEM,
                AerialHellItems.STELLAR_GRASS_BLOCK_ITEM,
                AerialHellItems.STELLAR_PODZOL_ITEM,
                AerialHellItems.STELLAR_GRASS_ITEM,
                AerialHellItems.STELLAR_TALL_GRASS_ITEM,
                AerialHellItems.STELLAR_GRASS_BALL_ITEM,
                AerialHellItems.STELLAR_FERN_ITEM,
                AerialHellItems.STELLAR_TALL_FERN_ITEM,
                AerialHellItems.STELLAR_VERY_TALL_GRASS_ITEM,
                AerialHellItems.STELLAR_CLOVERS_ITEM,
                AerialHellItems.STELLAR_ROOTS_ITEM,
                AerialHellItems.MOSSY_STELLAR_STONE_ITEM,
                AerialHellItems.MOSSY_STELLAR_COBBLESTONE_ITEM,
                AerialHellItems.MOSSY_STELLAR_STONE_WALL_ITEM,
                AerialHellItems.MOSSY_STELLAR_COBBLESTONE_WALL_ITEM,
                AerialHellItems.MOSSY_STELLAR_STONE_SLAB_ITEM,
                AerialHellItems.MOSSY_STELLAR_COBBLESTONE_SLAB_ITEM,
                AerialHellItems.MOSSY_STELLAR_STONE_STAIRS_ITEM,
                AerialHellItems.MOSSY_STELLAR_COBBLESTONE_STAIRS_ITEM,
                AerialHellItems.MOSSY_MUD_BRICKS_ITEM,
                AerialHellItems.MOSSY_MUD_BRICKS_WALL_ITEM,
                AerialHellItems.MOSSY_MUD_BRICKS_SLAB_ITEM,
                AerialHellItems.MOSSY_MUD_BRICKS_STAIRS_ITEM,
                AerialHellItems.MOSSY_SHADOW_CATACOMBS_BRICKS_ITEM,
                AerialHellItems.MOSSY_SHADOW_CATACOMBS_BRICKS_WALL_ITEM,
                AerialHellItems.MOSSY_SHADOW_CATACOMBS_BRICKS_SLAB_ITEM,
                AerialHellItems.MOSSY_SHADOW_CATACOMBS_BRICKS_STAIRS_ITEM
        );

        ColorProviderRegistry.ITEM.register((stack, color) -> new Color(92, 171, 102).getRGB(),
                AerialHellItems.STELLAR_JUNGLE_TREE_LEAVES_ITEM
        );

        ColorProviderRegistry.ITEM.register((stack, color) -> ColorHandlerHelper.SHADOW_BLACK,
                AerialHellItems.SHADOW_GRASS_BLOCK_ITEM
        );

        ColorProviderRegistry.ITEM.register((stack, color) -> getCustomColor(stack, color),
                AerialHellItems.MUD_GLYPH_BLOCK_ITEM,
                AerialHellItems.LUNATIC_GLYPH_BLOCK_ITEM,
                AerialHellItems.GOLDEN_NETHER_PRISON_GLYPH_BLOCK_ITEM,
                AerialHellItems.VOLUCITE_GLYPH_BLOCK_ITEM,
                AerialHellItems.SHADOW_CATACOMBS_GLYPH_BLOCK_ITEM
        );
    }

    private static int getCustomColor(ItemStack itemstack, int color)
    {
        if (itemstack.getItem() == AerialHellItems.MUD_GLYPH_BLOCK_ITEM) {return ColorHandlerHelper.MUD_GLYPH_COLOR;}
        else if (itemstack.getItem() == AerialHellItems.LUNATIC_GLYPH_BLOCK_ITEM) {return ColorHandlerHelper.LUNATIC_GLYPH_COLOR;}
        else if (itemstack.getItem() == AerialHellItems.GOLDEN_NETHER_PRISON_GLYPH_BLOCK_ITEM) {return ColorHandlerHelper.GOLDEN_NETHER_PRISON_GLYPH_COLOR;}
        else if (itemstack.getItem() == AerialHellItems.VOLUCITE_GLYPH_BLOCK_ITEM) {return ColorHandlerHelper.VOLUCITE_GLYPH_COLOR;}
        else if (itemstack.getItem() == AerialHellItems.SHADOW_CATACOMBS_GLYPH_BLOCK_ITEM) {return ColorHandlerHelper.SHADOW_CATACOMBS_GLYPH_COLOR;}
        else {return ColorHandlerHelper.DEFAULT_COLOR.getRGB();}
    }
