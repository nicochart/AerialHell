...
public class RenderRegistrationListener
{
    public static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event)
    {
        ...
        event.registerEntityRenderer(AerialHellEntities.VOLUCITE_GOLEM_HEAD.get(), VoluciteGolemHeadRender::new);
    ...
    public static void onRegisterLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event)
    {
        ...
        event.registerLayerDefinition(AerialHellModelLayers.VOLUCITE_GOLEM_HEAD, VoluciteGolemHeadModel::createBodyLayer);
