...
public class RenderRegistrationListener
{
    public static void registerBlockRenderLayers()
    {
        ...
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_LOG, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_WOOD, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_SLAB, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_STAIRS, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_FENCE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_GATE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_DOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_STELLAR_COBBLESTONE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_STELLAR_FURNACE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_WOOL, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_RUBY_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_FLUORITE_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_AZURITE_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_GOLD_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_BARREL, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_CRAFTING_TABLE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_BOAT_VINE_ROPE_SPOOL, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GHOST_LANTERN, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.WHITE_SOLID_ETHER, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLUE_SOLID_ETHER, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.CRYSTAL_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_STONE_CRYSTAL_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_CRYSTAL_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_CRYSTAL_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.CRYSTALLIZED_LEAVES, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.CRYSTALLIZED_FIRE, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GOLDEN_SOLID_ETHER, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GREEN_SOLID_ETHER, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.PURPLE_SOLID_ETHER, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GLOWING_STICK_FRUIT_VINES, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GLOWING_STICK_FRUIT_VINES_PLANT, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLOSSOMING_VINES, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLOSSOMING_VINES_PLANT, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.CLIMBING_VINE, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_SUGAR_CANE, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.FULL_MOON_FLOWER, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.LAZULI_ROOTS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.LAZULI_ROOTS_PLANT, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_ROOTS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_ROOTS_PLANT, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.DEAD_ROOTS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.DEAD_ROOTS_PLANT, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GLOWING_ROOTS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GLOWING_ROOTS_PLANT, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_GLOWING_ROOTS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_GLOWING_ROOTS_PLANT, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.AERIAL_BERRY_BUSH, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.VIBRANT_AERIAL_BERRY_BUSH, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_WHEAT, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLUE_MEANIE_CROP, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLUE_FLOWER, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLACK_ROSE, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BELLFLOWER, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_STELLAR_STONE, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_STELLAR_COBBLESTONE, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_STELLAR_STONE_SLAB, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_STELLAR_COBBLESTONE_SLAB, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_STELLAR_STONE_STAIRS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_STELLAR_COBBLESTONE_STAIRS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_STELLAR_STONE_WALL, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_STELLAR_COBBLESTONE_WALL, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_MUD_BRICKS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_SHADOW_CATACOMBS_BRICKS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_MUD_BRICKS_SLAB, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_MUD_BRICKS_STAIRS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_MUD_BRICKS_WALL, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_SHADOW_CATACOMBS_BRICKS_SLAB, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_SHADOW_CATACOMBS_BRICKS_STAIRS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MOSSY_SHADOW_CATACOMBS_BRICKS_WALL, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MUD_GLYPH_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.LUNATIC_GLYPH_BLOCK, translucent);
        ...
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BRAMBLES, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_BRAMBLES, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_GRASS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_GRASS_BALL, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.PURPLISH_STELLAR_GRASS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_CLOVERS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GLOWING_STELLAR_GRASS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.THORNY_COBWEB, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.AERIAL_TREE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GOLDEN_BEECH_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.COPPER_PINE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.LAPIS_ROBINIA_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_PINE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_JUNGLE_TREE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.PURPLE_SHADOW_PINE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.CORTINARIUS_VIOLACEUS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.VERDIGRIS_AGARIC, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GLOWING_BOLETUS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.TALL_GLOWING_BOLETUS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLUE_MEANIE_CLUSTER, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GIANT_ROOT_SHROOM, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_TALL_GRASS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_TALL_FERN, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_VERY_TALL_GRASS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLUISH_FERN, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.TALL_BLUISH_FERN, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POLYCHROME_FERN, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.TALL_POLYCHROME_FERN, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.STELLAR_DEAD_BUSH, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_BLUE_FLOWER, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_BLACK_ROSE, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_BELLFLOWER, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_STELLAR_FERN, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_STELLAR_DEAD_BUSH, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_SKY_CACTUS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_VIBRANT_SKY_CACTUS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_AERIAL_TREE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_GOLDEN_BEECH_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_COPPER_PINE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_LAPIS_ROBINIA_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_SHADOW_PINE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_PURPLE_SHADOW_PINE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_STELLAR_JUNGLE_TREE_SAPLING, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_CORTINARIUS_VIOLACEUS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_VERDIGRIS_AGARIC, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_VINE_BLOSSOM, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.POTTED_GLOWING_BOLETUS, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SLIPPERY_SAND_GLASS, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.RED_SLIPPERY_SAND_GLASS, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLACK_SLIPPERY_SAND_GLASS, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLUE_SLIPPERY_SAND_GLASS, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GREEN_SLIPPERY_SAND_GLASS, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SLIPPERY_SAND_GLASS_PANE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.RED_SLIPPERY_SAND_GLASS_PANE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLACK_SLIPPERY_SAND_GLASS_PANE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.BLUE_SLIPPERY_SAND_GLASS_PANE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GREEN_SLIPPERY_SAND_GLASS_PANE, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MAGMATIC_GEL_BLOCK, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MAGMATIC_GEL_SLAB, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MAGMATIC_GEL_STAIRS, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.MAGMATIC_GEL_WALL, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.AERIAL_TREE_DOOR, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GOLDEN_BEECH_DOOR, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.COPPER_PINE_DOOR, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.LAPIS_ROBINIA_DOOR, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_PINE_DOOR, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SKY_CACTUS_FIBER_DOOR, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GRAY_SHROOM_DOOR, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.RUBY_DOOR, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.AERIAL_TREE_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.LAPIS_ROBINIA_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GOLDEN_BEECH_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.COPPER_PINE_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SHADOW_PINE_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SKY_CACTUS_FIBER_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.GRAY_SHROOM_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.RUBY_TRAPDOOR, translucent);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.RUBY_BARS, translucent);
        ...
        BlockRenderLayerMap.putBlock(AerialHellBlocks.VOLUCITE_WALL_TORCH, cutout);
        BlockRenderLayerMap.putBlock(AerialHellBlocks.SKY_LADDER, cutout);
    ...
    public static void registerLayerDefinitions()
    {
        ...
        EntityModelLayerRegistry.registerModelLayer(AerialHellModelLayers.RESONATOR_SHARD, ResonatorShardModel::createBodyLayer);
    }

    public static void registerShiftingBakedModels()
    {
        ModelLoadingPlugin.register(plugin -> plugin.modifyBlockModelAfterBake().register((originalModel, context) ->
        {
