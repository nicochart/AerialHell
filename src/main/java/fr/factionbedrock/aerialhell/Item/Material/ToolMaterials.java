...
{
	public static final ToolMaterial SKY_WOOD = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 59, 2.0F, 0.0F, 15, AerialHellTags.Items.AERIALHELL_PLANKS);
	public static final ToolMaterial STELLAR_STONE = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 131, 4.0F, 1.0F, 5, AerialHellTags.Items.REPAIRS_STELLAR_STONE_MATERIAL);
	public static final ToolMaterial RUBY = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 250, 6.0F, 2.0F, 14, AerialHellTags.Items.REPAIRS_RUBY_MATERIAL);
	public static final ToolMaterial AZURITE = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 110, 12.0F, 0.0F, 22, AerialHellTags.Items.REPAIRS_AZURITE_MATERIAL);
	public static final ToolMaterial MAGMATIC_GEL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 32, 12.0F, 0.0F, 22, AerialHellTags.Items.REPAIRS_MAGMATIC_GEL_MATERIAL);
