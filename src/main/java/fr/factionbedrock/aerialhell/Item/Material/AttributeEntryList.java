...
public class AttributeEntryList
{
    ...
    public ItemAttributeModifiers addAllAttributesToBuilder(ItemAttributeModifiers.Builder builder, ResourceLocation modifierId, EquipmentSlotGroup slotGroup)
    {
