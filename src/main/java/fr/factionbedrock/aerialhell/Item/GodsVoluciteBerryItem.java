    ...
    public GodsVoluciteBerryItem()
    {
        super(new Item.Properties().rarity(AerialHellRarities.MYTHICAL)
                .food(new FoodProperties.Builder().alwaysEdible().nutrition(6).saturationModifier(0.8F)
                		...
                		.effect(new MobEffectInstance(AerialHellMobEffects.HEAD_IN_THE_CLOUDS, 2000, 2), 1.0F)
                		.effect(new MobEffectInstance(AerialHellMobEffects.SHADOW_IMMUNITY, 2400, 2), 1.0F)
                		.effect(new MobEffectInstance(AerialHellMobEffects.GOD, 6000, 0), 1.0F)
