...
{
	public GoldShurikenItem(Item.Properties settings) {super(settings);}
	...
	@Override protected AbstractShurikenEntity getShurikenEntity(Player player, Level world) {return new GoldShurikenEntity(player, world, this.getDefaultInstance());}
}