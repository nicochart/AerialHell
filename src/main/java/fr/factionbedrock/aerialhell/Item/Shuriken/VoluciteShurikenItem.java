...
{
	public VoluciteShurikenItem(Item.Settings settings) {super(settings);}
	...
	@Override protected AbstractShurikenEntity getShurikenEntity(PlayerEntity player, World world) {return new VoluciteShurikenEntity(player, world, this.getDefaultStack());}
}