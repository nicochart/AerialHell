...
public class VoluciteShurikenItem extends AbstractShurikenItem
{
	...
	{
		super(new Item.Settings().rarity(AerialHellRarities.VIBRANT));
	}
	...
	@Override protected AbstractShurikenEntity getShurikenEntity(PlayerEntity player, World world) {return new VoluciteShurikenEntity(player, world);}
}