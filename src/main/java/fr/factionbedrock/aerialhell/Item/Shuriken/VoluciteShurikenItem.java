...
import fr.factionbedrock.aerialhell.Entity.Projectile.Shuriken.NoGravityShurikenEntity;
...
public class VoluciteShurikenItem extends AbstractShurikenItem
{
	...
	@Override protected NoGravityShurikenEntity getShurikenEntity(Player playerIn, Level worldIn) {return AerialHellEntities.VOLUCITE_SHURIKEN.get().create(worldIn);}
}