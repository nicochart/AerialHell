...
public class RubyShurikenItem extends AbstractShurikenItem
{
	...
	@Override protected AbstractShurikenEntity getShurikenEntity(Player playerIn, Level worldIn) {return new RubyShurikenEntity(playerIn, worldIn, this.getDefaultInstance());}
}