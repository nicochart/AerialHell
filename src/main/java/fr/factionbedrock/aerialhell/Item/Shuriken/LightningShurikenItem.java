...
{
	public LightningShurikenItem(Item.Settings settings) {super(settings);}
	...
	@Override protected AbstractShurikenEntity getShurikenEntity(PlayerEntity player, World world) {return new LightningShurikenEntity(player, world, this.getDefaultStack());}
}