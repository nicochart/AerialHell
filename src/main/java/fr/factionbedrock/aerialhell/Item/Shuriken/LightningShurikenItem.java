...
{
	public LightningShurikenItem(ItemGroup group)
	{
	...
	@Override protected AbstractShurikenEntity getKnifeEntity(PlayerEntity playerIn, World worldIn) {return new LightningShurikenEntity(playerIn, worldIn);}
}