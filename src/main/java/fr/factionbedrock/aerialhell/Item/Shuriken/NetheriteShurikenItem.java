...
{
	public NetheriteShurikenItem(CreativeModeTab group)
	{
	...
	@Override protected AbstractShurikenEntity getKnifeEntity(Player playerIn, Level worldIn) {return new NetheriteShurikenEntity(playerIn, worldIn);}
}