...
{
	public NetheriteShurikenItem(Item.Properties settings) {super(settings);}
	...
	@Override protected AbstractShurikenEntity getShurikenEntity(Player player, Level world) {return new NetheriteShurikenEntity(player, world, this.getDefaultInstance());}
}