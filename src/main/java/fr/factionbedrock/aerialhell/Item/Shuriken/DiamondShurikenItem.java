...
{
	public DiamondShurikenItem(CreativeModeTab group)
	{
	...
	@Override protected AbstractShurikenEntity getKnifeEntity(Player playerIn, Level worldIn) {return new DiamondShurikenEntity(playerIn, worldIn);}
}