...
public class ObsidianShurikenItem extends AbstractShurikenItem
{
	...
	@Override protected AbstractShurikenEntity getShurikenEntity(Player playerIn, Level worldIn) {return new ObsidianShurikenEntity(playerIn, worldIn, this.getDefaultInstance());}
}