...
public class EffectShovelItem extends AerialHellToolItem
{	
	private int timer;

	public EffectShovelItem(Properties properties) {super(properties, List.of(UseInteractionToolType.SHOVEL));}
