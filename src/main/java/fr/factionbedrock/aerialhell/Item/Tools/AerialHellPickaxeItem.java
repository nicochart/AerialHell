...
public class AerialHellPickaxeItem extends PickaxeItem implements AerialHellItemInterface
{
    ...
    public AerialHellPickaxeItem(AerialHellItem.Properties properties)
    {
        super(Tiers.IRON, 0, 0 /*tier behavior is overridden*/, properties);
        this.tier = properties.toolMaterial().vanillaMaterial();
        this.defaultModifiers = properties.defaultAttributes();
