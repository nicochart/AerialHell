...
public class AerialHellShovelItem extends ShovelItem implements AerialHellItemInterface
{
    ...
    public AerialHellShovelItem(AerialHellItem.Properties properties)
    {
