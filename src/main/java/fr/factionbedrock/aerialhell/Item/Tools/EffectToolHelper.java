...
public class EffectToolHelper
{
	...
	public static void applyFullVolucitePower(Item ItemIn, ItemStack heldItem, Level worldIn, Player playerIn, Random rand)
	{
		...
		{
			playerIn.addEffect(new MobEffectInstance(AerialHellMobEffects.HEAD_IN_THE_CLOUDS.get(), 100, 1));
	...
	public static void applyReaperWalkEffect(Item ItemIn, ItemStack heldItem, Level worldIn, Player playerIn, Random rand, int cooldown)
	{
		...
		if (!worldIn.isClientSide())
		{
			playerIn.addEffect(new MobEffectInstance(MobEffects.INVISIBILITY, 200, 0));
			playerIn.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 120, 0));
			playerIn.addEffect(new MobEffectInstance(AerialHellMobEffects.SHADOW_IMMUNITY.get(), 120, 0));
		}
		setDamageAndCooldown(ItemIn, heldItem, playerIn, cooldown);
	}
	...
	public static boolean tryRemovingPoisonAndWitherEffect(Item ItemIn, ItemStack heldItem, Level worldIn, Player playerIn, Random rand) //returns true if any effect is removed
	{
	...
	public static boolean tryEatingTool(Item ItemIn, ItemStack heldItem, Level worldIn, Player playerIn, Random rand) //return true if eat success
	{
	...
	public static void PlayerLiftoff(Item ItemIn, ItemStack heldItem, Level worldIn, Player playerIn, Random rand)
	{
		...
		playerIn.playSound(SoundEvents.GENERIC_EXPLODE, 1.0F, 0.5F + rand.nextFloat());
		int cooldown;
	...
	public static class PassiveEffects
	{
		...
		public static void applyGodEffect(LivingEntity entityIn) {((LivingEntity) entityIn).addEffect(new MobEffectInstance(AerialHellMobEffects.GOD.get(), 400, 0));}
	}
}
