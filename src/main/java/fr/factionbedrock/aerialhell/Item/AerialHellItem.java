...
public class AerialHellItem extends WithInformationItem implements AerialHellItemInterface
{
	...
	public static class Properties extends Item.Properties
	{
		...
		private ImmutableMultimap<Attribute, AttributeModifier> defaultAttributes;
		@Nullable private AerialHellToolMaterial toolMaterial;
		public Properties() {super(); this.maxUseDuration = 0; this.enchantmentValue = 0; this.canDisableShield = false; this.isFoil = false; this.repairIngredient = Ingredient.of(); this.itemUseAnimation = UseAnim.NONE; this.useInteractionTypes = new ArrayList<>(); this.defaultAttributes = ImmutableMultimap.<Attribute, AttributeModifier>builder().build(); this.toolMaterial = null;}
		...
		public ImmutableMultimap<Attribute, AttributeModifier> defaultAttributes() {return this.defaultAttributes;}
		public AerialHellToolMaterial toolMaterial() {return this.toolMaterial;}
		...
		public Properties attributes(ImmutableMultimap<Attribute, AttributeModifier> attributes) {this.defaultAttributes = attributes;return this;}
		...
		public Properties foil(boolean foil) {this.isFoil = foil; return this;}
