...
public class ModuleList
{
    ...
    public static class Builder
    {
        ...
        public Builder addActions(ActionModule... modules) {this.actionModules.addAll(Arrays.asList(modules)); return this;}
        public Builder addConditions(ConditionModule... modules) {this.conditionModules.addAll(Arrays.asList(modules)); return this;}
        public Builder addSideEffects(SideEffectModule... modules) {this.sideEffectModules.addAll(Arrays.asList(modules)); return this;}
