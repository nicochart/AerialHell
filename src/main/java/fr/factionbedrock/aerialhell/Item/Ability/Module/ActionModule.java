...
public class ActionModule extends AbilityModule
{
    ...
    {
        public ThrowProjectile(EntityType<? extends Projectile> type, ToFloatFunc<Integer> velocityFromTicksUsed, float inaccuracy)
        {
            super((stack, itemOwner, equipmentSlot, usingItemInfo, damageInfo, miningInfo) ->
            {
                ...
                if (!level.isClientSide())
                {
                    ...
                    if (projectile != null)
                    {
                        ...
                        if (projectile instanceof AbstractArrow arrow)
                        {
                            ...
                            if (itemOwner.level() instanceof ServerLevel serverLevel) {EnchantmentHelper.onProjectileSpawned(serverLevel, stack, arrow, item -> {});}
                        }
        ...
        public static class Builder
        {
            ...
            public final ThrowProjectile build(EntityType<? extends Projectile> type, float velocity, float inaccuracy) {return this.build(type, (ticksUsed) -> velocity, inaccuracy);}
            public final ThrowProjectile build(EntityType<? extends Projectile> type, ToFloatFunc<Integer> velocity, float inaccuracy) {return new ThrowProjectile(type, velocity, inaccuracy);}
        }
    }
