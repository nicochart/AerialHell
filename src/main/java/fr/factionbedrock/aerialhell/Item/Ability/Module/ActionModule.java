...
public class ActionModule extends AbilityModule
{
    ...
    {
        public ThrowProjectile(EntityType<? extends Projectile> type, ToFloatFunction<Integer> velocityFromTicksUsed, float inaccuracy)
        {
            super((stack, itemOwner, equipmentSlot, usingItemInfo, damageInfo, miningInfo) ->
            {
                ...
                if (!level.isClientSide())
                {
                    ...
                    if (projectile != null)
                    {
                        ...
                        if (itemOwner.level() instanceof ServerLevel serverLevel) {
                            EnchantmentHelper.onProjectileSpawned(serverLevel, stack, projectile, item -> {});}
        ...
        public static class Builder
        {
            ...
            public final ThrowProjectile build(EntityType<? extends Projectile> type, ToFloatFunction<Integer> velocity, float inaccuracy) {return new ThrowProjectile(type, velocity, inaccuracy);}
        }
    }
    ...
    {
        public MultiplyDamage(ToFloatFunction<LivingEntity> multiplier, TestTarget testTarget) {super((stack, itemOwner, equipmentSlot, usingItemInfo, damageInfo, miningInfo) ->
        {
            if (damageInfo != null)
            {
        ...
        public static class Builder
        {
            ...
            public MultiplyDamage by(ToFloatFunction<LivingEntity> multiplier, TestTarget testTarget) {return new MultiplyDamage(multiplier, testTarget);}
        }
    }
