...
public class ItemAbility
{
    ...
    public static Builder copyOf(Builder source) {return source.copy();}
    ...
    public static class Builder
    {
        ...
        public Builder addOnReleaseUsingModules(ModuleList modules) {this.onReleaseUsingModules.addAll(modules); return this;}
        ...
        public Builder copy()
        {
            return new Builder(this.passiveModules.copy(), this.onUseModules.copy(), this.onReleaseUsingModules.copy(), this.onDealDamageModules.copy(), this.onTakeDamageModules.copy(), this.onMiningModules.copy());
        }
