...
public class VoluciteThrowingKnifeItem extends AbstractThrowingKnifeItem
{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand hand)
	{
		...
		if (!worldIn.isRemote)
		{
			VoluciteThrowingKnifeEntity voluciteThrowingKnife = new VoluciteThrowingKnifeEntity(playerIn, worldIn);
			voluciteThrowingKnife.func_234612_a_(playerIn, playerIn.rotationPitch, playerIn.rotationYaw, 0.0F, 0.8F, 1.0F);
			worldIn.addEntity(voluciteThrowingKnife);
		}
