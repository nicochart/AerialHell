...
public class StellarEggItem extends EggItem
{
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand) //copied from ThrownEgg, replacing ThrownEgg with ThrownStellarEgg
    {
