...
public class DimensionShattererProjectileItem extends EggItem
{
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) //copied from ThrownEgg, replacing ThrownEgg with DimensionShattererProjectile
    {
