...
{
    public StellarWheatBlock(BlockBehaviour.Properties settings) {super(settings);}
    ...
    @Override protected ItemLike getBaseSeedId() {return AerialHellItems.STELLAR_WHEAT_SEEDS;}
