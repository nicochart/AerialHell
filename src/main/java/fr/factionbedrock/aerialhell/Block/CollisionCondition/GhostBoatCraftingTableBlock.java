...
{
    public GhostBoatCraftingTableBlock(AbstractBlock.Settings settings) {super(settings.solidBlock((state, blockGetter, pos) -> false).suffocates((state, blockGetter, pos) -> false));}
