...
{
	public GhostBoatTrapDoorBlock(BlockSetType type, AbstractBlock.Settings settings)
	{
		super(type, settings.solidBlock((state, blockGetter, pos) -> false).suffocates((state, blockGetter, pos) -> false));
	}
