...
public class AerialHellFluidBlock extends LiquidBlock
{
	...
	{
        super(flowableFluid, settings.noCollission().strength(100F).noLootTable());
    }
    ...
    public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity)
    {
		if(this.fluid.is(AerialHellTags.Fluids.LIQUID_OF_THE_GODS))
        {
            ...
            {
            	if (!(entity instanceof TornSpiritEntity || entity instanceof ChainedGodEntity || ((LivingEntity) entity).hasEffect(AerialHellMobEffects.GOD)))
            	{
            		entity.hurt(AerialHellDamageTypes.getDamageSource(world, AerialHellDamageTypes.GOD_BLESS), 1.5F);//.setFire(10);
            	}
