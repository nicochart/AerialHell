...
public class BiomeShifterOreBlock extends BiomeShifterBlock
{
    ...
    public BiomeShifterOreBlock(int minExpDropped, int maxExpDropped, Properties prop, int fieldSize, BiomeShifter.ShiftType shiftType) {super(prop, fieldSize, shiftType); this.xpRange = UniformInt.of(minExpDropped, maxExpDropped);}
