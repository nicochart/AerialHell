...
{	
	public MagmaticGelOreBlock(int minExpDropped, int maxExpDropped, BlockBehaviour.Properties settings)
	{
	...
	public void stepOn(Level world, BlockPos pos, BlockState state, Entity entity)
	{
		...
		if (!world.isClientSide() && entity instanceof LivingEntity && !entity.isShiftKeyDown() && !creaPlayer)
		{
