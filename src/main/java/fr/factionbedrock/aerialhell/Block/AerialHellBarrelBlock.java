...
public class AerialHellBarrelBlock extends BarrelBlock
{
	...
	*/
	...
	public AerialHellBarrelBlock(BlockBehaviour.Properties properties) {super(properties);}

	@Override public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {return new AerialHellBarrelBlockEntity(pos, state);}
