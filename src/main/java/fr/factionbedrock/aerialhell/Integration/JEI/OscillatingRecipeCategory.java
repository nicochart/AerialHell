...
{
    public static final IRecipeHolderType<OscillatingRecipe> OSCILLATING = IRecipeHolderType.create(AerialHellRecipes.RecipeTypes.OSCILLATING);

	public OscillatingRecipeCategory(IGuiHelper guiHelper)
    {
        super(guiHelper, OSCILLATING, AerialHellBlocks.OSCILLATOR, "block.aerialhell.oscillator", true);
    }
}
