...
public class OscillatingRecipeCategory extends AbstractCookingCategory<OscillatingRecipe>
{
    ...
    {
        super(OSCILLATING, guiHelper, AerialHellBlocks.OSCILLATOR.get(), "block.aerialhell.oscillator", OscillatorScreen.OSCILLATOR_GUI_TEXTURES, AerialHellItems.FLUORITE.get());
    }
