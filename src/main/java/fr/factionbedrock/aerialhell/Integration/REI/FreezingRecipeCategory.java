...
//{
//	public final static Identifier TEXTURE = Identifier.fromNamespaceAndPath(AerialHell.MODID, "textures/gui/container/freezer.png");
//
...
//
//        widgets.add(Widgets.createSlot(new Point(startPoint.x + 56, startPoint.y + 53)).entries(List.of(EntryStacks.of(AerialHellItems.MAGMATIC_GEL))));
//
