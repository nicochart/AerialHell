...
{
    public static final Codec<ConfigSpacingStructurePlacement> CODEC = ExtraCodecs.validate(
            ...
            ConfigSpacingStructurePlacement::validate
    ).codec();
    ...
    public ConfigSpacingStructurePlacement(Vec3i locateOffset, FrequencyReductionMethod frequencyReductionMethod, float frequency, int salt, Optional<ExclusionZone> exclusionZone, int separation, RandomSpreadType spreadType)
    {
