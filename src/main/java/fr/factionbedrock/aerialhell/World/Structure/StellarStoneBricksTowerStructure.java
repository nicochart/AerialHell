...
public class StellarStoneBricksTowerStructure extends AbstractClassicLittleStructure
{
    ...
    public StellarStoneBricksTowerStructure(Codec<NoFeatureConfig> codec) {super(codec);}
    @Override public List<MobSpawnInfo.Spawners> getDefaultSpawnList() {return monstersSpawnList;}

    @Override public IStartFactory<NoFeatureConfig> getStartFactory() {return StellarStoneBricksTowerStructure.Start::new;}
