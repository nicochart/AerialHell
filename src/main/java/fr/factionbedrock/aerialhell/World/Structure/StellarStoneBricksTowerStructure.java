...
public class StellarStoneBricksTowerStructure extends AbstractAerialHellStructure
{
    ...
    public StellarStoneBricksTowerStructure(Codec<NoFeatureConfig> codec)
    {
        super(codec);
    }
    ...
    {
        return StellarStoneBricksTowerStructure.Start::new;
    }
    ...
    public static class Start extends AbstractAerialHellStructure.Start
    {
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager structureManager, int x, int z, Biome biome, NoFeatureConfig NoFeatureConfig)
        {
            ...
            (
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY).getOrDefault(new ResourceLocation(AerialHell.MODID, "stellar_stone_bricks_tower/ground_pool")), 50),
            ...
            {
                this.func_214626_a(this.rand, landHeight - 9, landHeight- 9);
            }
        }
    }
}