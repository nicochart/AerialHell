...
{
    private final static int MIN_GEN_HEIGHT = 50, MAX_GEN_HEIGHT = 190, Y_OFFSET = -10;

    public CopperPineCottageStructure() {super(CopperPineCottageStructure::getPiecesGenerator);}
