...
public class GoldenNetherPrisonStructure extends AbstractAerialHellStructure
{
    ...
    public static final MapCodec<GoldenNetherPrisonStructure> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(GoldenNetherPrisonStructure.configCodecBuilder(instance),
    ...
    public GoldenNetherPrisonStructure(Structure.Config config, RegistryEntry<StructurePool> startPool, Optional<Identifier> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Type> projectStartToHeightmap, int maxDistanceFromCenter)
    {
    ...
    @Override public StructureType<?> getType() {return AerialHellStructures.GOLDEN_NETHER_PRISON_STRUCTURE;}
}