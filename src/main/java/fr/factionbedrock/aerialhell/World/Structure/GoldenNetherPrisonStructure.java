...
public class GoldenNetherPrisonStructure extends AbstractAerialHellStructure
{
    ...
    public static final Codec<GoldenNetherPrisonStructure> CODEC = RecordCodecBuilder.<GoldenNetherPrisonStructure>mapCodec(instance ->
            ...
            ).apply(instance, GoldenNetherPrisonStructure::new)).codec();
