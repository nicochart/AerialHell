...
{
    public static final Codec<ShadowPineTowerStructure> CODEC = RecordCodecBuilder.<ShadowPineTowerStructure>mapCodec(instance ->
            ...
            ).apply(instance, ShadowPineTowerStructure::new)).codec();
