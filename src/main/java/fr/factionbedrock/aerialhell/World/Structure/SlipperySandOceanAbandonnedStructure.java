...
{
    private final static int MIN_GEN_HEIGHT = 50, MAX_GEN_HEIGHT = 190, Y_OFFSET = -3;

    public SlipperySandOceanAbandonnedStructure() {super(SlipperySandOceanAbandonnedStructure::getPiecesGenerator);}
