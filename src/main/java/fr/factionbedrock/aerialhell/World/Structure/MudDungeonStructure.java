...
public class MudDungeonStructure extends AbstractAerialHellStructure
{
    ...
    public MudDungeonStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<Identifier> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter)
    {
    ...
    @Override public StructureType<?> type() {return AerialHellStructures.MUD_DUNGEON_STRUCTURE;}
}