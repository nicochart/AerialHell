...
{
	private static final List<MobSpawnInfo.Spawners> spawnList = ImmutableList.of(new MobSpawnInfo.Spawners(AerialHellEntities.MUD_SOLDIER.get(), 1, 3, 15), new MobSpawnInfo.Spawners(EntityType.SKELETON, 2, 5, 5));
