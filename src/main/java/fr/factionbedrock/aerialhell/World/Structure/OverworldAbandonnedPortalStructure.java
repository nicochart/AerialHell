...
public class OverworldAbandonnedPortalStructure extends AbstractAerialHellStructure
{
    ...
    public OverworldAbandonnedPortalStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<Identifier> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter)
    {
    ...
    @Override public StructureType<?> type() {return AerialHellStructures.OVERWORLD_ABANDONNED_PORTAL_STRUCTURE;}
}