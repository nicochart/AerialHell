...
public class FloatingBoatStructure extends AbstractAerialHellStructure
{
    ...
    public FloatingBoatStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter)
    {
    ...
    @Override public StructureType<?> type() {return AerialHellStructures.FLOATING_BOAT;}
}