...
{
    public static final Codec<FloatingBoatStructure> CODEC = RecordCodecBuilder.<FloatingBoatStructure>mapCodec(instance ->
            ...
            ).apply(instance, FloatingBoatStructure::new)).codec();
