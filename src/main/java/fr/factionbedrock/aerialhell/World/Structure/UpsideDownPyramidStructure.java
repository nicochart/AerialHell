...
public class UpsideDownPyramidStructure extends AbstractAerialHellStructure
{
    ...
    public UpsideDownPyramidStructure(StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<Identifier> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter)
    {
