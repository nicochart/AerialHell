...
public class ShadowPine extends BigTree
{
	...
	*/
	...
	{
		return Feature.TREE.withConfiguration(AerialHellFeatures.Configs.SHADOW_PINE_CONFIG);
	}
	...
	{
		return Feature.TREE.withConfiguration(AerialHellFeatures.Configs.MEGA_SHADOW_PINE_CONFIG);
	}
}
