...
public class ShadowPine extends BigTree
{
	...
	*/
	...
	{
		return Feature.TREE.withConfiguration(AerialHellConfiguredFeatures.Configs.SHADOW_PINE_CONFIG);
	}
	...
	{
		return Feature.TREE.withConfiguration(AerialHellConfiguredFeatures.Configs.MEGA_SHADOW_PINE_CONFIG);
	}
}
