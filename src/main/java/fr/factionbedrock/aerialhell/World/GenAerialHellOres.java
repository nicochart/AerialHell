...
public class GenAerialHellOres
{
	...
	public static class OrePlacements
	{
		...
		public final static List<PlacementModifier> DIAMOND_STELLAR_ORE = commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.absolute(10), VerticalAnchor.absolute(120)));
		public final static List<PlacementModifier> FLUORITE_ORE = commonOrePlacement(60, HeightRangePlacement.uniform(VerticalAnchor.absolute(40), VerticalAnchor.absolute(256)));
		public final static List<PlacementModifier> RUBY_ORE = commonOrePlacement(30, HeightRangePlacement.uniform(VerticalAnchor.absolute(20), VerticalAnchor.absolute(256)));
		...
		public final static List<PlacementModifier> VOLUCITE_ORE = commonOrePlacement(3, HeightRangePlacement.uniform(VerticalAnchor.absolute(160), VerticalAnchor.absolute(256)));
		public final static List<PlacementModifier> OBSIDIAN_ORE = commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(10), VerticalAnchor.absolute(70)));
