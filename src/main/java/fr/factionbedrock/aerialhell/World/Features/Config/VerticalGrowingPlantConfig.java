...
public record VerticalGrowingPlantConfig(int spreadWidth, int spreadHeight, int minHeight, int maxHeight, int minTries, int maxTries) implements FeatureConfiguration
{
