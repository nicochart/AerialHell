...
public class BoarEntity extends Pig
{
    ...
    @Override @Nullable public Pig getBreedOffspring(ServerLevel serverWorld, AgeableMob mob) {return AerialHellEntities.STELLAR_BOAR.create(serverWorld, EntitySpawnReason.BREEDING);}
    @Override public boolean isFood(ItemStack stack) {return FOOD_ITEMS.test(stack);}

    public static boolean canSpawn(EntityType<? extends Pig> type, ServerLevelAccessor world, EntitySpawnReason reason, BlockPos pos, RandomSource random)
    {
