...
public interface BaseEntityInterface
{
    ...
    default void setNeedsSync() {this.getSelf().hasImpulse = true;}
    ...
    default void snapTo(double x, double y, double z, float yRot, float xRot) {this.getSelf().moveTo(x, y, z, yRot, xRot);}
    ...
    default RandomSource getRandom() {return this.getSelf().level().random;}
