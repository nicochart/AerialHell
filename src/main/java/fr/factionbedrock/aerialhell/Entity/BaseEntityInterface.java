...
public interface BaseEntityInterface
{
    ...
    default void refreshPositionAndAngles(double x, double y, double z, float yRot, float xRot) {this.getSelf().snapTo(x, y, z, yRot, xRot);} //TODO rename
    ...
    default boolean is(Entity entity) {return this.getSelf().is(entity);} //TODO rename

    default void setPosition(double x, double y, double z) {this.getSelf().setPos(x, y, z);}
    default void setPitch(float xRot) {this.getSelf().setXRot(xRot);}
    default void setYaw(float yRot) {this.getSelf().setYRot(yRot);}

    default RandomSource getRandom() {return this.getSelf().getRandom();}
    default double getParticleX(double scale) {return this.getSelf().getRandomX(scale);}
    default double getRandomBodyY() {return this.getSelf().getRandomY();}
    default double getParticleZ(double scale) {return this.getSelf().getRandomZ(scale);}
}
