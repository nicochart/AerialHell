...
{
	public CrystalCaterpillarEntity(EntityType<? extends AbstractCaterpillarEntity> type, Level world) {super(type, world);}
	
	public CrystalCaterpillarEntity(Level level) {this(AerialHellEntities.CRYSTAL_CATERPILLAR, level);}
