...
public class CrystalSpiderEntity extends AbstractAerialHellSpiderEntity implements LunarMisleadableEntity
{
    ...
    @Override public void registerGoals()
    {
        ...
        this.targetSelector.addGoal(1, new TargetGoal<>(this, Player.class, (potentialTarget) -> !this.isMisleadedBy(potentialTarget)));
    ...
    {
        public TargetGoal(Spider spider, Class<T> classTarget, Predicate<LivingEntity> entityPredicate)
        {
        	super(spider, classTarget, true, entityPredicate);
        }
