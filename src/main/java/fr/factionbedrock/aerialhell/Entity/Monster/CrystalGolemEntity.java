...
public class CrystalGolemEntity extends AerialHellGolemEntity implements LunarMisleadableEntity, GoalConditionEntity.PhaseAwareGoalConditionEntity
{
    ...
    @Override protected void registerGoals()
    {
        ...
        this.targetSelector.addGoal(2, new ConditionalGoal(this, ACTIVE_GOALS, new NearestAttackableTargetGoal<>(this, Player.class, true, (potentialTarget) -> !this.isMisleadedBy(potentialTarget))));
