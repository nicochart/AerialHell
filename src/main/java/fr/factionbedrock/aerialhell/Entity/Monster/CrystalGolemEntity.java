...
{	
    ...
    {
    	super.tick();
    	if (this.canDespawn(64) && this.ticksExisted > getMaxLifeTime() && !isDisappearing())
    	{
    ...
    protected class CrystalGolemAvoidEntityGoal<T extends LivingEntity> extends AvoidEntityGoal<T>
    {
		...
		{
			return this.golem.isActive() && this.golem.isDisappearing() && super.shouldExecute();
		}
		
		@Override
		public boolean shouldContinueExecuting()
		{
			return this.golem.isActive() && this.golem.isDisappearing() && super.shouldContinueExecuting();
		}
    }
