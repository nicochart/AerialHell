...
public class GhostGoals
{
    ...
    {
        public GhostPirateNearestAttackableTargetGoal(Mob entity, Class<T> targetClassIn, boolean checkSight) {super(entity, targetClassIn, checkSight);}
    ...
    {
        public GhostPirateMeleeAttackGoal(PathfinderMob entity, double speedIn, boolean useLongMemory) {super(entity, speedIn, useLongMemory);}
    ...
    {
        public GhostPirateLookAtPlayerGoal(Mob entity, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {super(entity, watchTargetClass, maxDistance);}
        @Override public boolean additionalConditionMet() {return !EntityHelper.isImmuneToGhostBlockCollision(this.goalOwner.getTarget());}
    }
