...
{
    public VoluciteWardenStrikeAttackGoal(VoluciteWardenEntity entity, float distanceOffsetTolerance) {super(entity, distanceOffsetTolerance);}
    ...
    {
        Vec3 armStartPos = this.getGoalOwner().getRightArm().getFirst().getUnrotatedRelativePositionOffset();
        ...
        for (VoluciteWardenEntity.ArmPartInfo partInfo : this.getGoalOwner().getRightArm())
        {
