...
public class DiamondShurikenEntity extends AbstractShurikenEntity
{
	...
	public DiamondShurikenEntity(Level world, LivingEntity shooter, double accelX, double accelY, double accelZ, float velocity, float inaccuracy)
	{
		super(AerialHellEntities.DIAMOND_SHURIKEN, world, shooter, accelX, accelY, accelZ, velocity, inaccuracy);
	}

	public DiamondShurikenEntity(double x, double y, double z, Level world)
	{
		super(AerialHellEntities.DIAMOND_SHURIKEN, x, y, z, world);
	}

	public DiamondShurikenEntity(LivingEntity shooter, Level world)
	{
