...
public class ShurikenEntity extends ThrowableProjectile
{
	...
	@Override public void readAdditionalSaveData(CompoundTag valueInput)
	{
		...
		this.shurikenZRot = valueInput.contains("shurikenZRot") ? valueInput.getShort("shurikenZRot") : 0;
	}
	...
	protected SoundEvent getShootSound() {return AerialHellSoundEvents.ENTITY_SHURIKEN_SHOOT.get();}
