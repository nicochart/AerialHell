...
public class ObsidianShurikenEntity extends AbstractShurikenEntity
{
	...
	public ObsidianShurikenEntity(Level world, LivingEntity shooter, double accelX, double accelY, double accelZ, float velocity, float inaccuracy)
	{
		super(AerialHellEntities.OBSIDIAN_SHURIKEN, world, shooter, accelX, accelY, accelZ, velocity, inaccuracy);
	}

	public ObsidianShurikenEntity(double x, double y, double z, Level world)
	{
		super(AerialHellEntities.OBSIDIAN_SHURIKEN, x, y, z, world);
	}

	public ObsidianShurikenEntity(LivingEntity shooter, Level world)
	{
