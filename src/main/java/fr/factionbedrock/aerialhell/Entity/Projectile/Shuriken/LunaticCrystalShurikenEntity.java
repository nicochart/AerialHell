...
public class LunaticCrystalShurikenEntity extends AbstractShurikenEntity
{
	...
	public LunaticCrystalShurikenEntity(Level world, LivingEntity shooter, double accelX, double accelY, double accelZ, float velocity, float inaccuracy)
	{
		super(AerialHellEntities.LUNATIC_CRYSTAL_SHURIKEN, world, shooter, accelX, accelY, accelZ, velocity, inaccuracy);
	}

	public LunaticCrystalShurikenEntity(double x, double y, double z, Level world)
	{
		super(AerialHellEntities.LUNATIC_CRYSTAL_SHURIKEN, x, y, z, world);
	}

	public LunaticCrystalShurikenEntity(LivingEntity shooter, Level world)
	{
