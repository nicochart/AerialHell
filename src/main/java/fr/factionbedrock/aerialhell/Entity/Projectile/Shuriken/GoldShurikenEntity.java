...
public class GoldShurikenEntity extends AbstractShurikenEntity
{
	...
	public GoldShurikenEntity(Level world, LivingEntity shooter, double accelX, double accelY, double accelZ, float velocity, float inaccuracy)
	{
		super(AerialHellEntities.GOLD_SHURIKEN, world, shooter, accelX, accelY, accelZ, velocity, inaccuracy);
	}

	public GoldShurikenEntity(double x, double y, double z, Level world)
	{
		super(AerialHellEntities.GOLD_SHURIKEN, x, y, z, world);
	}

	public GoldShurikenEntity(LivingEntity shooter, Level world)
	{
