...
public class IronThrowingKnifeEntity extends AbtractThrowingKnifeEntity
{
	...
	public IronThrowingKnifeEntity(LivingEntity owner, World worldIn)
	{
		super(AerialHellEntities.IRON_THROWING_KNIFE.get(), owner, worldIn);
	}
	...
	protected void onImpact(RayTraceResult result)
	{
		...
		if (result != null && result.getType() != RayTraceResult.Type.MISS && this.world instanceof ServerWorld && result.getType() == RayTraceResult.Type.ENTITY)
		{
            ...
            entity.attackEntityFrom(new DamageSource("throwing_knife_hit"), 6.0F);
