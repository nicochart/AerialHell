...
public class IronShurikenEntity extends AbstractShurikenEntity
{
	...
	public IronShurikenEntity(Level world, LivingEntity shooter, double accelX, double accelY, double accelZ, float velocity, float inaccuracy)
	{
		super(AerialHellEntities.IRON_SHURIKEN, world, shooter, accelX, accelY, accelZ, velocity, inaccuracy);
	}

	public IronShurikenEntity(double x, double y, double z, Level world)
	{
		super(AerialHellEntities.IRON_SHURIKEN, x, y, z, world);
	}

	public IronShurikenEntity(LivingEntity shooter, Level world)
	{
