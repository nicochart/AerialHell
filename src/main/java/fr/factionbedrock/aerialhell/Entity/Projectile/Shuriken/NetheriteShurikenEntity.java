...
public class NetheriteShurikenEntity extends AbstractShurikenEntity
{
	...
	public NetheriteShurikenEntity(Level world, LivingEntity shooter, double accelX, double accelY, double accelZ, float velocity, float inaccuracy)
	{
		super(AerialHellEntities.NETHERITE_SHURIKEN, world, shooter, accelX, accelY, accelZ, velocity, inaccuracy);
	}

	public NetheriteShurikenEntity(double x, double y, double z, Level world)
	{
		super(AerialHellEntities.NETHERITE_SHURIKEN, x, y, z, world);
	}

	public NetheriteShurikenEntity(LivingEntity shooter, Level world)
	{
