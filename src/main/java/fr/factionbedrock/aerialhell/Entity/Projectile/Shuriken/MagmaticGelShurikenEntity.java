...
public class MagmaticGelShurikenEntity extends AbstractShurikenEntity
{
	...
	public MagmaticGelShurikenEntity(Level world, LivingEntity shooter, double accelX, double accelY, double accelZ, float velocity, float inaccuracy)
	{
		super(AerialHellEntities.MAGMATIC_GEL_SHURIKEN, world, shooter, accelX, accelY, accelZ, velocity, inaccuracy);
	}

	public MagmaticGelShurikenEntity(double x, double y, double z, Level world)
	{
		super(AerialHellEntities.MAGMATIC_GEL_SHURIKEN, x, y, z, world);
	}

	public MagmaticGelShurikenEntity(LivingEntity shooter, Level world)
	{
