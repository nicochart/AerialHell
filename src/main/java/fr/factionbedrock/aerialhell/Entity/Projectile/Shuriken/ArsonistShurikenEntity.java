...
public class ArsonistShurikenEntity extends AbstractShurikenEntity
{
	...
	public ArsonistShurikenEntity(Level world, LivingEntity shooter, double accelX, double accelY, double accelZ, float velocity, float inaccuracy)
	{
		super(AerialHellEntities.ARSONIST_SHURIKEN, world, shooter, accelX, accelY, accelZ, velocity, inaccuracy);
	}

	public ArsonistShurikenEntity(double x, double y, double z, Level world)
	{
		super(AerialHellEntities.ARSONIST_SHURIKEN, x, y, z, world);
	}

	public ArsonistShurikenEntity(LivingEntity shooter, Level world)
	{
