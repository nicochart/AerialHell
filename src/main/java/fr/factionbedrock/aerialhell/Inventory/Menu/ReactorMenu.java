		...
		addSlot(new Slot(container,0,80,36)
		{
			@Override public boolean mayPlace(ItemStack stack)
			{
				return stack.is(AerialHellItems.FLUORITE) || stack.is(AerialHellItems.FLUORITE_BLOCK)
					|| stack.is(AerialHellItems.SHADOW_CRYSTAL) || stack.is(AerialHellItems.SHADOW_SHARD) || stack.is(AerialHellItems.CURSED_CRYSTAL) || stack.is(AerialHellItems.CURSED_CRYSTAL_BLOCK);
			}
		});
	}
