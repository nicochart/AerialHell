...
public class OscillatorMenu extends AbstractFurnaceMenu
{
	...
	{
		super(AerialHellMenuTypes.OSCILLATOR, RecipeTypes.OSCILLATING, RecipeBookType.FURNACE, windowId, playerInventory);
	}

	public OscillatorMenu(int windowId, Inventory playerInventory, Container oscillatingInventory, ContainerData data)
	{
		super(AerialHellMenuTypes.OSCILLATOR, RecipeTypes.OSCILLATING, RecipeBookType.FURNACE, windowId, playerInventory, oscillatingInventory, data);
	}
