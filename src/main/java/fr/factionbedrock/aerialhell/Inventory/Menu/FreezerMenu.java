...
public class FreezerMenu extends AbstractFurnaceMenu
{
	...
	{
		super(AerialHellMenuTypes.FREEZER, RecipeTypes.FREEZING, RecipeBookType.FURNACE, windowId, playerInventory);
	}

	public FreezerMenu(int windowId, Inventory playerInventory, Container freezingInventory, ContainerData data)
	{
		super(AerialHellMenuTypes.FREEZER, RecipeTypes.FREEZING, RecipeBookType.FURNACE, windowId, playerInventory, freezingInventory, data);
	}
